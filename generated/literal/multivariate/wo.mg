// hol2mg literal statements (private): shard wo of profile multivariate.  Each theorem is the literal
...
Theorem hlt_fld : forall A:set, A <> Empty -> forall R1 :e 2 :^: A :^: A, hl_fld A R1 = hl_GSPEC A (fun GEN_PVAR_372 :e A => if exists x :e A, hl_SETSPEC A GEN_PVAR_372 (if exists y :e A, R1 x y = 1 \/ R1 y x = 1 then 1 else 0) x = 1 then 1 else 0).
Admitted.
...
Theorem hlt_FINITE_FLD : forall A:set, A <> Empty -> forall l :e 2 :^: A :^: A, hl_FINITE A (hl_fld A l) = 1 <-> hl_FINITE (A :*: A) (hl_GSPEC (A :*: A) (fun GEN_PVAR_373 :e A :*: A => if exists x y :e A, hl_SETSPEC (A :*: A) GEN_PVAR_373 (l x y) (hl_pair A A x y) = 1 then 1 else 0)) = 1.
Admitted.
...
Theorem hlt_QOSET_FLD : forall A:set, A <> Empty -> forall l :e 2 :^: A :^: A, hl_qoset A l = 1 -> hl_fld A l = hl_GSPEC A (fun GEN_PVAR_374 :e A => if exists x :e A, hl_SETSPEC A GEN_PVAR_374 (l x x) x = 1 then 1 else 0).
Admitted.
...
Theorem hlt_FLD_RESTRICT_QOSET : forall A:set, A <> Empty -> forall l :e 2 :^: A :^: A, forall P :e 2 :^: A, hl_qoset A l = 1 -> hl_fld A (fun x :e A => fun y :e A => if P x = 1 /\ (P y = 1 /\ l x y = 1) then 1 else 0) = hl_GSPEC A (fun GEN_PVAR_384 :e A => if exists x :e A, hl_SETSPEC A GEN_PVAR_384 (if hl_IN A x (hl_fld A l) = 1 /\ P x = 1 then 1 else 0) x = 1 then 1 else 0).
Admitted.

// HOL Light: Library/wo.ml:522 / FLD_RESTRICT_POSET   (hash md5:5101e32d037c4b248effc6c9ab5d3bf6)
Theorem hlt_FLD_RESTRICT_POSET : forall A:set, A <> Empty -> forall l :e 2 :^: A :^: A, forall P :e 2 :^: A, hl_poset A l = 1 -> hl_fld A (fun x :e A => fun y :e A => if P x = 1 /\ (P y = 1 /\ l x y = 1) then 1 else 0) = hl_GSPEC A (fun GEN_PVAR_385 :e A => if exists x :e A, hl_SETSPEC A GEN_PVAR_385 (if hl_IN A x (hl_fld A l) = 1 /\ P x = 1 then 1 else 0) x = 1 then 1 else 0).
Admitted.

// HOL Light: Library/wo.ml:527 / FLD_RESTRICT_TOSET   (hash md5:8d9f0485d0513518c505ae97d70dedd3)
Theorem hlt_FLD_RESTRICT_TOSET : forall A:set, A <> Empty -> forall l :e 2 :^: A :^: A, forall P :e 2 :^: A, hl_toset A l = 1 -> hl_fld A (fun x :e A => fun y :e A => if P x = 1 /\ (P y = 1 /\ l x y = 1) then 1 else 0) = hl_GSPEC A (fun GEN_PVAR_386 :e A => if exists x :e A, hl_SETSPEC A GEN_PVAR_386 (if hl_IN A x (hl_fld A l) = 1 /\ P x = 1 then 1 else 0) x = 1 then 1 else 0).
Admitted.

// HOL Light: Library/wo.ml:532 / FLD_RESTRICT_WOSET   (hash md5:6e92a8faca058073dc810b5aa799af73)
Theorem hlt_FLD_RESTRICT_WOSET : forall A:set, A <> Empty -> forall l :e 2 :^: A :^: A, forall P :e 2 :^: A, hl_woset A l = 1 -> hl_fld A (fun x :e A => fun y :e A => if P x = 1 /\ (P y = 1 /\ l x y = 1) then 1 else 0) = hl_GSPEC A (fun GEN_PVAR_387 :e A => if exists x :e A, hl_SETSPEC A GEN_PVAR_387 (if hl_IN A x (hl_fld A l) = 1 /\ P x = 1 then 1 else 0) x = 1 then 1 else 0).
Admitted.

// HOL Light: Library/wo.ml:537 / FLD_RESTRICT_WQOSET   (hash md5:52c8e8fc6c7d1772cd84fb21cc3950e1)
Theorem hlt_FLD_RESTRICT_WQOSET : forall A:set, A <> Empty -> forall l :e 2 :^: A :^: A, forall P :e 2 :^: A, hl_wqoset A l = 1 -> hl_fld A (fun x :e A => fun y :e A => if P x = 1 /\ (P y = 1 /\ l x y = 1) then 1 else 0) = hl_GSPEC A (fun GEN_PVAR_388 :e A => if exists x :e A, hl_SETSPEC A GEN_PVAR_388 (if hl_IN A x (hl_fld A l) = 1 /\ P x = 1 then 1 else 0) x = 1 then 1 else 0).
Admitted.
...
Theorem hlt_FLD_POINTWISE : forall A K:set, A <> Empty -> K <> Empty -> forall l :e 2 :^: A :^: A, forall s :e 2 :^: K, hl_qoset A l = 1 -> hl_fld (A :^: K) (fun x :e A :^: K => fun y :e A :^: K => if forall i :e K, hl_IN K i s = 1 -> l (x i) (y i) = 1 then 1 else 0) = hl_GSPEC (A :^: K) (fun GEN_PVAR_389 :e A :^: K => if exists x :e A :^: K, hl_SETSPEC (A :^: K) GEN_PVAR_389 (if forall i :e K, hl_IN K i s = 1 -> hl_IN A (x i) (hl_fld A l) = 1 then 1 else 0) x = 1 then 1 else 0).
Admitted.
...
Theorem hlt_WOSET_FINITE_TOSET : forall A:set, A <> Empty -> forall l :e 2 :^: A :^: A, hl_toset A l = 1 /\ hl_FINITE (A :*: A) (hl_GSPEC (A :*: A) (fun GEN_PVAR_391 :e A :*: A => if exists x y :e A, hl_SETSPEC (A :*: A) GEN_PVAR_391 (l x y) (hl_pair A A x y) = 1 then 1 else 0)) = 1 -> hl_woset A l = 1.
Admitted.
