...
// HOL Light kernel definitions of profile standard (commit 433477862bb90b328a593e012e09390e99b2439b).  Checked after mglib/native/*.mg and
...
Definition hl_index : set :=
  fun v_120880 :e omega => fun v_120881 :e omega => hl_COND omega (if hl_le v_120880 (hl_NUMERAL (hl_BIT1 hl_zero)) = 1 \/ v_120881 = hl_NUMERAL hl_zero then 1 else 0) (hl_NUMERAL hl_zero) (hl_CARD omega (hl_GSPEC omega (fun GEN_PVAR_380 :e omega => if exists j :e omega, hl_SETSPEC omega GEN_PVAR_380 (if hl_le (hl_NUMERAL (hl_BIT1 hl_zero)) j = 1 /\ hl_num_divides (hl_EXP v_120880 j) v_120881 = 1 then 1 else 0) j = 1 then 1 else 0))).

// HOL Light: binom : num#num->num
Definition hl_binom : set :=
  hl_select (omega :^: (omega :*: omega) :^: (omega :*: (omega :*: (omega :*: (omega :*: omega))))) (fun binom :e omega :^: (omega :*: omega) :^: (omega :*: (omega :*: (omega :*: (omega :*: omega)))) => if forall v_129131 :e omega :*: (omega :*: (omega :*: (omega :*: omega))), (forall n :e omega, binom v_129131 (hl_pair omega omega n (hl_NUMERAL hl_zero)) = hl_NUMERAL (hl_BIT1 hl_zero)) /\ ((forall k :e omega, binom v_129131 (hl_pair omega omega (hl_NUMERAL hl_zero) (hl_SUC k)) = hl_NUMERAL hl_zero) /\ forall n k :e omega, binom v_129131 (hl_pair omega omega (hl_SUC n) (hl_SUC k)) = hl_add (binom v_129131 (hl_pair omega omega n (hl_SUC k))) (binom v_129131 (hl_pair omega omega n k))) then 1 else 0) (hl_pair omega (omega :*: (omega :*: (omega :*: omega))) (hl_NUMERAL (hl_BIT0 (hl_BIT1 (hl_BIT0 (hl_BIT0 (hl_BIT0 (hl_BIT1 (hl_BIT1 hl_zero)))))))) (hl_pair omega (omega :*: (omega :*: omega)) (hl_NUMERAL (hl_BIT1 (hl_BIT0 (hl_BIT0 (hl_BIT1 (hl_BIT0 (hl_BIT1 (hl_BIT1 hl_zero)))))))) (hl_pair omega (omega :*: omega) (hl_NUMERAL (hl_BIT0 (hl_BIT1 (hl_BIT1 (hl_BIT1 (hl_BIT0 (hl_BIT1 (hl_BIT1 hl_zero)))))))) (hl_pair omega omega (hl_NUMERAL (hl_BIT1 (hl_BIT1 (hl_BIT1 (hl_BIT1 (hl_BIT0 (hl_BIT1 (hl_BIT1 hl_zero)))))))) (hl_NUMERAL (hl_BIT1 (hl_BIT0 (hl_BIT1 (hl_BIT1 (hl_BIT0 (hl_BIT1 (hl_BIT1 hl_zero)))))))))))).

// HOL Light: rational : real->bool
Definition hl_rational : set :=
  fun v_131254 :e R => if exists m n :e R, hl_integer m = 1 /\ (hl_integer n = 1 /\ (~ n = hl_real_of_num (hl_NUMERAL hl_zero) /\ v_131254 = hl_real_div m n)) then 1 else 0.

// HOL Light: floor : real->real
Definition hl_floor : set :=
  hl_select (R :^: R :^: (omega :*: (omega :*: (omega :*: (omega :*: omega))))) (fun n :e R :^: R :^: (omega :*: (omega :*: (omega :*: (omega :*: omega)))) => if forall v_131636 :e omega :*: (omega :*: (omega :*: (omega :*: omega))), exists r :e R :^: R, forall x :e R, hl_integer (n v_131636 x) = 1 /\ (hl_real_le (hl_real_of_num (hl_NUMERAL hl_zero)) (r x) = 1 /\ (hl_real_lt (r x) (hl_real_of_num (hl_NUMERAL (hl_BIT1 hl_zero))) = 1 /\ x = hl_real_add (n v_131636 x) (r x))) then 1 else 0) (hl_pair omega (omega :*: (omega :*: (omega :*: omega))) (hl_NUMERAL (hl_BIT0 (hl_BIT1 (hl_BIT1 (hl_BIT0 (hl_BIT0 (hl_BIT1 (hl_BIT1 hl_zero)))))))) (hl_pair omega (omega :*: (omega :*: omega)) (hl_NUMERAL (hl_BIT0 (hl_BIT0 (hl_BIT1 (hl_BIT1 (hl_BIT0 (hl_BIT1 (hl_BIT1 hl_zero)))))))) (hl_pair omega (omega :*: omega) (hl_NUMERAL (hl_BIT1 (hl_BIT1 (hl_BIT1 (hl_BIT1 (hl_BIT0 (hl_BIT1 (hl_BIT1 hl_zero)))))))) (hl_pair omega omega (hl_NUMERAL (hl_BIT1 (hl_BIT1 (hl_BIT1 (hl_BIT1 (hl_BIT0 (hl_BIT1 (hl_BIT1 hl_zero)))))))) (hl_NUMERAL (hl_BIT0 (hl_BIT1 (hl_BIT0 (hl_BIT0 (hl_BIT1 (hl_BIT1 (hl_BIT1 hl_zero)))))))))))).

// HOL Light: frac : real->real
Definition hl_frac : set :=
  hl_select (R :^: R :^: (omega :*: (omega :*: (omega :*: omega)))) (fun r :e R :^: R :^: (omega :*: (omega :*: (omega :*: omega))) => if forall v_131637 :e omega :*: (omega :*: (omega :*: omega)), forall x :e R, hl_integer (hl_floor x) = 1 /\ (hl_real_le (hl_real_of_num (hl_NUMERAL hl_zero)) (r v_131637 x) = 1 /\ (hl_real_lt (r v_131637 x) (hl_real_of_num (hl_NUMERAL (hl_BIT1 hl_zero))) = 1 /\ x = hl_real_add (hl_floor x) (r v_131637 x))) then 1 else 0) (hl_pair omega (omega :*: (omega :*: omega)) (hl_NUMERAL (hl_BIT0 (hl_BIT1 (hl_BIT1 (hl_BIT0 (hl_BIT0 (hl_BIT1 (hl_BIT1 hl_zero)))))))) (hl_pair omega (omega :*: omega) (hl_NUMERAL (hl_BIT0 (hl_BIT1 (hl_BIT0 (hl_BIT0 (hl_BIT1 (hl_BIT1 (hl_BIT1 hl_zero)))))))) (hl_pair omega omega (hl_NUMERAL (hl_BIT1 (hl_BIT0 (hl_BIT0 (hl_BIT0 (hl_BIT0 (hl_BIT1 (hl_BIT1 hl_zero)))))))) (hl_NUMERAL (hl_BIT1 (hl_BIT1 (hl_BIT0 (hl_BIT0 (hl_BIT0 (hl_BIT1 (hl_BIT1 hl_zero))))))))))).

// HOL Light: int_prime : int->bool
Definition hl_int_prime : set :=
  fun v_137423 :e hl_ty_int => if hl_int_gt (hl_int_abs v_137423) (hl_int_of_num (hl_NUMERAL (hl_BIT1 hl_zero))) = 1 /\ forall x :e hl_ty_int, hl_int_divides x v_137423 = 1 -> hl_int_abs x = hl_int_of_num (hl_NUMERAL (hl_BIT1 hl_zero)) \/ hl_int_abs x = hl_int_abs v_137423 then 1 else 0.

// HOL Light: fld : (A->A->bool)->A->bool
Definition hl_fld : set -> set :=
  fun A:set => fun v_139129 :e 2 :^: A :^: A => hl_GSPEC A (fun GEN_PVAR_452 :e A => if exists x :e A, hl_SETSPEC A GEN_PVAR_452 (if exists y :e A, v_139129 x y = 1 \/ v_139129 y x = 1 then 1 else 0) x = 1 then 1 else 0).

// HOL Light: qoset : (A->A->bool)->bool
Definition hl_qoset : set -> set :=
  fun A:set => fun v_139184 :e 2 :^: A :^: A => if (forall x :e A, hl_IN A x (hl_fld A v_139184) = 1 -> v_139184 x x = 1) /\ forall x y z :e A, v_139184 x y = 1 /\ v_139184 y z = 1 -> v_139184 x z = 1 then 1 else 0.

// HOL Light: poset : (A->A->bool)->bool
Definition hl_poset : set -> set :=
  fun A:set => fun v_139189 :e 2 :^: A :^: A => if (forall x :e A, hl_IN A x (hl_fld A v_139189) = 1 -> v_139189 x x = 1) /\ ((forall x y z :e A, v_139189 x y = 1 /\ v_139189 y z = 1 -> v_139189 x z = 1) /\ forall x y :e A, v_139189 x y = 1 /\ v_139189 y x = 1 -> x = y) then 1 else 0.

// HOL Light: toset : (A->A->bool)->bool
Definition hl_toset : set -> set :=
  fun A:set => fun v_139194 :e 2 :^: A :^: A => if (forall x :e A, hl_IN A x (hl_fld A v_139194) = 1 -> v_139194 x x = 1) /\ ((forall x y z :e A, v_139194 x y = 1 /\ v_139194 y z = 1 -> v_139194 x z = 1) /\ ((forall x y :e A, v_139194 x y = 1 /\ v_139194 y x = 1 -> x = y) /\ forall x y :e A, hl_IN A x (hl_fld A v_139194) = 1 /\ hl_IN A y (hl_fld A v_139194) = 1 -> v_139194 x y = 1 \/ v_139194 y x = 1)) then 1 else 0.

// HOL Light: woset : (A->A->bool)->bool
Definition hl_woset : set -> set :=
  fun A:set => fun v_139199 :e 2 :^: A :^: A => if (forall x :e A, hl_IN A x (hl_fld A v_139199) = 1 -> v_139199 x x = 1) /\ ((forall x y z :e A, v_139199 x y = 1 /\ v_139199 y z = 1 -> v_139199 x z = 1) /\ ((forall x y :e A, v_139199 x y = 1 /\ v_139199 y x = 1 -> x = y) /\ ((forall x y :e A, hl_IN A x (hl_fld A v_139199) = 1 /\ hl_IN A y (hl_fld A v_139199) = 1 -> v_139199 x y = 1 \/ v_139199 y x = 1) /\ forall s :e 2 :^: A, hl_SUBSET A s (hl_fld A v_139199) = 1 /\ ~ s = hl_EMPTY A -> exists x :e A, hl_IN A x s = 1 /\ forall y :e A, hl_IN A y s = 1 -> v_139199 x y = 1))) then 1 else 0.

// HOL Light: wqoset : (A->A->bool)->bool
Definition hl_wqoset : set -> set :=
  fun A:set => fun v_139204 :e 2 :^: A :^: A => if (forall x :e A, hl_IN A x (hl_fld A v_139204) = 1 -> v_139204 x x = 1) /\ ((forall x y z :e A, v_139204 x y = 1 /\ v_139204 y z = 1 -> v_139204 x z = 1) /\ forall s :e 2 :^: A, hl_SUBSET A s (hl_fld A v_139204) = 1 -> exists t :e 2 :^: A, hl_FINITE A t = 1 /\ (hl_SUBSET A t s = 1 /\ forall y :e A, hl_IN A y s = 1 -> exists x :e A, hl_IN A x t = 1 /\ v_139204 x y = 1)) then 1 else 0.

// HOL Light: chain : (A->A->bool)->(A->bool)->bool
Definition hl_chain : set -> set :=
  fun A:set => fun v_139209 :e 2 :^: A :^: A => fun v_139210 :e 2 :^: A => if forall x y :e A, hl_IN A x v_139210 = 1 /\ hl_IN A y v_139210 = 1 -> v_139209 x y = 1 \/ v_139209 y x = 1 then 1 else 0.

// HOL Light: antichain : (A->A->bool)->(A->bool)->bool
Definition hl_antichain : set -> set :=
  fun A:set => fun v_139221 :e 2 :^: A :^: A => fun v_139222 :e 2 :^: A => if hl_SUBSET A v_139222 (hl_fld A v_139221) = 1 /\ hl_pairwise A (fun x :e A => fun y :e A => if ~ v_139221 x y = 1 then 1 else 0) v_139222 = 1 then 1 else 0.

// HOL Light: strictly : (A->A->bool)->A->A->bool
Definition hl_strictly : set -> set :=
  fun A:set => fun v_139874 :e 2 :^: A :^: A => fun x :e A => fun y :e A => if v_139874 x y = 1 /\ ~ v_139874 y x = 1 then 1 else 0.

// HOL Light: properly : (A->A->bool)->A->A->bool
Definition hl_properly : set -> set :=
  fun A:set => fun v_139879 :e 2 :^: A :^: A => fun x :e A => fun y :e A => if v_139879 x y = 1 /\ ~ x = y then 1 else 0.

// HOL Light: inseg : (A->A->bool)->(A->A->bool)->bool
Definition hl_inseg : set -> set :=
  fun A:set => fun v_144138 :e 2 :^: A :^: A => fun v_144139 :e 2 :^: A :^: A => if forall x y :e A, v_144138 x y = 1 <-> v_144139 x y = 1 /\ hl_fld A v_144138 y = 1 then 1 else 0.

// HOL Light: linseg : (A->A->bool)->A->A->A->bool
Definition hl_linseg : set -> set :=
  fun A:set => fun v_144210 :e 2 :^: A :^: A => fun v_144211 :e A => fun x :e A => fun y :e A => if v_144210 x y = 1 /\ hl_properly A v_144210 y v_144211 = 1 then 1 else 0.

// HOL Light: ordinal : (A->A->bool)->bool
Definition hl_ordinal : set -> set :=
  fun A:set => fun v_144222 :e 2 :^: A :^: A => if hl_woset A v_144222 = 1 /\ forall x :e A, hl_fld A v_144222 x = 1 -> x = hl_select A (fun y :e A => if ~ hl_properly A v_144222 y x = 1 then 1 else 0) then 1 else 0.

// HOL Light: +_c : (?191825->bool)->(?191824->bool)->(?191825,?191824)sum->bool
Definition hl_sym_2b5f63 : set -> set -> set :=
  fun T191825:set => fun T191824:set => fun v_226691 :e 2 :^: T191825 => fun v_226692 :e 2 :^: T191824 => hl_UNION (T191825 :+: T191824) (hl_GSPEC (T191825 :+: T191824) (fun GEN_PVAR_486 :e T191825 :+: T191824 => if exists x :e T191825, hl_SETSPEC (T191825 :+: T191824) GEN_PVAR_486 (hl_IN T191825 x v_226691) (hl_INL T191825 T191824 x) = 1 then 1 else 0)) (hl_GSPEC (T191825 :+: T191824) (fun GEN_PVAR_487 :e T191825 :+: T191824 => if exists y :e T191824, hl_SETSPEC (T191825 :+: T191824) GEN_PVAR_487 (hl_IN T191824 y v_226692) (hl_INR T191824 T191825 y) = 1 then 1 else 0)).

// HOL Light: *_c : (?191858->bool)->(?191857->bool)->?191858#?191857->bool
Definition hl_sym_2a5f63 : set -> set -> set :=
  fun T191858:set => fun T191857:set => fun v_226703 :e 2 :^: T191858 => fun v_226704 :e 2 :^: T191857 => hl_GSPEC (T191858 :*: T191857) (fun GEN_PVAR_488 :e T191858 :*: T191857 => if exists x :e T191858, exists y :e T191857, hl_SETSPEC (T191858 :*: T191857) GEN_PVAR_488 (if hl_IN T191858 x v_226703 = 1 /\ hl_IN T191857 y v_226704 = 1 then 1 else 0) (hl_pair T191858 T191857 x y) = 1 then 1 else 0).

// HOL Light: RC : (A->A->bool)->A->A->bool
Definition hl_RC : set -> set :=
  fun A:set => fun R1 :e 2 :^: A :^: A => fun a0 :e A => fun a1 :e A => if forall RC' :e 2 :^: A :^: A, (forall a01 a11 :e A, R1 a01 a11 = 1 \/ a11 = a01 -> RC' a01 a11 = 1) -> RC' a0 a1 = 1 then 1 else 0.

// HOL Light: SC : (A->A->bool)->A->A->bool
Definition hl_SC : set -> set :=
  fun A:set => fun R1 :e 2 :^: A :^: A => fun a0 :e A => fun a1 :e A => if forall SC' :e 2 :^: A :^: A, (forall a01 a11 :e A, R1 a01 a11 = 1 \/ SC' a11 a01 = 1 -> SC' a01 a11 = 1) -> SC' a0 a1 = 1 then 1 else 0.

// HOL Light: TC : (A->A->bool)->A->A->bool
Definition hl_TC : set -> set :=
  fun A:set => fun R1 :e 2 :^: A :^: A => fun a0 :e A => fun a1 :e A => if forall TC' :e 2 :^: A :^: A, (forall a01 a11 :e A, R1 a01 a11 = 1 \/ (exists y :e A, TC' a01 y = 1 /\ TC' y a11 = 1) -> TC' a01 a11 = 1) -> TC' a0 a1 = 1 then 1 else 0.

// HOL Light: RSC : (A->A->bool)->A->A->bool
Definition hl_RSC : set -> set :=
  fun A:set => fun v_263478 :e 2 :^: A :^: A => hl_RC A (hl_SC A v_263478).

// HOL Light: RTC : (A->A->bool)->A->A->bool
Definition hl_RTC : set -> set :=
  fun A:set => fun v_263602 :e 2 :^: A :^: A => hl_RC A (hl_TC A v_263602).

// HOL Light: STC : (A->A->bool)->A->A->bool
Definition hl_STC : set -> set :=
  fun A:set => fun v_265113 :e 2 :^: A :^: A => hl_TC A (hl_SC A v_265113).

// HOL Light: RSTC : (A->A->bool)->A->A->bool
Definition hl_RSTC : set -> set :=
  fun A:set => fun v_265405 :e 2 :^: A :^: A => hl_RC A (hl_TC A (hl_SC A v_265405)).

// HOL Light: INV : (B->A->bool)->A->B->bool
Definition hl_INV : set -> set -> set :=
  fun B:set => fun A:set => fun v_266350 :e 2 :^: A :^: B => fun v_266351 :e A => fun v_266352 :e B => v_266350 v_266352 v_266351.

// HOL Light: RELPOW : num->(A->A->bool)->A->A->bool
Definition hl_RELPOW : set -> set :=
  fun A:set => hl_select (2 :^: A :^: A :^: (2 :^: A :^: A) :^: omega :^: (omega :*: (omega :*: (omega :*: (omega :*: (omega :*: omega)))))) (fun RELPOW :e 2 :^: A :^: A :^: (2 :^: A :^: A) :^: omega :^: (omega :*: (omega :*: (omega :*: (omega :*: (omega :*: omega))))) => if forall v_266426 :e omega :*: (omega :*: (omega :*: (omega :*: (omega :*: omega)))), (forall R1 :e 2 :^: A :^: A, forall x y :e A, RELPOW v_266426 (hl_NUMERAL hl_zero) R1 x y = 1 <-> x = y) /\ forall n :e omega, forall x :e A, forall R1 :e 2 :^: A :^: A, forall y :e A, RELPOW v_266426 (hl_SUC n) R1 x y = 1 <-> exists z :e A, RELPOW v_266426 n R1 x z = 1 /\ R1 z y = 1 then 1 else 0) (hl_pair omega (omega :*: (omega :*: (omega :*: (omega :*: omega)))) (hl_NUMERAL (hl_BIT0 (hl_BIT1 (hl_BIT0 (hl_BIT0 (hl_BIT1 (hl_BIT0 (hl_BIT1 hl_zero)))))))) (hl_pair omega (omega :*: (omega :*: (omega :*: omega))) (hl_NUMERAL (hl_BIT1 (hl_BIT0 (hl_BIT1 (hl_BIT0 (hl_BIT0 (hl_BIT0 (hl_BIT1 hl_zero)))))))) (hl_pair omega (omega :*: (omega :*: omega)) (hl_NUMERAL (hl_BIT0 (hl_BIT0 (hl_BIT1 (hl_BIT1 (hl_BIT0 (hl_BIT0 (hl_BIT1 hl_zero)))))))) (hl_pair omega (omega :*: omega) (hl_NUMERAL (hl_BIT0 (hl_BIT0 (hl_BIT0 (hl_BIT0 (hl_BIT1 (hl_BIT0 (hl_BIT1 hl_zero)))))))) (hl_pair omega omega (hl_NUMERAL (hl_BIT1 (hl_BIT1 (hl_BIT1 (hl_BIT1 (hl_BIT0 (hl_BIT0 (hl_BIT1 hl_zero)))))))) (hl_NUMERAL (hl_BIT1 (hl_BIT1 (hl_BIT1 (hl_BIT0 (hl_BIT1 (hl_BIT0 (hl_BIT1 hl_zero))))))))))))).

// HOL Light: ITER : num->(?210900->?210900)->?210900->?210900
Definition hl_ITER : set -> set :=
  fun T210900:set => hl_select (T210900 :^: T210900 :^: (T210900 :^: T210900) :^: omega :^: (omega :*: (omega :*: (omega :*: omega)))) (fun ITER :e T210900 :^: T210900 :^: (T210900 :^: T210900) :^: omega :^: (omega :*: (omega :*: (omega :*: omega))) => if forall v_268497 :e omega :*: (omega :*: (omega :*: omega)), (forall x :e T210900, forall f :e T210900 :^: T210900, ITER v_268497 (hl_NUMERAL hl_zero) f x = x) /\ forall x :e T210900, forall f :e T210900 :^: T210900, forall n :e omega, ITER v_268497 (hl_SUC n) f x = f (ITER v_268497 n f x) then 1 else 0) (hl_pair omega (omega :*: (omega :*: omega)) (hl_NUMERAL (hl_BIT1 (hl_BIT0 (hl_BIT0 (hl_BIT1 (hl_BIT0 (hl_BIT0 (hl_BIT1 hl_zero)))))))) (hl_pair omega (omega :*: omega) (hl_NUMERAL (hl_BIT0 (hl_BIT0 (hl_BIT1 (hl_BIT0 (hl_BIT1 (hl_BIT0 (hl_BIT1 hl_zero)))))))) (hl_pair omega omega (hl_NUMERAL (hl_BIT1 (hl_BIT0 (hl_BIT1 (hl_BIT0 (hl_BIT0 (hl_BIT0 (hl_BIT1 hl_zero)))))))) (hl_NUMERAL (hl_BIT0 (hl_BIT1 (hl_BIT0 (hl_BIT0 (hl_BIT1 (hl_BIT0 (hl_BIT1 hl_zero))))))))))).

// HOL Light: inverse_mod : num->num->num
Definition hl_inverse_mod : set :=
  fun v_272813 :e omega => fun v_272814 :e omega => hl_COND omega (hl_le v_272813 (hl_NUMERAL (hl_BIT1 hl_zero))) (hl_NUMERAL (hl_BIT1 hl_zero)) (hl_select omega (fun y :e omega => if hl_lt y v_272813 = 1 /\ hl_sym_3d3d omega (hl_mul v_272814 y) (hl_num_gcd (hl_pair omega omega v_272813 v_272814)) (hl_num_mod v_272813) = 1 then 1 else 0)).

// HOL Light: squarefree : num->bool
Definition hl_squarefree : set :=
  fun v_273056 :e omega => if forall m :e omega, hl_num_divides (hl_EXP m (hl_NUMERAL (hl_BIT0 (hl_BIT1 hl_zero)))) v_273056 = 1 -> m = hl_NUMERAL (hl_BIT1 hl_zero) then 1 else 0.

// HOL Light: phi : num->num
Definition hl_phi : set :=
  fun v_275004 :e omega => hl_CARD omega (hl_GSPEC omega (fun GEN_PVAR_559 :e omega => if exists m :e omega, hl_SETSPEC omega GEN_PVAR_559 (if hl_lt (hl_NUMERAL hl_zero) m = 1 /\ (hl_le m v_275004 = 1 /\ hl_num_coprime (hl_pair omega omega m v_275004) = 1) then 1 else 0) m = 1 then 1 else 0)).

// HOL Light: order : num->num->num
Definition hl_order : set :=
  fun v_276438 :e omega => fun v_276439 :e omega => hl_select omega (fun d :e omega => if forall k :e omega, hl_sym_3d3d omega (hl_EXP v_276439 k) (hl_NUMERAL (hl_BIT1 hl_zero)) (hl_num_mod v_276438) = 1 <-> hl_num_divides d k = 1 then 1 else 0).

// HOL Light: primefact : num list->num->bool
Definition hl_primefact : set :=
  fun v_278984 :e finseq omega => fun v_278985 :e omega => if hl_ITLIST omega omega hl_mul v_278984 (hl_NUMERAL (hl_BIT1 hl_zero)) = v_278985 /\ forall p :e omega, hl_MEM omega p v_278984 = 1 -> hl_prime p = 1 then 1 else 0.
