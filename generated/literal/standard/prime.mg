// hol2mg literal statements (private): shard prime of profile standard.  Each theorem is the literal
...
Theorem hlt_FINITE_DIVISORS : forall n :e omega, ~ n = hl_NUMERAL hl_zero -> hl_FINITE omega (hl_GSPEC omega (fun GEN_PVAR_373 :e omega => if exists d :e omega, hl_SETSPEC omega GEN_PVAR_373 (hl_num_divides d n) d = 1 then 1 else 0)) = 1.
Admitted.

// HOL Light: Library/prime.ml:167 / FINITE_SPECIAL_DIVISORS   (hash md5:a30c91028849b689bd17b80e92b88c70)
Theorem hlt_FINITE_SPECIAL_DIVISORS : forall P :e 2 :^: omega, forall n :e omega, ~ n = hl_NUMERAL hl_zero -> hl_FINITE omega (hl_GSPEC omega (fun GEN_PVAR_375 :e omega => if exists d :e omega, hl_SETSPEC omega GEN_PVAR_375 (if P d = 1 /\ hl_num_divides d n = 1 then 1 else 0) d = 1 then 1 else 0)) = 1.
Admitted.
...
Theorem hlt_PRIMES_INFINITE : hl_INFINITE omega (hl_GSPEC omega (fun GEN_PVAR_376 :e omega => if exists p :e omega, hl_SETSPEC omega GEN_PVAR_376 (hl_prime p) p = 1 then 1 else 0)) = 1.
Admitted.
...
Theorem hlt_FINITE_EXP_LE : forall P :e 2 :^: omega, forall p n :e omega, hl_le (hl_NUMERAL (hl_BIT0 (hl_BIT1 hl_zero))) p = 1 -> hl_FINITE omega (hl_GSPEC omega (fun GEN_PVAR_377 :e omega => if exists j :e omega, hl_SETSPEC omega GEN_PVAR_377 (if P j = 1 /\ hl_le (hl_EXP p j) n = 1 then 1 else 0) j = 1 then 1 else 0)) = 1.
Admitted.

// HOL Light: Library/prime.ml:1234 / FINITE_INDICES   (hash md5:7b3d46d8986a0c4ea2040dcbd8f40072)
Theorem hlt_FINITE_INDICES : forall P :e 2 :^: omega, forall p n :e omega, hl_le (hl_NUMERAL (hl_BIT0 (hl_BIT1 hl_zero))) p = 1 /\ ~ n = hl_NUMERAL hl_zero -> hl_FINITE omega (hl_GSPEC omega (fun GEN_PVAR_379 :e omega => if exists j :e omega, hl_SETSPEC omega GEN_PVAR_379 (if P j = 1 /\ hl_num_divides (hl_EXP p j) n = 1 then 1 else 0) j = 1 then 1 else 0)) = 1.
Admitted.

// HOL Light: Library/prime.ml:1241 / index_def   (hash md5:6bd37732135c5f62978cb78e7e809cbc)
Theorem hlt_index_def : forall p n :e omega, hl_index p n = hl_COND omega (if hl_le p (hl_NUMERAL (hl_BIT1 hl_zero)) = 1 \/ n = hl_NUMERAL hl_zero then 1 else 0) (hl_NUMERAL hl_zero) (hl_CARD omega (hl_GSPEC omega (fun GEN_PVAR_380 :e omega => if exists j :e omega, hl_SETSPEC omega GEN_PVAR_380 (if hl_le (hl_NUMERAL (hl_BIT1 hl_zero)) j = 1 /\ hl_num_divides (hl_EXP p j) n = 1 then 1 else 0) j = 1 then 1 else 0))).
Admitted.
...
Theorem hlt_INDEX_FACT_ALT : forall p n :e omega, hl_prime p = 1 -> hl_index p (hl_FACT n) = hl_nsum omega (hl_GSPEC omega (fun GEN_PVAR_383 :e omega => if exists j :e omega, hl_SETSPEC omega GEN_PVAR_383 (if hl_le (hl_NUMERAL (hl_BIT1 hl_zero)) j = 1 /\ hl_le (hl_EXP p j) n = 1 then 1 else 0) j = 1 then 1 else 0)) (fun j :e omega => hl_DIV n (hl_EXP p j)).
Admitted.

// HOL Light: Library/prime.ml:1360 / INDEX_FACT_UNBOUNDED   (hash md5:d2d98716c76d68411d78bd064821001e)
Theorem hlt_INDEX_FACT_UNBOUNDED : forall p n :e omega, hl_prime p = 1 -> hl_index p (hl_FACT n) = hl_nsum omega (hl_GSPEC omega (fun GEN_PVAR_384 :e omega => if exists j :e omega, hl_SETSPEC omega GEN_PVAR_384 (hl_le (hl_NUMERAL (hl_BIT1 hl_zero)) j) j = 1 then 1 else 0)) (fun j :e omega => hl_DIV n (hl_EXP p j)).
Admitted.

// HOL Light: Library/prime.ml:1368 / PRIMEPOW_DIVIDES_FACT   (hash md5:8d3fe7c42f0b645b586e9d1a6fd11d42)
Theorem hlt_PRIMEPOW_DIVIDES_FACT : forall p n k :e omega, hl_prime p = 1 -> (hl_num_divides (hl_EXP p k) (hl_FACT n) = 1 <-> hl_le k (hl_nsum omega (hl_GSPEC omega (fun GEN_PVAR_385 :e omega => if exists j :e omega, hl_SETSPEC omega GEN_PVAR_385 (if hl_le (hl_NUMERAL (hl_BIT1 hl_zero)) j = 1 /\ hl_le (hl_EXP p j) n = 1 then 1 else 0) j = 1 then 1 else 0)) (fun j :e omega => hl_DIV n (hl_EXP p j))) = 1).
Admitted.
...
Theorem hlt_PRIME_FACTORIZATION_INDEX : forall k :e omega :^: omega, hl_FINITE omega (hl_GSPEC omega (fun GEN_PVAR_388 :e omega => if exists p :e omega, hl_SETSPEC omega GEN_PVAR_388 (if hl_prime p = 1 /\ ~ k p = hl_NUMERAL hl_zero then 1 else 0) p = 1 then 1 else 0)) = 1 -> exists n :e omega, ~ n = hl_NUMERAL hl_zero /\ forall p :e omega, hl_prime p = 1 -> hl_index p n = k p.
Admitted.
...
Theorem hlt_PRIME_FACTORIZATION_ALT : forall n :e omega, ~ n = hl_NUMERAL hl_zero -> hl_nproduct omega (hl_GSPEC omega (fun GEN_PVAR_389 :e omega => if exists p :e omega, hl_SETSPEC omega GEN_PVAR_389 (hl_prime p) p = 1 then 1 else 0)) (fun p :e omega => hl_EXP p (hl_index p n)) = n.
Admitted.

// HOL Light: Library/prime.ml:1767 / PRIME_FACTORIZATION   (hash md5:62d3fbcc6fd5fbedeb96c767afcfa3ec)
Theorem hlt_PRIME_FACTORIZATION : forall n :e omega, ~ n = hl_NUMERAL hl_zero -> hl_nproduct omega (hl_GSPEC omega (fun GEN_PVAR_390 :e omega => if exists p :e omega, hl_SETSPEC omega GEN_PVAR_390 (if hl_prime p = 1 /\ hl_num_divides p n = 1 then 1 else 0) p = 1 then 1 else 0)) (fun p :e omega => hl_EXP p (hl_index p n)) = n.
Admitted.
...
Theorem hlt_ITERATE_GCD_DIVIDES_EQ : forall K:set, K <> Empty -> forall f :e omega :^: K, forall k :e 2 :^: K, forall i :e K, hl_IN K i k = 1 -> (hl_num_divides (hl_iterate omega K (fun m :e omega => fun n :e omega => hl_num_gcd (hl_pair omega omega m n)) k f) (f i) = 1 <-> hl_FINITE K (hl_GSPEC K (fun GEN_PVAR_391 :e K => if exists j :e K, hl_SETSPEC K GEN_PVAR_391 (if hl_IN K j k = 1 /\ ~ f j = hl_NUMERAL hl_zero then 1 else 0) j = 1 then 1 else 0)) = 1 \/ f i = hl_NUMERAL hl_zero).
Admitted.
...
Theorem hlt_DIVIDES_ITERATE_GCD_GEN : forall K:set, K <> Empty -> forall f :e omega :^: K, forall k :e 2 :^: K, forall d :e omega, hl_num_divides d (hl_iterate omega K (fun m :e omega => fun n :e omega => hl_num_gcd (hl_pair omega omega m n)) k f) = 1 <-> hl_FINITE K (hl_GSPEC K (fun GEN_PVAR_392 :e K => if exists j :e K, hl_SETSPEC K GEN_PVAR_392 (if hl_IN K j k = 1 /\ ~ f j = hl_NUMERAL hl_zero then 1 else 0) j = 1 then 1 else 0)) = 1 -> forall i :e K, hl_IN K i k = 1 -> hl_num_divides d (f i) = 1.
Admitted.
...
Theorem hlt_DIVIDES_ITERATE_LCM_GEN : forall K:set, K <> Empty -> forall f :e omega :^: K, forall k :e 2 :^: K, forall i :e K, hl_IN K i k = 1 -> (hl_num_divides (f i) (hl_iterate omega K (fun m :e omega => fun n :e omega => hl_num_lcm (hl_pair omega omega m n)) k f) = 1 <-> hl_FINITE K (hl_GSPEC K (fun GEN_PVAR_393 :e K => if exists j :e K, hl_SETSPEC K GEN_PVAR_393 (if hl_IN K j k = 1 /\ ~ f j = hl_NUMERAL (hl_BIT1 hl_zero) then 1 else 0) j = 1 then 1 else 0)) = 1 \/ f i = hl_NUMERAL (hl_BIT1 hl_zero)).
Admitted.
...
Theorem hlt_ITERATE_LCM_DIVIDES_GEN : forall K:set, K <> Empty -> forall f :e omega :^: K, forall k :e 2 :^: K, forall n :e omega, hl_num_divides (hl_iterate omega K (fun m :e omega => fun n1 :e omega => hl_num_lcm (hl_pair omega omega m n1)) k f) n = 1 <-> hl_FINITE K (hl_GSPEC K (fun GEN_PVAR_394 :e K => if exists j :e K, hl_SETSPEC K GEN_PVAR_394 (if hl_IN K j k = 1 /\ ~ f j = hl_NUMERAL (hl_BIT1 hl_zero) then 1 else 0) j = 1 then 1 else 0)) = 1 -> forall i :e K, hl_IN K i k = 1 -> hl_num_divides (f i) n = 1.
Admitted.
...
Theorem hlt_PRIMEPOW_DIVIDES_ITERATE_LCM_GEN : forall K:set, K <> Empty -> forall f :e omega :^: K, forall k :e 2 :^: K, forall p m :e omega, hl_prime p = 1 -> (hl_num_divides (hl_EXP p m) (hl_iterate omega K (fun m1 :e omega => fun n :e omega => hl_num_lcm (hl_pair omega omega m1 n)) k f) = 1 <-> m = hl_NUMERAL hl_zero \/ hl_FINITE K (hl_GSPEC K (fun GEN_PVAR_395 :e K => if exists j :e K, hl_SETSPEC K GEN_PVAR_395 (if hl_IN K j k = 1 /\ ~ f j = hl_NUMERAL (hl_BIT1 hl_zero) then 1 else 0) j = 1 then 1 else 0)) = 1 /\ exists i :e K, hl_IN K i k = 1 /\ hl_num_divides (hl_EXP p m) (f i) = 1).
Admitted.

// HOL Light: Library/prime.ml:2193 / PRIME_DIVIDES_ITERATE_LCM_GEN   (hash md5:f969584edc34f74f707780b7aaec7edd)
Theorem hlt_PRIME_DIVIDES_ITERATE_LCM_GEN : forall K:set, K <> Empty -> forall f :e omega :^: K, forall k :e 2 :^: K, forall p :e omega, hl_prime p = 1 -> (hl_num_divides p (hl_iterate omega K (fun m :e omega => fun n :e omega => hl_num_lcm (hl_pair omega omega m n)) k f) = 1 <-> hl_FINITE K (hl_GSPEC K (fun GEN_PVAR_396 :e K => if exists j :e K, hl_SETSPEC K GEN_PVAR_396 (if hl_IN K j k = 1 /\ ~ f j = hl_NUMERAL (hl_BIT1 hl_zero) then 1 else 0) j = 1 then 1 else 0)) = 1 /\ exists i :e K, hl_IN K i k = 1 /\ hl_num_divides p (f i) = 1).
Admitted.
...
Theorem hlt_ITERATE_LCM_EQ_0_GEN : forall K:set, K <> Empty -> forall k :e 2 :^: K, forall f :e omega :^: K, hl_iterate omega K (fun m :e omega => fun n :e omega => hl_num_lcm (hl_pair omega omega m n)) k f = hl_NUMERAL hl_zero <-> hl_FINITE K (hl_GSPEC K (fun GEN_PVAR_399 :e K => if exists j :e K, hl_SETSPEC K GEN_PVAR_399 (if hl_IN K j k = 1 /\ ~ f j = hl_NUMERAL (hl_BIT1 hl_zero) then 1 else 0) j = 1 then 1 else 0)) = 1 /\ exists j :e K, hl_IN K j k = 1 /\ f j = hl_NUMERAL hl_zero.
Admitted.
...
Theorem hlt_ITERATE_GCD_EQ_0_GEN : forall K:set, K <> Empty -> forall k :e 2 :^: K, forall f :e omega :^: K, hl_iterate omega K (fun m :e omega => fun n :e omega => hl_num_gcd (hl_pair omega omega m n)) k f = hl_NUMERAL hl_zero <-> hl_FINITE K (hl_GSPEC K (fun GEN_PVAR_405 :e K => if exists j :e K, hl_SETSPEC K GEN_PVAR_405 (if hl_IN K j k = 1 /\ ~ f j = hl_NUMERAL hl_zero then 1 else 0) j = 1 then 1 else 0)) = 1 -> forall j :e K, hl_IN K j k = 1 -> f j = hl_NUMERAL hl_zero.
Admitted.
