// hol2mg literal statements (private): shard floor of profile standard.  Each theorem is the literal
...
Theorem hlt_HAS_SIZE_INTSEG_NUM : forall m n :e omega, hl_HAS_SIZE R (hl_GSPEC R (fun GEN_PVAR_415 :e R => if exists x :e R, hl_SETSPEC R GEN_PVAR_415 (if hl_integer x = 1 /\ (hl_real_le (hl_real_of_num m) x = 1 /\ hl_real_le x (hl_real_of_num n) = 1) then 1 else 0) x = 1 then 1 else 0)) (hl_sub (hl_add n (hl_NUMERAL (hl_BIT1 hl_zero))) m) = 1.
Admitted.

// HOL Light: Library/floor.ml:585 / FINITE_INTSEG   (hash md5:25660519ca8497f5686af7c7d4e01530)
Theorem hlt_FINITE_INTSEG : forall a b :e R, hl_FINITE R (hl_GSPEC R (fun GEN_PVAR_417 :e R => if exists x :e R, hl_SETSPEC R GEN_PVAR_417 (if hl_integer x = 1 /\ (hl_real_le a x = 1 /\ hl_real_le x b = 1) then 1 else 0) x = 1 then 1 else 0)) = 1.
Admitted.

// HOL Light: Library/floor.ml:604 / HAS_SIZE_INTSEG_INT   (hash md5:2c5815ed2fc6504f288d151e90ec971c)
Theorem hlt_HAS_SIZE_INTSEG_INT : forall a b :e R, hl_integer a = 1 /\ hl_integer b = 1 -> hl_HAS_SIZE R (hl_GSPEC R (fun GEN_PVAR_420 :e R => if exists x :e R, hl_SETSPEC R GEN_PVAR_420 (if hl_integer x = 1 /\ (hl_real_le a x = 1 /\ hl_real_le x b = 1) then 1 else 0) x = 1 then 1 else 0)) (hl_COND omega (hl_real_lt b a) (hl_NUMERAL hl_zero) (hl_num_of_int (hl_int_of_real (hl_real_add (hl_real_sub b a) (hl_real_of_num (hl_NUMERAL (hl_BIT1 hl_zero))))))) = 1.
Admitted.

// HOL Light: Library/floor.ml:630 / CARD_INTSEG_INT   (hash md5:2800252d64afe27f964f79101007a892)
Theorem hlt_CARD_INTSEG_INT : forall a b :e R, hl_integer a = 1 /\ hl_integer b = 1 -> hl_CARD R (hl_GSPEC R (fun GEN_PVAR_421 :e R => if exists x :e R, hl_SETSPEC R GEN_PVAR_421 (if hl_integer x = 1 /\ (hl_real_le a x = 1 /\ hl_real_le x b = 1) then 1 else 0) x = 1 then 1 else 0)) = hl_COND omega (hl_real_lt b a) (hl_NUMERAL hl_zero) (hl_num_of_int (hl_int_of_real (hl_real_add (hl_real_sub b a) (hl_real_of_num (hl_NUMERAL (hl_BIT1 hl_zero)))))).
Admitted.

// HOL Light: Library/floor.ml:638 / REAL_CARD_INTSEG_INT   (hash md5:4232f2ecf6963538bb6da80b38d2fe65)
Theorem hlt_REAL_CARD_INTSEG_INT : forall a b :e R, hl_integer a = 1 /\ hl_integer b = 1 -> hl_real_of_num (hl_CARD R (hl_GSPEC R (fun GEN_PVAR_422 :e R => if exists x :e R, hl_SETSPEC R GEN_PVAR_422 (if hl_integer x = 1 /\ (hl_real_le a x = 1 /\ hl_real_le x b = 1) then 1 else 0) x = 1 then 1 else 0))) = hl_COND R (hl_real_lt b a) (hl_real_of_num (hl_NUMERAL hl_zero)) (hl_real_add (hl_real_sub b a) (hl_real_of_num (hl_NUMERAL (hl_BIT1 hl_zero)))).
Admitted.
...
Theorem hlt_INFINITE_RATIONAL_IN_RANGE : forall a b :e R, hl_real_lt a b = 1 -> hl_INFINITE R (hl_GSPEC R (fun GEN_PVAR_423 :e R => if exists q :e R, hl_SETSPEC R GEN_PVAR_423 (if hl_rational q = 1 /\ (hl_real_lt a q = 1 /\ hl_real_lt q b = 1) then 1 else 0) q = 1 then 1 else 0)) = 1.
Admitted.
