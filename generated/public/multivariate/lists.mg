// Generated by hol2mg from HOL Light 433477862bb90b328a593e012e09390e99b2439b, profile multivariate, shard lists.
...
// HOL Light: lists.ml:77 / MEM
// Source hash: md5:e0472c3034cc7dc63e858905bbb6e42d
// Status: generalization_required (bridges: empty_case:A, hol_list_finseq)
...
// HOL Light: lists.ml:81 / ALL2_DEF
// Source hash: md5:05f0d882920f2505f89f2a84c1cd96a7
// Status: generalization_required (bridges: empty_case:A, hol_list_finseq)
...
// HOL Light: lists.ml:87 / ALL2
// Source hash: md5:b1f931b4c35afae213098fafc8984c88
// Status: generalization_required (bridges: empty_case:A, empty_case:B, hol_list_finseq)
...
// HOL Light: lists.ml:94 / MAP2_DEF
// Source hash: md5:132dd24cae8f7c26df87b26fc52a9f79
// Status: generalization_required (bridges: empty_case:A, hol_list_finseq)
...
// HOL Light: lists.ml:98 / MAP2
// Source hash: md5:1f34424eb953ced4a6af98ce77d6064e
// Status: generalization_required (bridges: empty_case:A, empty_case:B, hol_list_finseq)
...
// Status: generalization_required (bridges: empty_case:A, empty_case:B, hol_list_finseq, hol_prod_setprod)
...
// HOL Light: lists.ml:114 / ITLIST2_DEF
// Source hash: md5:66a918c3b024e404b398a0b6e52f44d4
// Status: generalization_required (bridges: empty_case:A, empty_case:C, hol_list_finseq)
...
// HOL Light: lists.ml:118 / ITLIST2
// Source hash: md5:806c92a11af80d573a20824facb83787
// Status: generalization_required (bridges: empty_case:A, empty_case:B, empty_case:C, hol_list_finseq)
...
// HOL Light: lists.ml:123 / ZIP_DEF
// Source hash: md5:6e2d7c78c5f2e5c31038cd05c1782067
// Status: generalization_required (bridges: empty_case:A, hol_list_finseq, hol_prod_setprod)
...
// HOL Light: lists.ml:127 / ZIP
// Source hash: md5:fd4494788599018ac29f29b4f2822be0
// Status: generalization_required (bridges: empty_case:A, empty_case:B, hol_list_finseq, hol_prod_setprod)
...
// HOL Light: lists.ml:132 / ALLPAIRS
// Source hash: md5:1030dd49ef6d6f70cf8c8a98f2734b3d
// Status: generalization_required (bridges: empty_case:A, hol_list_finseq)
...
// Source hash: md5:c4998480a49055100b294b5ff74a7003
// Status: transport_required (bridges: hol_list_finseq, hol_num_omega)
...
// HOL Light: lists.ml:148 / NOT_CONS_NIL
...
// Status: generalization_required (bridges: empty_case:A, hol_list_finseq, hol_num_omega, nat_lt_SNoLt)
...
// HOL Light: lists.ml:219 / LENGTH_REVERSE
// Source hash: md5:17c013973224e3dee52a9c818586a264
// Status: transport_required (bridges: hol_list_finseq, hol_num_omega)
...
// Source hash: md5:02447eaab41cdada267141a0ab2c2687
// Status: transport_required (bridges: hol_list_finseq)
...
// HOL Light: lists.ml:240 / NOT_EX
// Source hash: md5:4c09973e1cfa5822abdb256d3c655a88
// Status: transport_required (bridges: hol_list_finseq)
Theorem NOT_EX : forall A:set, A <> Empty -> forall P:set -> prop, forall l :e finseq A, ~ seq_ex P l <-> seq_all (fun x:set => ~ P x) l.
Admitted.

// HOL Light: lists.ml:245 / NOT_ALL
// Source hash: md5:4bc3240b21d38b2b3cf45c9b36ab840f
// Status: transport_required (bridges: hol_list_finseq)
Theorem NOT_ALL : forall A:set, A <> Empty -> forall P:set -> prop, forall l :e finseq A, ~ seq_all P l <-> seq_ex (fun x:set => ~ P x) l.
Admitted.

// HOL Light: lists.ml:250 / ALL_MAP
// Source hash: md5:0f6eaa20955e61ecced785b2b67da0a9
// Status: transport_required (bridges: hol_list_finseq)
...
// HOL Light: lists.ml:255 / ALL_EQ
// Source hash: md5:a9612881dce4440a96189975e8c668ce
// Status: transport_required (bridges: hol_list_finseq)
...
// HOL Light: lists.ml:262 / ALL_T
// Source hash: md5:1ef10b4f01356df5f7678160db331d50
// Status: transport_required (bridges: hol_list_finseq)
Theorem ALL_T : forall A:set, A <> Empty -> forall l :e finseq A, seq_all (fun x:set => True) l.
Admitted.

// HOL Light: lists.ml:266 / MAP_EQ_ALL2
// Source hash: md5:5873bdf08728aa876f1f063a2206bd4d
// Status: generalization_required (bridges: empty_case:A, hol_list_finseq)
...
// HOL Light: lists.ml:272 / ALL2_MAP
// Source hash: md5:e2caf4faab982154814cddd9f86ed0f1
// Status: transport_required (bridges: hol_list_finseq)
...
// Source hash: md5:3d794ca2edd1ddfef4b3be7863d04e50
// Status: transport_required (bridges: hol_list_finseq)
...
// Source hash: md5:d13c7903e336f50874d6fbb2e0e01efa
// Status: generalization_required (bridges: empty_case:A, empty_case:B, hol_list_finseq)
...
// HOL Light: lists.ml:299 / ALL_MP
// Source hash: md5:8f58295fa10e24df7a4af0a66b5fb117
// Status: transport_required (bridges: hol_list_finseq)
...
// HOL Light: lists.ml:304 / AND_ALL
// Source hash: md5:598933552a82047c8fcb589d544d4d05
// Status: transport_required (bridges: hol_list_finseq)
...
// HOL Light: lists.ml:309 / EX_IMP
// Source hash: md5:b83579acec443120e1a67e8f0a4550f1
// Status: transport_required (bridges: hol_list_finseq)
...
// HOL Light: lists.ml:314 / ALL_MEM
// Source hash: md5:5056d3db4b0de73fbe817f02698a3036
// Status: transport_required (bridges: hol_list_finseq)
Theorem ALL_MEM : forall A:set, A <> Empty -> forall P:set -> prop, forall l :e finseq A, (forall x :e A, seq_mem x l -> P x) <-> seq_all P l.
Admitted.

// HOL Light: lists.ml:319 / LENGTH_REPLICATE
// Source hash: md5:ea436d6e3dda4edef3e9c33e1650e12c
// Status: generalization_required (bridges: empty_case:A, hol_list_finseq, hol_num_omega)
Theorem LENGTH_REPLICATE : forall A:set, forall n :e omega, forall x :e A, seq_len (seq_replicate n x) = n.
Admitted.

// HOL Light: lists.ml:323 / MEM_REPLICATE
// Source hash: md5:88140f512a18ae84690618c6a49b626e
// Status: generalization_required (bridges: empty_case:A, hol_list_finseq, hol_num_omega)
Theorem MEM_REPLICATE : forall A:set, forall n :e omega, forall x y :e A, seq_mem x (seq_replicate n y) <-> x = y /\ ~ n = 0.
Admitted.

// HOL Light: lists.ml:328 / EX_MAP
// Source hash: md5:d621c58bd5cdfcecdbfb7a663680a360
// Status: transport_required (bridges: hol_list_finseq)
...
// Source hash: md5:65331249734eb4cc4e9441c91b6a2d51
// Status: generalization_required (bridges: empty_case:A, hol_list_finseq)
...
// HOL Light: lists.ml:347 / MEM_MAP
// Source hash: md5:efcc0ae65a5073ec9a7e1049fea67bdc
// Status: generalization_required (bridges: empty_case:B, hol_list_finseq)
...
// HOL Light: lists.ml:352 / FILTER_APPEND
// Source hash: md5:d4d93b5f36ebb171c6fddf63d85463d1
// Status: transport_required (bridges: hol_list_finseq)
...
// HOL Light: lists.ml:358 / FILTER_MAP
// Source hash: md5:1ef199560f30049cdd8cc0984c4dfff5
// Status: transport_required (bridges: hol_list_finseq)
...
// HOL Light: lists.ml:364 / MEM_FILTER
// Source hash: md5:39ddc253a1e4b67034a5db3986958b51
// Status: generalization_required (bridges: empty_case:A, hol_list_finseq)
...
// HOL Light: lists.ml:370 / LENGTH_FILTER
// Source hash: md5:f819a6c8161e197da7164838439a8944
...
// HOL Light: lists.ml:376 / EX_MEM
// Source hash: md5:dc236f3bb7a599b6add4c8d4d4fdc23f
// Status: transport_required (bridges: hol_list_finseq)
Theorem EX_MEM : forall A:set, A <> Empty -> forall P:set -> prop, forall l :e finseq A, (exists x :e A, P x /\ seq_mem x l) <-> seq_ex P l.
Admitted.

// HOL Light: lists.ml:381 / MAP_FST_ZIP
// Source hash: md5:3b52c86e60da8100259bbce8c718ace6
// Status: generalization_required (bridges: hol_list_finseq, hol_num_omega, hol_prod_setprod)
...
// HOL Light: lists.ml:387 / MAP_SND_ZIP
// Source hash: md5:ab1691b5345d2c7d820edad5c57c5686
// Status: generalization_required (bridges: hol_list_finseq, hol_num_omega, hol_prod_setprod)
...
// HOL Light: lists.ml:393 / LENGTH_ZIP
// Source hash: md5:a7bf6b5c7fc3e763c5d6d363dee05649
// Status: generalization_required (bridges: hol_list_finseq, hol_num_omega, hol_prod_setprod)
...
// HOL Light: lists.ml:399 / MEM_ASSOC
// Source hash: md5:dc073e622beda0ca861d2c4e9ed550a0
// Status: generalization_required (bridges: empty_case:A, hol_list_finseq, hol_prod_setprod)
...
// HOL Light: lists.ml:405 / ALL_APPEND
// Source hash: md5:0010b3895501ff7a5ff6e1d6798864ea
// Status: transport_required (bridges: hol_list_finseq)
...
// HOL Light: lists.ml:410 / MEM_EL
// Source hash: md5:114beac3511e6fe7508305290f9729d7
// Status: generalization_required (bridges: hol_list_finseq, hol_num_omega, nat_lt_SNoLt)
Theorem MEM_EL : forall A:set, A <> Empty -> forall l :e finseq A, forall n :e omega, n < seq_len l -> seq_mem (seq_nth l n) l.
Admitted.

// HOL Light: lists.ml:415 / MEM_EXISTS_EL
// Source hash: md5:4493491e0722295075cb34926b005eaa
// Status: generalization_required (bridges: empty_case:A, hol_list_finseq, hol_num_omega, nat_lt_SNoLt)
...
// HOL Light: lists.ml:422 / ALL_EL
// Source hash: md5:237e34a641b79831cfd0911e87fd72fd
// Status: generalization_required (bridges: hol_list_finseq, hol_num_omega, nat_lt_SNoLt)
...
// HOL Light: lists.ml:426 / ALL2_MAP2
// Source hash: md5:b81f14dfc5ba044192bd0ce1542135b6
// Status: transport_required (bridges: hol_list_finseq)
...
// HOL Light: lists.ml:432 / AND_ALL2
// Source hash: md5:a6e52c25066ce6e8132c25b40a38fd8d
// Status: transport_required (bridges: hol_list_finseq)
...
// HOL Light: lists.ml:439 / ALLPAIRS_SYM
...
// HOL Light: lists.ml:452 / ALLPAIRS_MAP
// Source hash: md5:f23de829602d7775e0cee60dfd35774c
// Status: transport_required (bridges: hol_list_finseq)
...
// HOL Light: lists.ml:458 / ALLPAIRS_EQ
// Source hash: md5:948fb2776481879cd9a3f3b4a954026e
// Status: transport_required (bridges: hol_list_finseq)
...
// HOL Light: lists.ml:464 / ALL2_ALL
// Source hash: md5:ad773421ed933244304c5e83c0f77d3c
// Status: transport_required (bridges: hol_list_finseq)
...
// Source hash: md5:8c4ba0d4c05300994d04fcf35bfd2317
// Status: generalization_required (bridges: empty_case:A, hol_list_finseq)
Theorem APPEND_LCANCEL : forall A:set, forall l1 l2 l3 :e finseq A, seq_append l1 l2 = seq_append l1 l3 <-> l2 = l3.
Admitted.

// HOL Light: lists.ml:477 / APPEND_RCANCEL
// Source hash: md5:7929e632510a0ef42809349c1908e7fc
// Status: generalization_required (bridges: empty_case:A, hol_list_finseq)
Theorem APPEND_RCANCEL : forall A:set, forall l1 l2 l3 :e finseq A, seq_append l1 l3 = seq_append l2 l3 <-> l1 = l2.
Admitted.

// HOL Light: lists.ml:483 / LENGTH_MAP2
// Source hash: md5:42acf0238a4233db18add111006f2bd1
// Status: generalization_required (bridges: hol_list_finseq, hol_num_omega)
...
// HOL Light: lists.ml:488 / EL_MAP2
// Source hash: md5:7dcce9680a2312a32a4141f7d677e5a6
// Status: generalization_required (bridges: hol_list_finseq, hol_num_omega, nat_lt_SNoLt)
...
// Source hash: md5:eb01dcdc910704add493aee7b5e61f6d
// Status: generalization_required (bridges: empty_case:A, hol_list_finseq)
...
// HOL Light: lists.ml:510 / SURJECTIVE_MAP
// Source hash: md5:c68eac62c1e2887631b83ac6bf4e7cf3
// Status: transport_required (bridges: hol_list_finseq)
...
// Source hash: md5:748e8eba07efd541bbb8f4cee28509db
// Status: generalization_required (bridges: hol_list_finseq, hol_num_omega, nat_lt_SNoLt)
...
// HOL Light: lists.ml:572 / EL_TL
// Source hash: md5:1c4e8150a9c01e601483be55a0dcfe79
// Status: generalization_required (bridges: add_nat_add_SNo, hol_list_finseq, hol_num_omega)
Theorem EL_TL : forall A:set, A <> Empty -> forall l :e finseq A, forall n :e omega, seq_nth (seq_tl l) n = seq_nth l (n + 1).
Admitted.

// HOL Light: lists.ml:576 / EL_CONS
// Source hash: md5:96bf1046e3cf9e37940e276d513bcf2d
// Status: generalization_required (bridges: empty_case:A, hol_list_finseq, hol_num_omega)
...
// Source hash: md5:540a91f3328e7f6a379a49ab731fe835
// Status: generalization_required (bridges: hol_list_finseq, hol_num_omega, nat_lt_SNoLt)
...
// HOL Light: lists.ml:599 / MAP_REVERSE
// Source hash: md5:038d08910009b286fad2d63812deec2f
// Status: transport_required (bridges: hol_list_finseq)
...
// HOL Light: lists.ml:604 / ALL_FILTER
// Source hash: md5:6fae4f4a0d9017f391f4c71232191e71
// Status: transport_required (bridges: hol_list_finseq)
...
// HOL Light: lists.ml:610 / APPEND_SING
// Source hash: md5:657b1648e9b6042cfb6163edb02d09ee
// Status: generalization_required (bridges: empty_case:A, hol_list_finseq)
Theorem APPEND_SING : forall A:set, forall h :e A, forall t :e finseq A, seq_append (seq_cons h seq_nil) t = seq_cons h t.
Admitted.

// HOL Light: lists.ml:614 / MEM_APPEND_DECOMPOSE_LEFT
// Source hash: md5:b6e9ffc4135587ba40aeaf58d991a37d
// Status: generalization_required (bridges: empty_case:A, hol_list_finseq)
...
// HOL Light: lists.ml:622 / MEM_APPEND_DECOMPOSE
// Source hash: md5:655abb7cee4ccc640944195ea244e94f
// Status: generalization_required (bridges: empty_case:A, hol_list_finseq)
...
// HOL Light: lists.ml:628 / PAIRWISE_APPEND
// Source hash: md5:df5224d6ab1447dbda247a059923c97e
// Status: transport_required (bridges: hol_list_finseq)
...
// HOL Light: lists.ml:636 / PAIRWISE_MAP
// Source hash: md5:2729e2a3e288fd1a4208cc9737da4dbb
// Status: transport_required (bridges: hol_list_finseq)
...
// HOL Light: lists.ml:642 / PAIRWISE_IMPLIES
// Source hash: md5:8d75040c7d2a055f4216d39f8ea08f8d
// Status: transport_required (bridges: hol_list_finseq)
...
// HOL Light: lists.ml:649 / PAIRWISE_TRANSITIVE
// Source hash: md5:602e07b92e365c30942cd7e171a820e7
// Status: generalization_required (bridges: empty_case:A, hol_list_finseq)
...
// HOL Light: lists.ml:660 / LENGTH_LIST_OF_SEQ
// Source hash: md5:6917348fe479f76feb31698a1ce30b03
// Status: transport_required (bridges: hol_list_finseq, hol_num_omega)
...
// HOL Light: lists.ml:665 / EL_LIST_OF_SEQ
// Source hash: md5:361e7b194afb22170b3ff15a20553c77
// Status: generalization_required (bridges: hol_list_finseq, hol_num_omega, nat_lt_SNoLt)
...
// HOL Light: lists.ml:672 / LIST_OF_SEQ_EQ_NIL
// Source hash: md5:13814f5ba3138c622e1efb0d01794f46
// Status: transport_required (bridges: hol_list_finseq, hol_num_omega)
...
// HOL Light: lists.ml:676 / LIST_OF_SEQ_EQ_SELF
// Source hash: md5:84a0ee00a59f235eff5a2665fe75758c
// Status: generalization_required (bridges: hol_list_finseq, hol_num_omega)
Theorem LIST_OF_SEQ_EQ_SELF : forall A:set, A <> Empty -> forall l :e finseq A, seq_mk (seq_len l) (fun i:set => seq_nth l i) = l.
Admitted.

// HOL Light: lists.ml:680 / LENGTH_EQ_LIST_OF_SEQ
// Source hash: md5:79e80582378ebd2d94081d9da4bb1f99
// Status: generalization_required (bridges: hol_list_finseq, hol_num_omega)
...
// HOL Light: lists.ml:684 / MAP_LIST_OF_SEQ
// Source hash: md5:9e3b62b49b5eec817e8fb9ed186f19bb
// Status: transport_required (bridges: hol_list_finseq, hol_num_omega)
...
// HOL Light: lists.ml:689 / LIST_OF_SEQ
// Source hash: md5:32afee83991c959f93b0d743ee582241
// Status: transport_required (bridges: hol_list_finseq, hol_num_omega)
...
// HOL Light: lists.ml:722 / MONO_ALL
// Source hash: md5:12dcd6b376bafee851fc134588275f08
// Status: transport_required (bridges: hol_list_finseq)
...
// HOL Light: lists.ml:727 / MONO_ALL2
// Source hash: md5:9aedd334a704373cb2ba0a5c9a1d1785
// Status: transport_required (bridges: hol_list_finseq)
