# hol2mg statement translation report: profile `core_prev`

- HOL Light commit: `9b510bc76da4cecf6e509be44d327c9236ec273f`
- theorems: 2983 discovered, 2683 public
- automatic definitions: 4 constants and 0 types generated, 5 not generated (NUM_REP: internal construction type ind; _22943: no carrier mapping for type constructor char (in char); ASCII: no carrier mapping for type constructor char (in char); _100472: unmapped constant _mk_tybit0 : (A,A)finite_sum recspace->A tybit0; _100491: unmapped constant _mk_tybit1 : ((A,A)finite_sum,1)finite_sum recspace->A tybit1)
...
- hol_sum_finsum (118)
- empty_case:B (97)
- hol_card_finite_cardinality (97)
- hol_nsum_finsum (90)
- choose_in_spec (71)
- hol_cart_setexp (54)
- hol_dimindex (50)
