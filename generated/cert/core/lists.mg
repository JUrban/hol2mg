...
exact (fun H__top A => (xm (A = Empty) (forall P:set -> prop, forall h :e A, forall t :e finseq A, (seq_all P seq_nil <-> True) /\ (seq_all P (seq_cons h t) <-> P h /\ seq_all P t)) (fun HAe => ((eq_sym_i A Empty HAe) (fun hl__u hl__v => forall P:set -> prop, forall h :e hl__u, forall t :e finseq hl__u, (seq_all P seq_nil <-> True) /\ (seq_all P (seq_cons h t) <-> P h /\ seq_all P t)) (fun P => (forall_in_Empty (fun h => forall t :e finseq Empty, (seq_all P seq_nil <-> True) /\ (seq_all P (seq_cons h t) <-> P h /\ seq_all P t)))))) (fun HAne => (imp_forall_pred (A) (fun P => forall h :e A, forall t :e finseq A, (hl_ALL A P (hl_NIL A) = 1 <-> True) /\ (hl_ALL A P (hl_CONS A h t) = 1 <-> P h = 1 /\ hl_ALL A P t = 1)) (fun P => forall h :e A, forall t :e finseq A, (seq_all P seq_nil <-> True) /\ (seq_all P (seq_cons h t) <-> P h /\ seq_all P t)) (fun P => (imp_forall_in (A) (fun h => forall t :e finseq A, (hl_ALL A (hl_chip A P) (hl_NIL A) = 1 <-> True) /\ (hl_ALL A (hl_chip A P) (hl_CONS A h t) = 1 <-> hl_chip A P h = 1 /\ hl_ALL A (hl_chip A P) t = 1)) (fun h => forall t :e finseq A, (seq_all P seq_nil <-> True) /\ (seq_all P (seq_cons h t) <-> P h /\ seq_all P t)) (fun h Hh => (imp_forall_in (finseq A) (fun t => (hl_ALL A (hl_chip A P) (hl_NIL A) = 1 <-> True) /\ (hl_ALL A (hl_chip A P) (hl_CONS A h t) = 1 <-> hl_chip A P h = 1 /\ hl_ALL A (hl_chip A P) t = 1)) (fun t => (seq_all P seq_nil <-> True) /\ (seq_all P (seq_cons h t) <-> P h /\ seq_all P t)) (fun t Ht => (imp_and (hl_ALL A (hl_chip A P) (hl_NIL A) = 1 <-> True) (seq_all P seq_nil <-> True) (hl_ALL A (hl_chip A P) (hl_CONS A h t) = 1 <-> hl_chip A P h = 1 /\ hl_ALL A (hl_chip A P) t = 1) (seq_all P (seq_cons h t) <-> P h /\ seq_all P t) (imp_iff (hl_ALL A (hl_chip A P) (hl_NIL A) = 1) (seq_all P seq_nil) (True) (True) (iffEL (hl_ALL A (hl_chip A P) (hl_NIL A) = 1) (seq_all P seq_nil) (((hl_NIL_compat) (A) HAne) (fun hl__u hl__v => hl_ALL A (hl_chip A P) (hl_NIL A) = 1 <-> seq_all P hl__u) ((hl_ALL_compat) (A) HAne (hl_chip A P) (hl_chip_Pi (A) P) (fun hl__x => (P) hl__x) ((hl_chip_iff (A) P)) (hl_NIL A) ((hl_NIL_in) (A) HAne)))) (iffER (hl_ALL A (hl_chip A P) (hl_NIL A) = 1) (seq_all P seq_nil) (((hl_NIL_compat) (A) HAne) (fun hl__u hl__v => hl_ALL A (hl_chip A P) (hl_NIL A) = 1 <-> seq_all P hl__u) ((hl_ALL_compat) (A) HAne (hl_chip A P) (hl_chip_Pi (A) P) (fun hl__x => (P) hl__x) ((hl_chip_iff (A) P)) (hl_NIL A) ((hl_NIL_in) (A) HAne)))) (imp_refl True) (imp_refl True)) (imp_iff (hl_ALL A (hl_chip A P) (hl_CONS A h t) = 1) (seq_all P (seq_cons h t)) (hl_chip A P h = 1 /\ hl_ALL A (hl_chip A P) t = 1) (P h /\ seq_all P t) (iffEL (hl_ALL A (hl_chip A P) (hl_CONS A h t) = 1) (seq_all P (seq_cons h t)) (((hl_CONS_compat) (A) HAne (h) Hh (t) Ht) (fun hl__u hl__v => hl_ALL A (hl_chip A P) (hl_CONS A h t) = 1 <-> seq_all P hl__u) ((hl_ALL_compat) (A) HAne (hl_chip A P) (hl_chip_Pi (A) P) (fun hl__x => (P) hl__x) ((hl_chip_iff (A) P)) (hl_CONS A h t) (setexp_ap (finseq A) (finseq A) (hl_CONS A h) (setexp_ap (A) (finseq A :^: finseq A) (hl_CONS A) ((hl_CONS_in) (A) HAne) (h) Hh) (t) Ht)))) (iffER (hl_ALL A (hl_chip A P) (hl_CONS A h t) = 1) (seq_all P (seq_cons h t)) (((hl_CONS_compat) (A) HAne (h) Hh (t) Ht) (fun hl__u hl__v => hl_ALL A (hl_chip A P) (hl_CONS A h t) = 1 <-> seq_all P hl__u) ((hl_ALL_compat) (A) HAne (hl_chip A P) (hl_chip_Pi (A) P) (fun hl__x => (P) hl__x) ((hl_chip_iff (A) P)) (hl_CONS A h t) (setexp_ap (finseq A) (finseq A) (hl_CONS A h) (setexp_ap (A) (finseq A :^: finseq A) (hl_CONS A) ((hl_CONS_in) (A) HAne) (h) Hh) (t) Ht)))) (imp_and (hl_chip A P h = 1) (P h) (hl_ALL A (hl_chip A P) t = 1) (seq_all P t) (iffEL (hl_chip A P h = 1) (P h) ((hl_chip_iff (A) P) (h) Hh)) (iffEL (hl_ALL A (hl_chip A P) t = 1) (seq_all P t) ((hl_ALL_compat) (A) HAne (hl_chip A P) (hl_chip_Pi (A) P) (fun hl__x => (P) hl__x) ((hl_chip_iff (A) P)) (t) Ht))) (imp_and (P h) (hl_chip A P h = 1) (seq_all P t) (hl_ALL A (hl_chip A P) t = 1) (iffER (hl_chip A P h = 1) (P h) ((hl_chip_iff (A) P) (h) Hh)) (iffER (hl_ALL A (hl_chip A P) t = 1) (seq_all P t) ((hl_ALL_compat) (A) HAne (hl_chip A P) (hl_chip_Pi (A) P) (fun hl__x => (P) hl__x) ((hl_chip_iff (A) P)) (t) Ht))))))))))) (H__top A HAne)))).
Qed.
...
exact (fun H__top A B HAne HBne => (imp_forall_fun (A) (B) (fun f => forall l1 l2 :e finseq A, hl_MAP A B f (hl_APPEND A l1 l2) = hl_APPEND B (hl_MAP A B f l1) (hl_MAP A B f l2)) (fun f => forall l1 l2 :e finseq A, seq_map f (seq_append l1 l2) = seq_append (seq_map f l1) (seq_map f l2)) (fun f Hfc => (imp_forall_in (finseq A) (fun l1 => forall l2 :e finseq A, hl_MAP A B (hl_lam A f) (hl_APPEND A l1 l2) = hl_APPEND B (hl_MAP A B (hl_lam A f) l1) (hl_MAP A B (hl_lam A f) l2)) (fun l1 => forall l2 :e finseq A, seq_map f (seq_append l1 l2) = seq_append (seq_map f l1) (seq_map f l2)) (fun l1 Hl1 => (imp_forall_in (finseq A) (fun l2 => hl_MAP A B (hl_lam A f) (hl_APPEND A l1 l2) = hl_APPEND B (hl_MAP A B (hl_lam A f) l1) (hl_MAP A B (hl_lam A f) l2)) (fun l2 => seq_map f (seq_append l1 l2) = seq_append (seq_map f l1) (seq_map f l2)) (fun l2 Hl2 => (imp_eq (hl_MAP A B (hl_lam A f) (hl_APPEND A l1 l2)) (seq_map f (seq_append l1 l2)) (hl_APPEND B (hl_MAP A B (hl_lam A f) l1) (hl_MAP A B (hl_lam A f) l2)) (seq_append (seq_map f l1) (seq_map f l2)) (((hl_APPEND_compat) (A) HAne (l1) Hl1 (l2) Hl2) (fun hl__u hl__v => hl_MAP A B (hl_lam A f) (hl_APPEND A l1 l2) = seq_map f hl__u) ((hl_MAP_compat) (A) (B) HAne HBne (hl_lam A f) (hl_lam_Pi (A) (B) f Hfc) (fun hl__x => (f) hl__x) ((hl_lam_ap (A) f)) (hl_APPEND A l1 l2) (setexp_ap (finseq A) (finseq A) (hl_APPEND A l1) (setexp_ap (finseq A) (finseq A :^: finseq A) (hl_APPEND A) ((hl_APPEND_in) (A) HAne) (l1) Hl1) (l2) Hl2))) (((hl_MAP_compat) (A) (B) HAne HBne (hl_lam A f) (hl_lam_Pi (A) (B) f Hfc) (fun hl__x => (f) hl__x) ((hl_lam_ap (A) f)) (l2) Hl2) (fun hl__u hl__v => hl_APPEND B (hl_MAP A B (hl_lam A f) l1) (hl_MAP A B (hl_lam A f) l2) = seq_append (seq_map f l1) hl__u) (((hl_MAP_compat) (A) (B) HAne HBne (hl_lam A f) (hl_lam_Pi (A) (B) f Hfc) (fun hl__x => (f) hl__x) ((hl_lam_ap (A) f)) (l1) Hl1) (fun hl__u hl__v => hl_APPEND B (hl_MAP A B (hl_lam A f) l1) (hl_MAP A B (hl_lam A f) l2) = seq_append hl__u (hl_MAP A B (hl_lam A f) l2)) ((hl_APPEND_compat) (B) HBne (hl_MAP A B (hl_lam A f) l1) (setexp_ap (finseq A) (finseq B) (hl_MAP A B (hl_lam A f)) (setexp_ap (B :^: A) (finseq B :^: finseq A) (hl_MAP A B) ((hl_MAP_in) (A) (B) HAne HBne) (hl_lam A f) (hl_lam_Pi (A) (B) f Hfc)) (l1) Hl1) (hl_MAP A B (hl_lam A f) l2) (setexp_ap (finseq A) (finseq B) (hl_MAP A B (hl_lam A f)) (setexp_ap (B :^: A) (finseq B :^: finseq A) (hl_MAP A B) ((hl_MAP_in) (A) (B) HAne HBne) (hl_lam A f) (hl_lam_Pi (A) (B) f Hfc)) (l2) Hl2))))))))))) (H__top A B HAne HBne)).
Qed.
...
exact (fun H__top A B HAne HBne => (imp_forall_fun (A) (B) (fun f => forall g :e B :^: A, forall l :e finseq A, hl_ALL A (fun x :e A => if f x = g x then 1 else 0) l = 1 -> hl_MAP A B f l = hl_MAP A B g l) (fun f => forall g:set -> set, (forall x :e A, g x :e B) -> forall l :e finseq A, seq_all (fun x:set => f x = g x) l -> seq_map f l = seq_map g l) (fun f Hfc => (imp_forall_fun (A) (B) (fun g => forall l :e finseq A, hl_ALL A (fun x :e A => if hl_lam A f x = g x then 1 else 0) l = 1 -> hl_MAP A B (hl_lam A f) l = hl_MAP A B g l) (fun g => forall l :e finseq A, seq_all (fun x:set => f x = g x) l -> seq_map f l = seq_map g l) (fun g Hgc => (imp_forall_in (finseq A) (fun l => hl_ALL A (fun x :e A => if hl_lam A f x = hl_lam A g x then 1 else 0) l = 1 -> hl_MAP A B (hl_lam A f) l = hl_MAP A B (hl_lam A g) l) (fun l => seq_all (fun x:set => f x = g x) l -> seq_map f l = seq_map g l) (fun l Hl => (fun H__L : ((hl_ALL A (fun x :e A => if hl_lam A f x = hl_lam A g x then 1 else 0) l = 1) -> (hl_MAP A B (hl_lam A f) l = hl_MAP A B (hl_lam A g) l)) => fun H__hyp3 : (seq_all (fun x:set => f x = g x) l) => (imp_eq (hl_MAP A B (hl_lam A f) l) (seq_map f l) (hl_MAP A B (hl_lam A g) l) (seq_map g l) ((hl_MAP_compat) (A) (B) HAne HBne (hl_lam A f) (hl_lam_Pi (A) (B) f Hfc) (fun hl__x => (f) hl__x) ((hl_lam_ap (A) f)) (l) Hl) ((hl_MAP_compat) (A) (B) HAne HBne (hl_lam A g) (hl_lam_Pi (A) (B) g Hgc) (fun hl__x => (g) hl__x) ((hl_lam_ap (A) g)) (l) Hl)) (H__L ((iffER (hl_ALL A (fun x :e A => if hl_lam A f x = hl_lam A g x then 1 else 0) l = 1) (seq_all (fun x:set => f x = g x) l) ((hl_ALL_compat) (A) HAne (fun x :e A => if hl_lam A f x = hl_lam A g x then 1 else 0) (lam_Pi (A) (fun _ => 2) (fun x => if hl_lam A f x = hl_lam A g x then 1 else 0) (fun x Hx => (If_in_2 (hl_lam A f x = hl_lam A g x)))) (fun x:set => f x = g x) ((fun x Hx => (iff_eq1_l ((fun x :e A => if hl_lam A f x = hl_lam A g x then 1 else 0) x) (if hl_lam A f x = hl_lam A g x then 1 else 0) (beta (A) (fun x => (if hl_lam A f x = hl_lam A g x then 1 else 0)) x Hx) (f x = g x) (iff_trans ((if hl_lam A f x = hl_lam A g x then 1 else 0) = 1) (hl_lam A f x = hl_lam A g x) (f x = g x) (If_1_iff (hl_lam A f x = hl_lam A g x)) (iffI (hl_lam A f x = hl_lam A g x) (f x = g x) (imp_eq (hl_lam A f x) (f x) (hl_lam A g x) (g x) ((hl_lam_ap (A) f) (x) Hx) ((hl_lam_ap (A) g) (x) Hx)) (imp_eq (f x) (hl_lam A f x) (g x) (hl_lam A g x) (eq_sym_i (hl_lam A f x) (f x) ((hl_lam_ap (A) f) (x) Hx)) (eq_sym_i (hl_lam A g x) (g x) ((hl_lam_ap (A) g) (x) Hx)))))))) (l) Hl)) H__hyp3))))))))) (H__top A B HAne HBne)).
Qed.
...
exact (fun H__top A HAne => (imp_forall_in (finseq A) (fun l => hl_ALL A (fun x :e A => if True then 1 else 0) l = 1) (fun l => seq_all (fun x:set => True) l) (fun l Hl => (iffEL (hl_ALL A (fun x :e A => if True then 1 else 0) l = 1) (seq_all (fun x:set => True) l) ((hl_ALL_compat) (A) HAne (fun x :e A => if True then 1 else 0) (lam_Pi (A) (fun _ => 2) (fun x => if True then 1 else 0) (fun x Hx => (If_in_2 (True)))) (fun x:set => True) ((fun x Hx => (iff_eq1_l ((fun x :e A => if True then 1 else 0) x) (if True then 1 else 0) (beta (A) (fun x => (if True then 1 else 0)) x Hx) (True) (iff_trans ((if True then 1 else 0) = 1) (True) (True) (If_1_iff (True)) (iffI (True) (True) (imp_refl True) (imp_refl True)))))) (l) Hl)))) (H__top A HAne)).
Qed.
...
exact (fun H__top A HAne => (imp_forall_in (finseq A) (fun l => forall f :e A :^: A, hl_ALL A (fun x :e A => if f x = x then 1 else 0) l = 1 -> hl_MAP A A f l = l) (fun l => forall f:set -> set, (forall x :e A, f x :e A) -> seq_all (fun x:set => f x = x) l -> seq_map f l = l) (fun l Hl => (imp_forall_fun (A) (A) (fun f => hl_ALL A (fun x :e A => if f x = x then 1 else 0) l = 1 -> hl_MAP A A f l = l) (fun f => seq_all (fun x:set => f x = x) l -> seq_map f l = l) (fun f Hfc => (fun H__L : ((hl_ALL A (fun x :e A => if hl_lam A f x = x then 1 else 0) l = 1) -> (hl_MAP A A (hl_lam A f) l = l)) => fun H__hyp2 : (seq_all (fun x:set => f x = x) l) => (imp_eq (hl_MAP A A (hl_lam A f) l) (seq_map f l) (l) (l) ((hl_MAP_compat) (A) (A) HAne HAne (hl_lam A f) (hl_lam_Pi (A) (A) f Hfc) (fun hl__x => (f) hl__x) ((hl_lam_ap (A) f)) (l) Hl) (fun q H => H)) (H__L ((iffER (hl_ALL A (fun x :e A => if hl_lam A f x = x then 1 else 0) l = 1) (seq_all (fun x:set => f x = x) l) ((hl_ALL_compat) (A) HAne (fun x :e A => if hl_lam A f x = x then 1 else 0) (lam_Pi (A) (fun _ => 2) (fun x => if hl_lam A f x = x then 1 else 0) (fun x Hx => (If_in_2 (hl_lam A f x = x)))) (fun x:set => f x = x) ((fun x Hx => (iff_eq1_l ((fun x :e A => if hl_lam A f x = x then 1 else 0) x) (if hl_lam A f x = x then 1 else 0) (beta (A) (fun x => (if hl_lam A f x = x then 1 else 0)) x Hx) (f x = x) (iff_trans ((if hl_lam A f x = x then 1 else 0) = 1) (hl_lam A f x = x) (f x = x) (If_1_iff (hl_lam A f x = x)) (iffI (hl_lam A f x = x) (f x = x) (imp_eq (hl_lam A f x) (f x) (x) (x) ((hl_lam_ap (A) f) (x) Hx) (fun q H => H)) (imp_eq (f x) (hl_lam A f x) (x) (x) (eq_sym_i (hl_lam A f x) (f x) ((hl_lam_ap (A) f) (x) Hx)) (eq_sym_i (x) (x) (fun q H => H)))))))) (l) Hl)) H__hyp2))))))) (H__top A HAne)).
Qed.
...
exact (fun H__top A HAne => (imp_forall_pred (A) (fun P => forall Q :e 2 :^: A, forall l :e finseq A, hl_ALL A (fun x :e A => if P x = 1 -> Q x = 1 then 1 else 0) l = 1 /\ hl_ALL A P l = 1 -> hl_ALL A Q l = 1) (fun P => forall Q:set -> prop, forall l :e finseq A, seq_all (fun x:set => P x -> Q x) l /\ seq_all P l -> seq_all Q l) (fun P => (imp_forall_pred (A) (fun Q => forall l :e finseq A, hl_ALL A (fun x :e A => if hl_chip A P x = 1 -> Q x = 1 then 1 else 0) l = 1 /\ hl_ALL A (hl_chip A P) l = 1 -> hl_ALL A Q l = 1) (fun Q => forall l :e finseq A, seq_all (fun x:set => P x -> Q x) l /\ seq_all P l -> seq_all Q l) (fun Q => (imp_forall_in (finseq A) (fun l => hl_ALL A (fun x :e A => if hl_chip A P x = 1 -> hl_chip A Q x = 1 then 1 else 0) l = 1 /\ hl_ALL A (hl_chip A P) l = 1 -> hl_ALL A (hl_chip A Q) l = 1) (fun l => seq_all (fun x:set => P x -> Q x) l /\ seq_all P l -> seq_all Q l) (fun l Hl => (fun H__L : ((hl_ALL A (fun x :e A => if hl_chip A P x = 1 -> hl_chip A Q x = 1 then 1 else 0) l = 1 /\ hl_ALL A (hl_chip A P) l = 1) -> (hl_ALL A (hl_chip A Q) l = 1)) => fun H__hyp3 : (seq_all (fun x:set => P x -> Q x) l /\ seq_all P l) => (iffEL (hl_ALL A (hl_chip A Q) l = 1) (seq_all Q l) ((hl_ALL_compat) (A) HAne (hl_chip A Q) (hl_chip_Pi (A) Q) (fun hl__x => (Q) hl__x) ((hl_chip_iff (A) Q)) (l) Hl)) (H__L ((imp_and (seq_all (fun x:set => P x -> Q x) l) (hl_ALL A (fun x :e A => if hl_chip A P x = 1 -> hl_chip A Q x = 1 then 1 else 0) l = 1) (seq_all P l) (hl_ALL A (hl_chip A P) l = 1) (iffER (hl_ALL A (fun x :e A => if hl_chip A P x = 1 -> hl_chip A Q x = 1 then 1 else 0) l = 1) (seq_all (fun x:set => P x -> Q x) l) ((hl_ALL_compat) (A) HAne (fun x :e A => if hl_chip A P x = 1 -> hl_chip A Q x = 1 then 1 else 0) (lam_Pi (A) (fun _ => 2) (fun x => if hl_chip A P x = 1 -> hl_chip A Q x = 1 then 1 else 0) (fun x Hx => (If_in_2 (hl_chip A P x = 1 -> hl_chip A Q x = 1)))) (fun x:set => P x -> Q x) ((fun x Hx => (iff_eq1_l ((fun x :e A => if hl_chip A P x = 1 -> hl_chip A Q x = 1 then 1 else 0) x) (if hl_chip A P x = 1 -> hl_chip A Q x = 1 then 1 else 0) (beta (A) (fun x => (if hl_chip A P x = 1 -> hl_chip A Q x = 1 then 1 else 0)) x Hx) (P x -> Q x) (iff_trans ((if hl_chip A P x = 1 -> hl_chip A Q x = 1 then 1 else 0) = 1) (hl_chip A P x = 1 -> hl_chip A Q x = 1) (P x -> Q x) (If_1_iff (hl_chip A P x = 1 -> hl_chip A Q x = 1)) (iffI (hl_chip A P x = 1 -> hl_chip A Q x = 1) (P x -> Q x) (fun H__L : ((hl_chip A P x = 1) -> (hl_chip A Q x = 1)) => fun H__hyp5 : (P x) => (iffEL (hl_chip A Q x = 1) (Q x) ((hl_chip_iff (A) Q) (x) Hx)) (H__L ((iffER (hl_chip A P x = 1) (P x) ((hl_chip_iff (A) P) (x) Hx)) H__hyp5))) (fun H__N : ((P x) -> (Q x)) => fun H__hyp6 : (hl_chip A P x = 1) => (iffER (hl_chip A Q x = 1) (Q x) ((hl_chip_iff (A) Q) (x) Hx)) (H__N ((iffEL (hl_chip A P x = 1) (P x) ((hl_chip_iff (A) P) (x) Hx)) H__hyp6)))))))) (l) Hl)) (iffER (hl_ALL A (hl_chip A P) l = 1) (seq_all P l) ((hl_ALL_compat) (A) HAne (hl_chip A P) (hl_chip_Pi (A) P) (fun hl__x => (P) hl__x) ((hl_chip_iff (A) P)) (l) Hl))) H__hyp3))))))))) (H__top A HAne)).
Qed.
...
exact (fun H__top A HAne => (imp_forall_pred (A) (fun P => forall Q :e 2 :^: A, forall l :e finseq A, hl_ALL A P l = 1 /\ hl_ALL A Q l = 1 <-> hl_ALL A (fun x :e A => if P x = 1 /\ Q x = 1 then 1 else 0) l = 1) (fun P => forall Q:set -> prop, forall l :e finseq A, seq_all P l /\ seq_all Q l <-> seq_all (fun x:set => P x /\ Q x) l) (fun P => (imp_forall_pred (A) (fun Q => forall l :e finseq A, hl_ALL A (hl_chip A P) l = 1 /\ hl_ALL A Q l = 1 <-> hl_ALL A (fun x :e A => if hl_chip A P x = 1 /\ Q x = 1 then 1 else 0) l = 1) (fun Q => forall l :e finseq A, seq_all P l /\ seq_all Q l <-> seq_all (fun x:set => P x /\ Q x) l) (fun Q => (imp_forall_in (finseq A) (fun l => hl_ALL A (hl_chip A P) l = 1 /\ hl_ALL A (hl_chip A Q) l = 1 <-> hl_ALL A (fun x :e A => if hl_chip A P x = 1 /\ hl_chip A Q x = 1 then 1 else 0) l = 1) (fun l => seq_all P l /\ seq_all Q l <-> seq_all (fun x:set => P x /\ Q x) l) (fun l Hl => (imp_iff (hl_ALL A (hl_chip A P) l = 1 /\ hl_ALL A (hl_chip A Q) l = 1) (seq_all P l /\ seq_all Q l) (hl_ALL A (fun x :e A => if hl_chip A P x = 1 /\ hl_chip A Q x = 1 then 1 else 0) l = 1) (seq_all (fun x:set => P x /\ Q x) l) (imp_and (hl_ALL A (hl_chip A P) l = 1) (seq_all P l) (hl_ALL A (hl_chip A Q) l = 1) (seq_all Q l) (iffEL (hl_ALL A (hl_chip A P) l = 1) (seq_all P l) ((hl_ALL_compat) (A) HAne (hl_chip A P) (hl_chip_Pi (A) P) (fun hl__x => (P) hl__x) ((hl_chip_iff (A) P)) (l) Hl)) (iffEL (hl_ALL A (hl_chip A Q) l = 1) (seq_all Q l) ((hl_ALL_compat) (A) HAne (hl_chip A Q) (hl_chip_Pi (A) Q) (fun hl__x => (Q) hl__x) ((hl_chip_iff (A) Q)) (l) Hl))) (imp_and (seq_all P l) (hl_ALL A (hl_chip A P) l = 1) (seq_all Q l) (hl_ALL A (hl_chip A Q) l = 1) (iffER (hl_ALL A (hl_chip A P) l = 1) (seq_all P l) ((hl_ALL_compat) (A) HAne (hl_chip A P) (hl_chip_Pi (A) P) (fun hl__x => (P) hl__x) ((hl_chip_iff (A) P)) (l) Hl)) (iffER (hl_ALL A (hl_chip A Q) l = 1) (seq_all Q l) ((hl_ALL_compat) (A) HAne (hl_chip A Q) (hl_chip_Pi (A) Q) (fun hl__x => (Q) hl__x) ((hl_chip_iff (A) Q)) (l) Hl))) (iffEL (hl_ALL A (fun x :e A => if hl_chip A P x = 1 /\ hl_chip A Q x = 1 then 1 else 0) l = 1) (seq_all (fun x:set => P x /\ Q x) l) ((hl_ALL_compat) (A) HAne (fun x :e A => if hl_chip A P x = 1 /\ hl_chip A Q x = 1 then 1 else 0) (lam_Pi (A) (fun _ => 2) (fun x => if hl_chip A P x = 1 /\ hl_chip A Q x = 1 then 1 else 0) (fun x Hx => (If_in_2 (hl_chip A P x = 1 /\ hl_chip A Q x = 1)))) (fun x:set => P x /\ Q x) ((fun x Hx => (iff_eq1_l ((fun x :e A => if hl_chip A P x = 1 /\ hl_chip A Q x = 1 then 1 else 0) x) (if hl_chip A P x = 1 /\ hl_chip A Q x = 1 then 1 else 0) (beta (A) (fun x => (if hl_chip A P x = 1 /\ hl_chip A Q x = 1 then 1 else 0)) x Hx) (P x /\ Q x) (iff_trans ((if hl_chip A P x = 1 /\ hl_chip A Q x = 1 then 1 else 0) = 1) (hl_chip A P x = 1 /\ hl_chip A Q x = 1) (P x /\ Q x) (If_1_iff (hl_chip A P x = 1 /\ hl_chip A Q x = 1)) (iffI (hl_chip A P x = 1 /\ hl_chip A Q x = 1) (P x /\ Q x) (imp_and (hl_chip A P x = 1) (P x) (hl_chip A Q x = 1) (Q x) (iffEL (hl_chip A P x = 1) (P x) ((hl_chip_iff (A) P) (x) Hx)) (iffEL (hl_chip A Q x = 1) (Q x) ((hl_chip_iff (A) Q) (x) Hx))) (imp_and (P x) (hl_chip A P x = 1) (Q x) (hl_chip A Q x = 1) (iffER (hl_chip A P x = 1) (P x) ((hl_chip_iff (A) P) (x) Hx)) (iffER (hl_chip A Q x = 1) (Q x) ((hl_chip_iff (A) Q) (x) Hx)))))))) (l) Hl)) (iffER (hl_ALL A (fun x :e A => if hl_chip A P x = 1 /\ hl_chip A Q x = 1 then 1 else 0) l = 1) (seq_all (fun x:set => P x /\ Q x) l) ((hl_ALL_compat) (A) HAne (fun x :e A => if hl_chip A P x = 1 /\ hl_chip A Q x = 1 then 1 else 0) (lam_Pi (A) (fun _ => 2) (fun x => if hl_chip A P x = 1 /\ hl_chip A Q x = 1 then 1 else 0) (fun x Hx => (If_in_2 (hl_chip A P x = 1 /\ hl_chip A Q x = 1)))) (fun x:set => P x /\ Q x) ((fun x Hx => (iff_eq1_l ((fun x :e A => if hl_chip A P x = 1 /\ hl_chip A Q x = 1 then 1 else 0) x) (if hl_chip A P x = 1 /\ hl_chip A Q x = 1 then 1 else 0) (beta (A) (fun x => (if hl_chip A P x = 1 /\ hl_chip A Q x = 1 then 1 else 0)) x Hx) (P x /\ Q x) (iff_trans ((if hl_chip A P x = 1 /\ hl_chip A Q x = 1 then 1 else 0) = 1) (hl_chip A P x = 1 /\ hl_chip A Q x = 1) (P x /\ Q x) (If_1_iff (hl_chip A P x = 1 /\ hl_chip A Q x = 1)) (iffI (hl_chip A P x = 1 /\ hl_chip A Q x = 1) (P x /\ Q x) (imp_and (hl_chip A P x = 1) (P x) (hl_chip A Q x = 1) (Q x) (iffEL (hl_chip A P x = 1) (P x) ((hl_chip_iff (A) P) (x) Hx)) (iffEL (hl_chip A Q x = 1) (Q x) ((hl_chip_iff (A) Q) (x) Hx))) (imp_and (P x) (hl_chip A P x = 1) (Q x) (hl_chip A Q x = 1) (iffER (hl_chip A P x = 1) (P x) ((hl_chip_iff (A) P) (x) Hx)) (iffER (hl_chip A Q x = 1) (Q x) ((hl_chip_iff (A) Q) (x) Hx)))))))) (l) Hl))))))))) (H__top A HAne)).
Qed.
...
exact (fun H__top A B HAne => (xm (B = Empty) (forall f:set -> set, (forall x :e A, f x :e B) -> forall y :e B, forall l :e finseq A, seq_mem y (seq_map f l) <-> exists x :e A, seq_mem x l /\ y = f x) (fun HBe => ((eq_sym_i B Empty HBe) (fun hl__u hl__v => forall f:set -> set, (forall x :e A, f x :e hl__u) -> forall y :e hl__u, forall l :e finseq A, seq_mem y (seq_map f l) <-> exists x :e A, seq_mem x l /\ y = f x) (fun f => (fun H : forall x :e A, f x :e Empty => (forall_in_Empty (fun y => forall l :e finseq A, seq_mem y (seq_map f l) <-> exists x :e A, seq_mem x l /\ y = f x)))))) (fun HBne => (imp_forall_fun (A) (B) (fun f => forall y :e B, forall l :e finseq A, hl_MEM B y (hl_MAP A B f l) = 1 <-> exists x :e A, hl_MEM A x l = 1 /\ y = f x) (fun f => forall y :e B, forall l :e finseq A, seq_mem y (seq_map f l) <-> exists x :e A, seq_mem x l /\ y = f x) (fun f Hfc => (imp_forall_in (B) (fun y => forall l :e finseq A, hl_MEM B y (hl_MAP A B (hl_lam A f) l) = 1 <-> exists x :e A, hl_MEM A x l = 1 /\ y = hl_lam A f x) (fun y => forall l :e finseq A, seq_mem y (seq_map f l) <-> exists x :e A, seq_mem x l /\ y = f x) (fun y Hy => (imp_forall_in (finseq A) (fun l => hl_MEM B y (hl_MAP A B (hl_lam A f) l) = 1 <-> exists x :e A, hl_MEM A x l = 1 /\ y = hl_lam A f x) (fun l => seq_mem y (seq_map f l) <-> exists x :e A, seq_mem x l /\ y = f x) (fun l Hl => (imp_iff (hl_MEM B y (hl_MAP A B (hl_lam A f) l) = 1) (seq_mem y (seq_map f l)) (exists x :e A, hl_MEM A x l = 1 /\ y = hl_lam A f x) (exists x :e A, seq_mem x l /\ y = f x) (iffEL (hl_MEM B y (hl_MAP A B (hl_lam A f) l) = 1) (seq_mem y (seq_map f l)) (((hl_MAP_compat) (A) (B) HAne HBne (hl_lam A f) (hl_lam_Pi (A) (B) f Hfc) (fun hl__x => (f) hl__x) ((hl_lam_ap (A) f)) (l) Hl) (fun hl__u hl__v => hl_MEM B y (hl_MAP A B (hl_lam A f) l) = 1 <-> seq_mem y hl__u) ((hl_MEM_compat) (B) HBne (y) Hy (hl_MAP A B (hl_lam A f) l) (setexp_ap (finseq A) (finseq B) (hl_MAP A B (hl_lam A f)) (setexp_ap (B :^: A) (finseq B :^: finseq A) (hl_MAP A B) ((hl_MAP_in) (A) (B) HAne HBne) (hl_lam A f) (hl_lam_Pi (A) (B) f Hfc)) (l) Hl)))) (iffER (hl_MEM B y (hl_MAP A B (hl_lam A f) l) = 1) (seq_mem y (seq_map f l)) (((hl_MAP_compat) (A) (B) HAne HBne (hl_lam A f) (hl_lam_Pi (A) (B) f Hfc) (fun hl__x => (f) hl__x) ((hl_lam_ap (A) f)) (l) Hl) (fun hl__u hl__v => hl_MEM B y (hl_MAP A B (hl_lam A f) l) = 1 <-> seq_mem y hl__u) ((hl_MEM_compat) (B) HBne (y) Hy (hl_MAP A B (hl_lam A f) l) (setexp_ap (finseq A) (finseq B) (hl_MAP A B (hl_lam A f)) (setexp_ap (B :^: A) (finseq B :^: finseq A) (hl_MAP A B) ((hl_MAP_in) (A) (B) HAne HBne) (hl_lam A f) (hl_lam_Pi (A) (B) f Hfc)) (l) Hl)))) (imp_exists_in (A) (fun x => hl_MEM A x l = 1 /\ y = hl_lam A f x) (fun x => seq_mem x l /\ y = f x) (fun x Hx => (imp_and (hl_MEM A x l = 1) (seq_mem x l) (y = hl_lam A f x) (y = f x) (iffEL (hl_MEM A x l = 1) (seq_mem x l) ((hl_MEM_compat) (A) HAne (x) Hx (l) Hl)) (imp_eq (y) (y) (hl_lam A f x) (f x) (fun q H => H) ((hl_lam_ap (A) f) (x) Hx))))) (imp_exists_in (A) (fun x => seq_mem x l /\ y = f x) (fun x => hl_MEM A x l = 1 /\ y = hl_lam A f x) (fun x Hx => (imp_and (seq_mem x l) (hl_MEM A x l = 1) (y = f x) (y = hl_lam A f x) (iffER (hl_MEM A x l = 1) (seq_mem x l) ((hl_MEM_compat) (A) HAne (x) Hx (l) Hl)) (imp_eq (y) (y) (f x) (hl_lam A f x) (eq_sym_i (y) (y) (fun q H => H)) (eq_sym_i (hl_lam A f x) (f x) ((hl_lam_ap (A) f) (x) Hx))))))))))))) (H__top A B HAne HBne)))).
Qed.
...
exact (fun H__top A HAne => (imp_forall_pred (A) (fun P => forall l1 l2 :e finseq A, hl_ALL A P (hl_APPEND A l1 l2) = 1 <-> hl_ALL A P l1 = 1 /\ hl_ALL A P l2 = 1) (fun P => forall l1 l2 :e finseq A, seq_all P (seq_append l1 l2) <-> seq_all P l1 /\ seq_all P l2) (fun P => (imp_forall_in (finseq A) (fun l1 => forall l2 :e finseq A, hl_ALL A (hl_chip A P) (hl_APPEND A l1 l2) = 1 <-> hl_ALL A (hl_chip A P) l1 = 1 /\ hl_ALL A (hl_chip A P) l2 = 1) (fun l1 => forall l2 :e finseq A, seq_all P (seq_append l1 l2) <-> seq_all P l1 /\ seq_all P l2) (fun l1 Hl1 => (imp_forall_in (finseq A) (fun l2 => hl_ALL A (hl_chip A P) (hl_APPEND A l1 l2) = 1 <-> hl_ALL A (hl_chip A P) l1 = 1 /\ hl_ALL A (hl_chip A P) l2 = 1) (fun l2 => seq_all P (seq_append l1 l2) <-> seq_all P l1 /\ seq_all P l2) (fun l2 Hl2 => (imp_iff (hl_ALL A (hl_chip A P) (hl_APPEND A l1 l2) = 1) (seq_all P (seq_append l1 l2)) (hl_ALL A (hl_chip A P) l1 = 1 /\ hl_ALL A (hl_chip A P) l2 = 1) (seq_all P l1 /\ seq_all P l2) (iffEL (hl_ALL A (hl_chip A P) (hl_APPEND A l1 l2) = 1) (seq_all P (seq_append l1 l2)) (((hl_APPEND_compat) (A) HAne (l1) Hl1 (l2) Hl2) (fun hl__u hl__v => hl_ALL A (hl_chip A P) (hl_APPEND A l1 l2) = 1 <-> seq_all P hl__u) ((hl_ALL_compat) (A) HAne (hl_chip A P) (hl_chip_Pi (A) P) (fun hl__x => (P) hl__x) ((hl_chip_iff (A) P)) (hl_APPEND A l1 l2) (setexp_ap (finseq A) (finseq A) (hl_APPEND A l1) (setexp_ap (finseq A) (finseq A :^: finseq A) (hl_APPEND A) ((hl_APPEND_in) (A) HAne) (l1) Hl1) (l2) Hl2)))) (iffER (hl_ALL A (hl_chip A P) (hl_APPEND A l1 l2) = 1) (seq_all P (seq_append l1 l2)) (((hl_APPEND_compat) (A) HAne (l1) Hl1 (l2) Hl2) (fun hl__u hl__v => hl_ALL A (hl_chip A P) (hl_APPEND A l1 l2) = 1 <-> seq_all P hl__u) ((hl_ALL_compat) (A) HAne (hl_chip A P) (hl_chip_Pi (A) P) (fun hl__x => (P) hl__x) ((hl_chip_iff (A) P)) (hl_APPEND A l1 l2) (setexp_ap (finseq A) (finseq A) (hl_APPEND A l1) (setexp_ap (finseq A) (finseq A :^: finseq A) (hl_APPEND A) ((hl_APPEND_in) (A) HAne) (l1) Hl1) (l2) Hl2)))) (imp_and (hl_ALL A (hl_chip A P) l1 = 1) (seq_all P l1) (hl_ALL A (hl_chip A P) l2 = 1) (seq_all P l2) (iffEL (hl_ALL A (hl_chip A P) l1 = 1) (seq_all P l1) ((hl_ALL_compat) (A) HAne (hl_chip A P) (hl_chip_Pi (A) P) (fun hl__x => (P) hl__x) ((hl_chip_iff (A) P)) (l1) Hl1)) (iffEL (hl_ALL A (hl_chip A P) l2 = 1) (seq_all P l2) ((hl_ALL_compat) (A) HAne (hl_chip A P) (hl_chip_Pi (A) P) (fun hl__x => (P) hl__x) ((hl_chip_iff (A) P)) (l2) Hl2))) (imp_and (seq_all P l1) (hl_ALL A (hl_chip A P) l1 = 1) (seq_all P l2) (hl_ALL A (hl_chip A P) l2 = 1) (iffER (hl_ALL A (hl_chip A P) l1 = 1) (seq_all P l1) ((hl_ALL_compat) (A) HAne (hl_chip A P) (hl_chip_Pi (A) P) (fun hl__x => (P) hl__x) ((hl_chip_iff (A) P)) (l1) Hl1)) (iffER (hl_ALL A (hl_chip A P) l2 = 1) (seq_all P l2) ((hl_ALL_compat) (A) HAne (hl_chip A P) (hl_chip_Pi (A) P) (fun hl__x => (P) hl__x) ((hl_chip_iff (A) P)) (l2) Hl2)))))))))) (H__top A HAne)).
Qed.
...
exact (fun H__top A B HAne HBne => (imp_forall_fun (A) (B) (fun f => forall l :e finseq A, hl_MAP A B f l = hl_NIL B <-> l = hl_NIL A) (fun f => forall l :e finseq A, seq_map f l = seq_nil <-> l = seq_nil) (fun f Hfc => (imp_forall_in (finseq A) (fun l => hl_MAP A B (hl_lam A f) l = hl_NIL B <-> l = hl_NIL A) (fun l => seq_map f l = seq_nil <-> l = seq_nil) (fun l Hl => (imp_iff (hl_MAP A B (hl_lam A f) l = hl_NIL B) (seq_map f l = seq_nil) (l = hl_NIL A) (l = seq_nil) (imp_eq (hl_MAP A B (hl_lam A f) l) (seq_map f l) (hl_NIL B) (seq_nil) ((hl_MAP_compat) (A) (B) HAne HBne (hl_lam A f) (hl_lam_Pi (A) (B) f Hfc) (fun hl__x => (f) hl__x) ((hl_lam_ap (A) f)) (l) Hl) ((hl_NIL_compat) (B) HBne)) (imp_eq (seq_map f l) (hl_MAP A B (hl_lam A f) l) (seq_nil) (hl_NIL B) (eq_sym_i (hl_MAP A B (hl_lam A f) l) (seq_map f l) ((hl_MAP_compat) (A) (B) HAne HBne (hl_lam A f) (hl_lam_Pi (A) (B) f Hfc) (fun hl__x => (f) hl__x) ((hl_lam_ap (A) f)) (l) Hl)) (eq_sym_i (hl_NIL B) (seq_nil) ((hl_NIL_compat) (B) HBne))) (imp_eq (l) (l) (hl_NIL A) (seq_nil) (fun q H => H) ((hl_NIL_compat) (A) HAne)) (imp_eq (l) (l) (seq_nil) (hl_NIL A) (eq_sym_i (l) (l) (fun q H => H)) (eq_sym_i (hl_NIL A) (seq_nil) ((hl_NIL_compat) (A) HAne)))))))) (H__top A B HAne HBne)).
Qed.
