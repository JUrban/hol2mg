...
exact (fun HL => (imp_forall_in (R) (fun x => forall y :e R, hl_real_add x y = hl_real_add y x) (fun x => forall y :e R, x + y = y + x) (fun x Hx => (imp_forall_in (R) (fun y => hl_real_add x y = hl_real_add y x) (fun y => x + y = y + x) (fun y Hy => (imp_eq (hl_real_add x y) (x + y) (hl_real_add y x) (y + x) ((hl_real_add_compat) (x) Hx (y) Hy) ((hl_real_add_compat) (y) Hy (x) Hx)))))) HL).
Qed.
...
exact (fun HL => (imp_forall_in (R) (fun x => forall y :e R, hl_real_le x y = 1 /\ hl_real_le y x = 1 <-> x = y) (fun x => forall y :e R, x <= y /\ y <= x <-> x = y) (fun x Hx => (imp_forall_in (R) (fun y => hl_real_le x y = 1 /\ hl_real_le y x = 1 <-> x = y) (fun y => x <= y /\ y <= x <-> x = y) (fun y Hy => (imp_iff (hl_real_le x y = 1 /\ hl_real_le y x = 1) (x <= y /\ y <= x) (x = y) (x = y) (imp_and (hl_real_le x y = 1) (x <= y) (hl_real_le y x = 1) (y <= x) (iffEL (hl_real_le x y = 1) (x <= y) ((hl_real_le_compat) (x) Hx (y) Hy)) (iffEL (hl_real_le y x = 1) (y <= x) ((hl_real_le_compat) (y) Hy (x) Hx))) (imp_and (x <= y) (hl_real_le x y = 1) (y <= x) (hl_real_le y x = 1) (iffER (hl_real_le x y = 1) (x <= y) ((hl_real_le_compat) (x) Hx (y) Hy)) (iffER (hl_real_le y x = 1) (y <= x) ((hl_real_le_compat) (y) Hy (x) Hx))) (imp_eq (x) (x) (y) (y) (fun q H => H) (fun q H => H)) (imp_eq (x) (x) (y) (y) (eq_sym_i (x) (x) (fun q H => H)) (eq_sym_i (y) (y) (fun q H => H)))))))) HL).
Qed.
...
exact (fun HL => (imp_forall_in (R) (fun x => forall y z :e R, hl_real_le y z = 1 -> hl_real_le (hl_real_add x y) (hl_real_add x z) = 1) (fun x => forall y z :e R, y <= z -> x + y <= x + z) (fun x Hx => (imp_forall_in (R) (fun y => forall z :e R, hl_real_le y z = 1 -> hl_real_le (hl_real_add x y) (hl_real_add x z) = 1) (fun y => forall z :e R, y <= z -> x + y <= x + z) (fun y Hy => (imp_forall_in (R) (fun z => hl_real_le y z = 1 -> hl_real_le (hl_real_add x y) (hl_real_add x z) = 1) (fun z => y <= z -> x + y <= x + z) (fun z Hz => (imp_imp (hl_real_le y z = 1) (y <= z) (hl_real_le (hl_real_add x y) (hl_real_add x z) = 1) (x + y <= x + z) (iffER (hl_real_le y z = 1) (y <= z) ((hl_real_le_compat) (y) Hy (z) Hz)) (iffEL (hl_real_le (hl_real_add x y) (hl_real_add x z) = 1) (x + y <= x + z) (((hl_real_add_compat) (x) Hx (z) Hz) (fun hl__u hl__v => hl_real_le (hl_real_add x y) (hl_real_add x z) = 1 <-> x + y <= hl__u) (((hl_real_add_compat) (x) Hx (y) Hy) (fun hl__u hl__v => hl_real_le (hl_real_add x y) (hl_real_add x z) = 1 <-> hl__u <= hl_real_add x z) ((hl_real_le_compat) (hl_real_add x y) (setexp_ap (R) (R) (hl_real_add x) (setexp_ap (R) (R :^: R) (hl_real_add) ((hl_real_add_in)) (x) Hx) (y) Hy) (hl_real_add x z) (setexp_ap (R) (R) (hl_real_add x) (setexp_ap (R) (R :^: R) (hl_real_add) ((hl_real_add_in)) (x) Hx) (z) Hz)))))))))))) HL).
Qed.
...
exact (fun HL => (imp_forall_in (R) (fun x => hl_real_le x x = 1) (fun x => x <= x) (fun x Hx => (iffEL (hl_real_le x x = 1) (x <= x) ((hl_real_le_compat) (x) Hx (x) Hx)))) HL).
Qed.
...
exact (fun HL => (imp_forall_in (R) (fun x => forall y :e R, hl_real_le x y = 1 \/ hl_real_le y x = 1) (fun x => forall y :e R, x <= y \/ y <= x) (fun x Hx => (imp_forall_in (R) (fun y => hl_real_le x y = 1 \/ hl_real_le y x = 1) (fun y => x <= y \/ y <= x) (fun y Hy => (imp_or (hl_real_le x y = 1) (x <= y) (hl_real_le y x = 1) (y <= x) (iffEL (hl_real_le x y = 1) (x <= y) ((hl_real_le_compat) (x) Hx (y) Hy)) (iffEL (hl_real_le y x = 1) (y <= x) ((hl_real_le_compat) (y) Hy (x) Hx))))))) HL).
Qed.
...
exact (fun HL => (imp_forall_in (R) (fun x => forall y z :e R, hl_real_le x y = 1 /\ hl_real_le y z = 1 -> hl_real_le x z = 1) (fun x => forall y z :e R, x <= y /\ y <= z -> x <= z) (fun x Hx => (imp_forall_in (R) (fun y => forall z :e R, hl_real_le x y = 1 /\ hl_real_le y z = 1 -> hl_real_le x z = 1) (fun y => forall z :e R, x <= y /\ y <= z -> x <= z) (fun y Hy => (imp_forall_in (R) (fun z => hl_real_le x y = 1 /\ hl_real_le y z = 1 -> hl_real_le x z = 1) (fun z => x <= y /\ y <= z -> x <= z) (fun z Hz => (imp_imp (hl_real_le x y = 1 /\ hl_real_le y z = 1) (x <= y /\ y <= z) (hl_real_le x z = 1) (x <= z) (imp_and (x <= y) (hl_real_le x y = 1) (y <= z) (hl_real_le y z = 1) (iffER (hl_real_le x y = 1) (x <= y) ((hl_real_le_compat) (x) Hx (y) Hy)) (iffER (hl_real_le y z = 1) (y <= z) ((hl_real_le_compat) (y) Hy (z) Hz))) (iffEL (hl_real_le x z = 1) (x <= z) ((hl_real_le_compat) (x) Hx (z) Hz))))))))) HL).
Qed.
...
exact (fun HL => (imp_forall_in (R) (fun x => forall y z :e R, hl_real_mul x (hl_real_mul y z) = hl_real_mul (hl_real_mul x y) z) (fun x => forall y z :e R, x * y * z = (x * y) * z) (fun x Hx => (imp_forall_in (R) (fun y => forall z :e R, hl_real_mul x (hl_real_mul y z) = hl_real_mul (hl_real_mul x y) z) (fun y => forall z :e R, x * y * z = (x * y) * z) (fun y Hy => (imp_forall_in (R) (fun z => hl_real_mul x (hl_real_mul y z) = hl_real_mul (hl_real_mul x y) z) (fun z => x * y * z = (x * y) * z) (fun z Hz => (imp_eq (hl_real_mul x (hl_real_mul y z)) (x * y * z) (hl_real_mul (hl_real_mul x y) z) ((x * y) * z) (((hl_real_mul_compat) (y) Hy (z) Hz) (fun hl__u hl__v => hl_real_mul x (hl_real_mul y z) = x * hl__u) ((hl_real_mul_compat) (x) Hx (hl_real_mul y z) (setexp_ap (R) (R) (hl_real_mul y) (setexp_ap (R) (R :^: R) (hl_real_mul) ((hl_real_mul_in)) (y) Hy) (z) Hz))) (((hl_real_mul_compat) (x) Hx (y) Hy) (fun hl__u hl__v => hl_real_mul (hl_real_mul x y) z = hl__u * z) ((hl_real_mul_compat) (hl_real_mul x y) (setexp_ap (R) (R) (hl_real_mul x) (setexp_ap (R) (R :^: R) (hl_real_mul) ((hl_real_mul_in)) (x) Hx) (y) Hy) (z) Hz))))))))) HL).
Qed.
...
exact (fun HL => (imp_forall_in (R) (fun x => ~ x = hl_real_of_num (hl_NUMERAL hl_zero) -> hl_real_mul (hl_real_inv x) x = hl_real_of_num (hl_NUMERAL (hl_BIT1 hl_zero))) (fun x => ~ x = 0 -> recip_SNo x * x = 1) (fun x Hx => (imp_imp (~ x = hl_real_of_num (hl_NUMERAL hl_zero)) (~ x = 0) (hl_real_mul (hl_real_inv x) x = hl_real_of_num (hl_NUMERAL (hl_BIT1 hl_zero))) (recip_SNo x * x = 1) (imp_not (x = 0) (x = hl_real_of_num (hl_NUMERAL hl_zero)) (imp_eq (x) (x) (hl_real_of_num (hl_NUMERAL hl_zero)) (0) (fun q H => H) ((eq_trans_i (hl_NUMERAL hl_zero) (hl_zero) 0 (hl_NUMERAL_compat (hl_zero) ((eq_sym_i (hl_zero) 0 hl_zero_compat) (fun hl__u hl__v => hl__u :e omega) (nat_p_omega 0 nat_0))) hl_zero_compat) (fun hl__u hl__v => hl_real_of_num (hl_NUMERAL hl_zero) = hl__u) ((hl_real_of_num_compat) (hl_NUMERAL hl_zero) (setexp_ap (omega) (omega) (hl_NUMERAL) ((hl_NUMERAL_in)) (hl_zero) ((hl_zero_in))))))) (imp_eq (hl_real_mul (hl_real_inv x) x) (recip_SNo x * x) (hl_real_of_num (hl_NUMERAL (hl_BIT1 hl_zero))) (1) (((hl_real_inv_compat) (x) Hx) (fun hl__u hl__v => hl_real_mul (hl_real_inv x) x = hl__u * x) ((hl_real_mul_compat) (hl_real_inv x) (setexp_ap (R) (R) (hl_real_inv) ((hl_real_inv_in)) (x) Hx) (x) Hx)) ((eq_trans_i (hl_NUMERAL (hl_BIT1 hl_zero)) (hl_BIT1 hl_zero) 1 (hl_NUMERAL_compat (hl_BIT1 hl_zero) ((eq_sym_i (hl_BIT1 hl_zero) 1 (eq_trans_i (hl_BIT1 hl_zero) (ordsucc (hl_BIT0 (hl_zero))) 1 (hl_BIT1_S (hl_zero) ((eq_sym_i (hl_zero) 0 hl_zero_compat) (fun hl__u hl__v => hl__u :e omega) (nat_p_omega 0 nat_0))) (f_equal (fun x => ordsucc x) (hl_BIT0 (hl_zero)) 0 (eq_trans_i (hl_BIT0 (hl_zero)) (hl_BIT0 0) 0 (f_equal (fun x => hl_BIT0 x) (hl_zero) 0 hl_zero_compat) hl_BIT0_0)))) (fun hl__u hl__v => hl__u :e omega) (nat_p_omega 1 (nat_ordsucc 0 (omega_nat_p 0 (nat_p_omega 0 nat_0)))))) (eq_trans_i (hl_BIT1 hl_zero) (ordsucc (hl_BIT0 (hl_zero))) 1 (hl_BIT1_S (hl_zero) ((eq_sym_i (hl_zero) 0 hl_zero_compat) (fun hl__u hl__v => hl__u :e omega) (nat_p_omega 0 nat_0))) (f_equal (fun x => ordsucc x) (hl_BIT0 (hl_zero)) 0 (eq_trans_i (hl_BIT0 (hl_zero)) (hl_BIT0 0) 0 (f_equal (fun x => hl_BIT0 x) (hl_zero) 0 hl_zero_compat) hl_BIT0_0)))) (fun hl__u hl__v => hl_real_of_num (hl_NUMERAL (hl_BIT1 hl_zero)) = hl__u) ((hl_real_of_num_compat) (hl_NUMERAL (hl_BIT1 hl_zero)) (setexp_ap (omega) (omega) (hl_NUMERAL) ((hl_NUMERAL_in)) (hl_BIT1 hl_zero) (setexp_ap (omega) (omega) (hl_BIT1) ((hl_BIT1_in)) (hl_zero) ((hl_zero_in)))))))))) HL).
Qed.
...
exact (fun HL => (imp_forall_in (R) (fun x => forall y :e R, hl_real_mul x y = hl_real_mul y x) (fun x => forall y :e R, x * y = y * x) (fun x Hx => (imp_forall_in (R) (fun y => hl_real_mul x y = hl_real_mul y x) (fun y => x * y = y * x) (fun y Hy => (imp_eq (hl_real_mul x y) (x * y) (hl_real_mul y x) (y * x) ((hl_real_mul_compat) (x) Hx (y) Hy) ((hl_real_mul_compat) (y) Hy (x) Hx)))))) HL).
Qed.
...
exact (fun HL => (imp_forall_in (omega) (fun m => forall n :e omega, hl_real_of_num m = hl_real_of_num n <-> m = n) (fun m => forall n :e omega, m = n <-> m = n) (fun m Hm => (imp_forall_in (omega) (fun n => hl_real_of_num m = hl_real_of_num n <-> m = n) (fun n => m = n <-> m = n) (fun n Hn => (imp_iff (hl_real_of_num m = hl_real_of_num n) (m = n) (m = n) (m = n) (imp_eq (hl_real_of_num m) (m) (hl_real_of_num n) (n) ((hl_real_of_num_compat) (m) Hm) ((hl_real_of_num_compat) (n) Hn)) (imp_eq (m) (hl_real_of_num m) (n) (hl_real_of_num n) (eq_sym_i (hl_real_of_num m) (m) ((hl_real_of_num_compat) (m) Hm)) (eq_sym_i (hl_real_of_num n) (n) ((hl_real_of_num_compat) (n) Hn))) (imp_eq (m) (m) (n) (n) (fun q H => H) (fun q H => H)) (imp_eq (m) (m) (n) (n) (eq_sym_i (m) (m) (fun q H => H)) (eq_sym_i (n) (n) (fun q H => H)))))))) HL).
Qed.
