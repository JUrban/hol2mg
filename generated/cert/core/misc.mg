...
exact (fun H__top => (imp_forall_in (R) (fun x => forall y :e R, hl_real_le x y = 1 /\ hl_real_le y x = 1 <-> x = y) (fun x => forall y :e R, x <= y /\ y <= x <-> x = y) (fun x Hx => (imp_forall_in (R) (fun y => hl_real_le x y = 1 /\ hl_real_le y x = 1 <-> x = y) (fun y => x <= y /\ y <= x <-> x = y) (fun y Hy => (imp_iff (hl_real_le x y = 1 /\ hl_real_le y x = 1) (x <= y /\ y <= x) (x = y) (x = y) (imp_and (hl_real_le x y = 1) (x <= y) (hl_real_le y x = 1) (y <= x) (iffEL (hl_real_le x y = 1) (x <= y) ((hl_real_le_compat) (x) Hx (y) Hy)) (iffEL (hl_real_le y x = 1) (y <= x) ((hl_real_le_compat) (y) Hy (x) Hx))) (imp_and (x <= y) (hl_real_le x y = 1) (y <= x) (hl_real_le y x = 1) (iffER (hl_real_le x y = 1) (x <= y) ((hl_real_le_compat) (x) Hx (y) Hy)) (iffER (hl_real_le y x = 1) (y <= x) ((hl_real_le_compat) (y) Hy (x) Hx))) (imp_eq (x) (x) (y) (y) (fun q H => H) (fun q H => H)) (imp_eq (x) (x) (y) (y) (eq_sym_i (x) (x) (fun q H => H)) (eq_sym_i (y) (y) (fun q H => H)))))))) H__top).
Qed.
