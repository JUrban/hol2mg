...
exact (fun HL A B HBne => (xm (A = Empty) (forall f:set -> set, (forall x :e A, f x :e B) -> forall g:set -> set, (forall x :e A, g x :e B) -> (forall x :e A, f x = g x) -> forall x :e A, f x = g x) (fun HAe => ((eq_sym_i A Empty HAe) (fun hl__u hl__v => forall f:set -> set, (forall x :e hl__u, f x :e B) -> forall g:set -> set, (forall x :e hl__u, g x :e B) -> (forall x :e hl__u, f x = g x) -> forall x :e hl__u, f x = g x) (fun f => (fun H : forall x :e Empty, f x :e B => (fun g => (fun H : forall x :e Empty, g x :e B => (fun H : forall x :e Empty, f x = g x => (forall_in_Empty (fun x => f x = g x))))))))) (fun HAne => (imp_forall_fun (A) (B) (fun f => forall g :e B :^: A, (forall x :e A, f x = g x) -> f = g) (fun f => forall g:set -> set, (forall x :e A, g x :e B) -> (forall x :e A, f x = g x) -> forall x :e A, f x = g x) (fun f Hfc => (imp_forall_fun (A) (B) (fun g => (forall x :e A, hl_lam A f x = g x) -> hl_lam A f = g) (fun g => (forall x :e A, f x = g x) -> forall x :e A, f x = g x) (fun g Hgc => (imp_imp (forall x :e A, hl_lam A f x = hl_lam A g x) (forall x :e A, f x = g x) (hl_lam A f = hl_lam A g) (forall x :e A, f x = g x) (imp_forall_in (A) (fun x => f x = g x) (fun x => hl_lam A f x = hl_lam A g x) (fun x Hx => (imp_eq (f x) (hl_lam A f x) (g x) (hl_lam A g x) (eq_sym_i (hl_lam A f x) (f x) ((hl_lam_ap (A) f) (x) Hx)) (eq_sym_i (hl_lam A g x) (g x) ((hl_lam_ap (A) g) (x) Hx))))) (imp_trans (hl_lam A f = hl_lam A g) (forall x :e A, hl_lam A f x = hl_lam A g x) (forall x :e A, f x = g x) (iffEL (hl_lam A f = hl_lam A g) (forall x :e A, hl_lam A f x = hl_lam A g x) (eq_Pi_pointwise (A) (B) (hl_lam A f) (hl_lam A g) (hl_lam_Pi (A) (B) f Hfc) (hl_lam_Pi (A) (B) g Hgc))) (imp_forall_in (A) (fun x => hl_lam A f x = hl_lam A g x) (fun x => f x = g x) (fun x Hx => (imp_eq (hl_lam A f x) (f x) (hl_lam A g x) (g x) ((hl_lam_ap (A) f) (x) Hx) ((hl_lam_ap (A) g) (x) Hx)))))))))) (HL A B HAne HBne)))).
Qed.
...
exact (fun HL => (imp_forall_bool (fun t => t = 1 \/ ~ t = 1) (fun t => t \/ ~ t) (fun t => (imp_or ((if t then 1 else 0) = 1) (t) (~ (if t then 1 else 0) = 1) (~ t) (iffEL ((if t then 1 else 0) = 1) (t) (If_1_iff t)) (imp_not ((if t then 1 else 0) = 1) (t) (iffER ((if t then 1 else 0) = 1) (t) (If_1_iff t)))))) HL).
Qed.
...
exact (fun HL => (imp_forall_bool (fun t1 => forall t2 :e 2, ~ (t1 = 1 -> t2 = 1) <-> t1 = 1 /\ ~ t2 = 1) (fun t1 => forall t2:prop, ~ (t1 -> t2) <-> t1 /\ ~ t2) (fun t1 => (imp_forall_bool (fun t2 => ~ ((if t1 then 1 else 0) = 1 -> t2 = 1) <-> (if t1 then 1 else 0) = 1 /\ ~ t2 = 1) (fun t2 => ~ (t1 -> t2) <-> t1 /\ ~ t2) (fun t2 => (imp_iff (~ ((if t1 then 1 else 0) = 1 -> (if t2 then 1 else 0) = 1)) (~ (t1 -> t2)) ((if t1 then 1 else 0) = 1 /\ ~ (if t2 then 1 else 0) = 1) (t1 /\ ~ t2) (imp_not ((if t1 then 1 else 0) = 1 -> (if t2 then 1 else 0) = 1) (t1 -> t2) (imp_imp (t1) ((if t1 then 1 else 0) = 1) (t2) ((if t2 then 1 else 0) = 1) (iffEL ((if t1 then 1 else 0) = 1) (t1) (If_1_iff t1)) (iffER ((if t2 then 1 else 0) = 1) (t2) (If_1_iff t2)))) (imp_not (t1 -> t2) ((if t1 then 1 else 0) = 1 -> (if t2 then 1 else 0) = 1) (imp_imp ((if t1 then 1 else 0) = 1) (t1) ((if t2 then 1 else 0) = 1) (t2) (iffER ((if t1 then 1 else 0) = 1) (t1) (If_1_iff t1)) (iffEL ((if t2 then 1 else 0) = 1) (t2) (If_1_iff t2)))) (imp_and ((if t1 then 1 else 0) = 1) (t1) (~ (if t2 then 1 else 0) = 1) (~ t2) (iffEL ((if t1 then 1 else 0) = 1) (t1) (If_1_iff t1)) (imp_not ((if t2 then 1 else 0) = 1) (t2) (iffER ((if t2 then 1 else 0) = 1) (t2) (If_1_iff t2)))) (imp_and (t1) ((if t1 then 1 else 0) = 1) (~ t2) (~ (if t2 then 1 else 0) = 1) (iffER ((if t1 then 1 else 0) = 1) (t1) (If_1_iff t1)) (imp_not (t2) ((if t2 then 1 else 0) = 1) (iffEL ((if t2 then 1 else 0) = 1) (t2) (If_1_iff t2))))))))) HL).
Qed.
...
exact (fun HL => (imp_forall_bool (fun t1 => forall t2 :e 2, ~ t1 = 1 -> ~ t2 = 1 <-> t2 = 1 -> t1 = 1) (fun t1 => forall t2:prop, ~ t1 -> ~ t2 <-> t2 -> t1) (fun t1 => (imp_forall_bool (fun t2 => ~ (if t1 then 1 else 0) = 1 -> ~ t2 = 1 <-> t2 = 1 -> (if t1 then 1 else 0) = 1) (fun t2 => ~ t1 -> ~ t2 <-> t2 -> t1) (fun t2 => (imp_iff (~ (if t1 then 1 else 0) = 1 -> ~ (if t2 then 1 else 0) = 1) (~ t1 -> ~ t2) ((if t2 then 1 else 0) = 1 -> (if t1 then 1 else 0) = 1) (t2 -> t1) (imp_imp (~ (if t1 then 1 else 0) = 1) (~ t1) (~ (if t2 then 1 else 0) = 1) (~ t2) (imp_not (t1) ((if t1 then 1 else 0) = 1) (iffEL ((if t1 then 1 else 0) = 1) (t1) (If_1_iff t1))) (imp_not ((if t2 then 1 else 0) = 1) (t2) (iffER ((if t2 then 1 else 0) = 1) (t2) (If_1_iff t2)))) (imp_imp (~ t1) (~ (if t1 then 1 else 0) = 1) (~ t2) (~ (if t2 then 1 else 0) = 1) (imp_not ((if t1 then 1 else 0) = 1) (t1) (iffER ((if t1 then 1 else 0) = 1) (t1) (If_1_iff t1))) (imp_not (t2) ((if t2 then 1 else 0) = 1) (iffEL ((if t2 then 1 else 0) = 1) (t2) (If_1_iff t2)))) (imp_imp ((if t2 then 1 else 0) = 1) (t2) ((if t1 then 1 else 0) = 1) (t1) (iffER ((if t2 then 1 else 0) = 1) (t2) (If_1_iff t2)) (iffEL ((if t1 then 1 else 0) = 1) (t1) (If_1_iff t1))) (imp_imp (t2) ((if t2 then 1 else 0) = 1) (t1) ((if t1 then 1 else 0) = 1) (iffEL ((if t2 then 1 else 0) = 1) (t2) (If_1_iff t2)) (iffER ((if t1 then 1 else 0) = 1) (t1) (If_1_iff t1)))))))) HL).
Qed.
...
exact (fun HL A => (xm (A = Empty) (forall P:set -> prop, ~ (exists x :e A, P x) <-> forall x :e A, ~ P x) (fun HAe => ((eq_sym_i A Empty HAe) (fun hl__u hl__v => forall P:set -> prop, ~ (exists x :e hl__u, P x) <-> forall x :e hl__u, ~ P x) (fun P => (iffI (~ exists x :e Empty, P x) (forall x :e Empty, ~ P x) (fun _ => (forall_in_Empty (fun x => ~ P x))) (fun _ => (fun H : exists x :e Empty, P x => not_exists_in_Empty (fun x => P x) H)))))) (fun HAne => (imp_forall_pred (A) (fun P => ~ (exists x :e A, P x = 1) <-> forall x :e A, ~ P x = 1) (fun P => ~ (exists x :e A, P x) <-> forall x :e A, ~ P x) (fun P => (imp_iff (~ exists x :e A, hl_chip A P x = 1) (~ exists x :e A, P x) (forall x :e A, ~ hl_chip A P x = 1) (forall x :e A, ~ P x) (imp_not (exists x :e A, hl_chip A P x = 1) (exists x :e A, P x) (imp_exists_in (A) (fun x => P x) (fun x => hl_chip A P x = 1) (fun x Hx => (iffER (hl_chip A P x = 1) (P x) ((hl_chip_iff (A) P) (x) Hx))))) (imp_not (exists x :e A, P x) (exists x :e A, hl_chip A P x = 1) (imp_exists_in (A) (fun x => hl_chip A P x = 1) (fun x => P x) (fun x Hx => (iffEL (hl_chip A P x = 1) (P x) ((hl_chip_iff (A) P) (x) Hx))))) (imp_forall_in (A) (fun x => ~ hl_chip A P x = 1) (fun x => ~ P x) (fun x Hx => (imp_not (hl_chip A P x = 1) (P x) (iffER (hl_chip A P x = 1) (P x) ((hl_chip_iff (A) P) (x) Hx))))) (imp_forall_in (A) (fun x => ~ P x) (fun x => ~ hl_chip A P x = 1) (fun x Hx => (imp_not (P x) (hl_chip A P x = 1) (iffEL (hl_chip A P x = 1) (P x) ((hl_chip_iff (A) P) (x) Hx)))))))) (HL A HAne)))).
Qed.
...
exact (fun HL A => (xm (A = Empty) (forall P:set -> prop, (exists x :e A, ~ P x) <-> ~ forall x :e A, P x) (fun HAe => ((eq_sym_i A Empty HAe) (fun hl__u hl__v => forall P:set -> prop, (exists x :e hl__u, ~ P x) <-> ~ forall x :e hl__u, P x) (fun P => (iffI (exists x :e Empty, ~ P x) (~ forall x :e Empty, P x) (fun H : exists x :e Empty, ~ P x => FalseE ((fun H : exists x :e Empty, ~ P x => not_exists_in_Empty (fun x => ~ P x) H) H) (~ forall x :e Empty, P x)) (fun H : ~ forall x :e Empty, P x => FalseE ((fun H : ~ forall x :e Empty, P x => H (forall_in_Empty (fun x => P x))) H) (exists x :e Empty, ~ P x)))))) (fun HAne => (imp_forall_pred (A) (fun P => (exists x :e A, ~ P x = 1) <-> ~ forall x :e A, P x = 1) (fun P => (exists x :e A, ~ P x) <-> ~ forall x :e A, P x) (fun P => (imp_iff (exists x :e A, ~ hl_chip A P x = 1) (exists x :e A, ~ P x) (~ forall x :e A, hl_chip A P x = 1) (~ forall x :e A, P x) (imp_exists_in (A) (fun x => ~ hl_chip A P x = 1) (fun x => ~ P x) (fun x Hx => (imp_not (hl_chip A P x = 1) (P x) (iffER (hl_chip A P x = 1) (P x) ((hl_chip_iff (A) P) (x) Hx))))) (imp_exists_in (A) (fun x => ~ P x) (fun x => ~ hl_chip A P x = 1) (fun x Hx => (imp_not (P x) (hl_chip A P x = 1) (iffEL (hl_chip A P x = 1) (P x) ((hl_chip_iff (A) P) (x) Hx))))) (imp_not (forall x :e A, hl_chip A P x = 1) (forall x :e A, P x) (imp_forall_in (A) (fun x => P x) (fun x => hl_chip A P x = 1) (fun x Hx => (iffER (hl_chip A P x = 1) (P x) ((hl_chip_iff (A) P) (x) Hx))))) (imp_not (forall x :e A, P x) (forall x :e A, hl_chip A P x = 1) (imp_forall_in (A) (fun x => hl_chip A P x = 1) (fun x => P x) (fun x Hx => (iffEL (hl_chip A P x = 1) (P x) ((hl_chip_iff (A) P) (x) Hx)))))))) (HL A HAne)))).
Qed.
...
exact (fun HL A => (xm (A = Empty) (forall P:set -> prop, ~ (forall x :e A, P x) <-> exists x :e A, ~ P x) (fun HAe => ((eq_sym_i A Empty HAe) (fun hl__u hl__v => forall P:set -> prop, ~ (forall x :e hl__u, P x) <-> exists x :e hl__u, ~ P x) (fun P => (iffI (~ forall x :e Empty, P x) (exists x :e Empty, ~ P x) (fun H : ~ forall x :e Empty, P x => FalseE ((fun H : ~ forall x :e Empty, P x => H (forall_in_Empty (fun x => P x))) H) (exists x :e Empty, ~ P x)) (fun H : exists x :e Empty, ~ P x => FalseE ((fun H : exists x :e Empty, ~ P x => not_exists_in_Empty (fun x => ~ P x) H) H) (~ forall x :e Empty, P x)))))) (fun HAne => (imp_forall_pred (A) (fun P => ~ (forall x :e A, P x = 1) <-> exists x :e A, ~ P x = 1) (fun P => ~ (forall x :e A, P x) <-> exists x :e A, ~ P x) (fun P => (imp_iff (~ forall x :e A, hl_chip A P x = 1) (~ forall x :e A, P x) (exists x :e A, ~ hl_chip A P x = 1) (exists x :e A, ~ P x) (imp_not (forall x :e A, hl_chip A P x = 1) (forall x :e A, P x) (imp_forall_in (A) (fun x => P x) (fun x => hl_chip A P x = 1) (fun x Hx => (iffER (hl_chip A P x = 1) (P x) ((hl_chip_iff (A) P) (x) Hx))))) (imp_not (forall x :e A, P x) (forall x :e A, hl_chip A P x = 1) (imp_forall_in (A) (fun x => hl_chip A P x = 1) (fun x => P x) (fun x Hx => (iffEL (hl_chip A P x = 1) (P x) ((hl_chip_iff (A) P) (x) Hx))))) (imp_exists_in (A) (fun x => ~ hl_chip A P x = 1) (fun x => ~ P x) (fun x Hx => (imp_not (hl_chip A P x = 1) (P x) (iffER (hl_chip A P x = 1) (P x) ((hl_chip_iff (A) P) (x) Hx))))) (imp_exists_in (A) (fun x => ~ P x) (fun x => ~ hl_chip A P x = 1) (fun x Hx => (imp_not (P x) (hl_chip A P x = 1) (iffEL (hl_chip A P x = 1) (P x) ((hl_chip_iff (A) P) (x) Hx)))))))) (HL A HAne)))).
Qed.
...
exact (fun HL A => (xm (A = Empty) (forall P:set -> prop, (forall x :e A, ~ P x) <-> ~ exists x :e A, P x) (fun HAe => ((eq_sym_i A Empty HAe) (fun hl__u hl__v => forall P:set -> prop, (forall x :e hl__u, ~ P x) <-> ~ exists x :e hl__u, P x) (fun P => (iffI (forall x :e Empty, ~ P x) (~ exists x :e Empty, P x) (fun _ => (fun H : exists x :e Empty, P x => not_exists_in_Empty (fun x => P x) H)) (fun _ => (forall_in_Empty (fun x => ~ P x))))))) (fun HAne => (imp_forall_pred (A) (fun P => (forall x :e A, ~ P x = 1) <-> ~ exists x :e A, P x = 1) (fun P => (forall x :e A, ~ P x) <-> ~ exists x :e A, P x) (fun P => (imp_iff (forall x :e A, ~ hl_chip A P x = 1) (forall x :e A, ~ P x) (~ exists x :e A, hl_chip A P x = 1) (~ exists x :e A, P x) (imp_forall_in (A) (fun x => ~ hl_chip A P x = 1) (fun x => ~ P x) (fun x Hx => (imp_not (hl_chip A P x = 1) (P x) (iffER (hl_chip A P x = 1) (P x) ((hl_chip_iff (A) P) (x) Hx))))) (imp_forall_in (A) (fun x => ~ P x) (fun x => ~ hl_chip A P x = 1) (fun x Hx => (imp_not (P x) (hl_chip A P x = 1) (iffEL (hl_chip A P x = 1) (P x) ((hl_chip_iff (A) P) (x) Hx))))) (imp_not (exists x :e A, hl_chip A P x = 1) (exists x :e A, P x) (imp_exists_in (A) (fun x => P x) (fun x => hl_chip A P x = 1) (fun x Hx => (iffER (hl_chip A P x = 1) (P x) ((hl_chip_iff (A) P) (x) Hx))))) (imp_not (exists x :e A, P x) (exists x :e A, hl_chip A P x = 1) (imp_exists_in (A) (fun x => hl_chip A P x = 1) (fun x => P x) (fun x Hx => (iffEL (hl_chip A P x = 1) (P x) ((hl_chip_iff (A) P) (x) Hx)))))))) (HL A HAne)))).
Qed.
...
exact (fun HL A HAne => (imp_forall_pred (A) (fun P => forall Q :e 2, (forall x :e A, P x = 1) -> Q = 1 <-> exists x :e A, P x = 1 -> Q = 1) (fun P => forall Q:prop, (forall x :e A, P x) -> Q <-> exists x :e A, P x -> Q) (fun P => (imp_forall_bool (fun Q => (forall x :e A, hl_chip A P x = 1) -> Q = 1 <-> exists x :e A, hl_chip A P x = 1 -> Q = 1) (fun Q => (forall x :e A, P x) -> Q <-> exists x :e A, P x -> Q) (fun Q => (imp_iff ((forall x :e A, hl_chip A P x = 1) -> (if Q then 1 else 0) = 1) ((forall x :e A, P x) -> Q) (exists x :e A, hl_chip A P x = 1 -> (if Q then 1 else 0) = 1) (exists x :e A, P x -> Q) (imp_imp (forall x :e A, hl_chip A P x = 1) (forall x :e A, P x) ((if Q then 1 else 0) = 1) (Q) (imp_forall_in (A) (fun x => P x) (fun x => hl_chip A P x = 1) (fun x Hx => (iffER (hl_chip A P x = 1) (P x) ((hl_chip_iff (A) P) (x) Hx)))) (iffEL ((if Q then 1 else 0) = 1) (Q) (If_1_iff Q))) (imp_imp (forall x :e A, P x) (forall x :e A, hl_chip A P x = 1) (Q) ((if Q then 1 else 0) = 1) (imp_forall_in (A) (fun x => hl_chip A P x = 1) (fun x => P x) (fun x Hx => (iffEL (hl_chip A P x = 1) (P x) ((hl_chip_iff (A) P) (x) Hx)))) (iffER ((if Q then 1 else 0) = 1) (Q) (If_1_iff Q))) (imp_exists_in (A) (fun x => hl_chip A P x = 1 -> (if Q then 1 else 0) = 1) (fun x => P x -> Q) (fun x Hx => (imp_imp (hl_chip A P x = 1) (P x) ((if Q then 1 else 0) = 1) (Q) (iffER (hl_chip A P x = 1) (P x) ((hl_chip_iff (A) P) (x) Hx)) (iffEL ((if Q then 1 else 0) = 1) (Q) (If_1_iff Q))))) (imp_exists_in (A) (fun x => P x -> Q) (fun x => hl_chip A P x = 1 -> (if Q then 1 else 0) = 1) (fun x Hx => (imp_imp (P x) (hl_chip A P x = 1) (Q) ((if Q then 1 else 0) = 1) (iffEL (hl_chip A P x = 1) (P x) ((hl_chip_iff (A) P) (x) Hx)) (iffER ((if Q then 1 else 0) = 1) (Q) (If_1_iff Q)))))))))) (HL A HAne)).
Qed.
...
exact (fun HL A HAne => (imp_forall_pred (A) (fun P => forall Q :e 2, (exists x :e A, P x = 1 -> Q = 1) <-> (forall x :e A, P x = 1) -> Q = 1) (fun P => forall Q:prop, (exists x :e A, P x -> Q) <-> (forall x :e A, P x) -> Q) (fun P => (imp_forall_bool (fun Q => (exists x :e A, hl_chip A P x = 1 -> Q = 1) <-> (forall x :e A, hl_chip A P x = 1) -> Q = 1) (fun Q => (exists x :e A, P x -> Q) <-> (forall x :e A, P x) -> Q) (fun Q => (imp_iff (exists x :e A, hl_chip A P x = 1 -> (if Q then 1 else 0) = 1) (exists x :e A, P x -> Q) ((forall x :e A, hl_chip A P x = 1) -> (if Q then 1 else 0) = 1) ((forall x :e A, P x) -> Q) (imp_exists_in (A) (fun x => hl_chip A P x = 1 -> (if Q then 1 else 0) = 1) (fun x => P x -> Q) (fun x Hx => (imp_imp (hl_chip A P x = 1) (P x) ((if Q then 1 else 0) = 1) (Q) (iffER (hl_chip A P x = 1) (P x) ((hl_chip_iff (A) P) (x) Hx)) (iffEL ((if Q then 1 else 0) = 1) (Q) (If_1_iff Q))))) (imp_exists_in (A) (fun x => P x -> Q) (fun x => hl_chip A P x = 1 -> (if Q then 1 else 0) = 1) (fun x Hx => (imp_imp (P x) (hl_chip A P x = 1) (Q) ((if Q then 1 else 0) = 1) (iffEL (hl_chip A P x = 1) (P x) ((hl_chip_iff (A) P) (x) Hx)) (iffER ((if Q then 1 else 0) = 1) (Q) (If_1_iff Q))))) (imp_imp (forall x :e A, hl_chip A P x = 1) (forall x :e A, P x) ((if Q then 1 else 0) = 1) (Q) (imp_forall_in (A) (fun x => P x) (fun x => hl_chip A P x = 1) (fun x Hx => (iffER (hl_chip A P x = 1) (P x) ((hl_chip_iff (A) P) (x) Hx)))) (iffEL ((if Q then 1 else 0) = 1) (Q) (If_1_iff Q))) (imp_imp (forall x :e A, P x) (forall x :e A, hl_chip A P x = 1) (Q) ((if Q then 1 else 0) = 1) (imp_forall_in (A) (fun x => hl_chip A P x = 1) (fun x => P x) (fun x Hx => (iffEL (hl_chip A P x = 1) (P x) ((hl_chip_iff (A) P) (x) Hx)))) (iffER ((if Q then 1 else 0) = 1) (Q) (If_1_iff Q)))))))) (HL A HAne)).
Qed.
...
exact (fun HL A HAne => (imp_forall_bool (fun P => forall Q :e 2 :^: A, P = 1 -> (exists x :e A, Q x = 1) <-> exists x :e A, P = 1 -> Q x = 1) (fun P => forall Q:set -> prop, P -> (exists x :e A, Q x) <-> exists x :e A, P -> Q x) (fun P => (imp_forall_pred (A) (fun Q => (if P then 1 else 0) = 1 -> (exists x :e A, Q x = 1) <-> exists x :e A, (if P then 1 else 0) = 1 -> Q x = 1) (fun Q => P -> (exists x :e A, Q x) <-> exists x :e A, P -> Q x) (fun Q => (imp_iff ((if P then 1 else 0) = 1 -> exists x :e A, hl_chip A Q x = 1) (P -> exists x :e A, Q x) (exists x :e A, (if P then 1 else 0) = 1 -> hl_chip A Q x = 1) (exists x :e A, P -> Q x) (imp_imp ((if P then 1 else 0) = 1) (P) (exists x :e A, hl_chip A Q x = 1) (exists x :e A, Q x) (iffER ((if P then 1 else 0) = 1) (P) (If_1_iff P)) (imp_exists_in (A) (fun x => hl_chip A Q x = 1) (fun x => Q x) (fun x Hx => (iffEL (hl_chip A Q x = 1) (Q x) ((hl_chip_iff (A) Q) (x) Hx))))) (imp_imp (P) ((if P then 1 else 0) = 1) (exists x :e A, Q x) (exists x :e A, hl_chip A Q x = 1) (iffEL ((if P then 1 else 0) = 1) (P) (If_1_iff P)) (imp_exists_in (A) (fun x => Q x) (fun x => hl_chip A Q x = 1) (fun x Hx => (iffER (hl_chip A Q x = 1) (Q x) ((hl_chip_iff (A) Q) (x) Hx))))) (imp_exists_in (A) (fun x => (if P then 1 else 0) = 1 -> hl_chip A Q x = 1) (fun x => P -> Q x) (fun x Hx => (imp_imp ((if P then 1 else 0) = 1) (P) (hl_chip A Q x = 1) (Q x) (iffER ((if P then 1 else 0) = 1) (P) (If_1_iff P)) (iffEL (hl_chip A Q x = 1) (Q x) ((hl_chip_iff (A) Q) (x) Hx))))) (imp_exists_in (A) (fun x => P -> Q x) (fun x => (if P then 1 else 0) = 1 -> hl_chip A Q x = 1) (fun x Hx => (imp_imp (P) ((if P then 1 else 0) = 1) (Q x) (hl_chip A Q x = 1) (iffEL ((if P then 1 else 0) = 1) (P) (If_1_iff P)) (iffER (hl_chip A Q x = 1) (Q x) ((hl_chip_iff (A) Q) (x) Hx)))))))))) (HL A HAne)).
Qed.
...
exact (fun HL A HAne => (imp_forall_bool (fun P => forall Q :e 2 :^: A, (exists x :e A, P = 1 -> Q x = 1) <-> P = 1 -> exists x :e A, Q x = 1) (fun P => forall Q:set -> prop, (exists x :e A, P -> Q x) <-> P -> exists x :e A, Q x) (fun P => (imp_forall_pred (A) (fun Q => (exists x :e A, (if P then 1 else 0) = 1 -> Q x = 1) <-> (if P then 1 else 0) = 1 -> exists x :e A, Q x = 1) (fun Q => (exists x :e A, P -> Q x) <-> P -> exists x :e A, Q x) (fun Q => (imp_iff (exists x :e A, (if P then 1 else 0) = 1 -> hl_chip A Q x = 1) (exists x :e A, P -> Q x) ((if P then 1 else 0) = 1 -> exists x :e A, hl_chip A Q x = 1) (P -> exists x :e A, Q x) (imp_exists_in (A) (fun x => (if P then 1 else 0) = 1 -> hl_chip A Q x = 1) (fun x => P -> Q x) (fun x Hx => (imp_imp ((if P then 1 else 0) = 1) (P) (hl_chip A Q x = 1) (Q x) (iffER ((if P then 1 else 0) = 1) (P) (If_1_iff P)) (iffEL (hl_chip A Q x = 1) (Q x) ((hl_chip_iff (A) Q) (x) Hx))))) (imp_exists_in (A) (fun x => P -> Q x) (fun x => (if P then 1 else 0) = 1 -> hl_chip A Q x = 1) (fun x Hx => (imp_imp (P) ((if P then 1 else 0) = 1) (Q x) (hl_chip A Q x = 1) (iffEL ((if P then 1 else 0) = 1) (P) (If_1_iff P)) (iffER (hl_chip A Q x = 1) (Q x) ((hl_chip_iff (A) Q) (x) Hx))))) (imp_imp ((if P then 1 else 0) = 1) (P) (exists x :e A, hl_chip A Q x = 1) (exists x :e A, Q x) (iffER ((if P then 1 else 0) = 1) (P) (If_1_iff P)) (imp_exists_in (A) (fun x => hl_chip A Q x = 1) (fun x => Q x) (fun x Hx => (iffEL (hl_chip A Q x = 1) (Q x) ((hl_chip_iff (A) Q) (x) Hx))))) (imp_imp (P) ((if P then 1 else 0) = 1) (exists x :e A, Q x) (exists x :e A, hl_chip A Q x = 1) (iffEL ((if P then 1 else 0) = 1) (P) (If_1_iff P)) (imp_exists_in (A) (fun x => Q x) (fun x => hl_chip A Q x = 1) (fun x Hx => (iffER (hl_chip A Q x = 1) (Q x) ((hl_chip_iff (A) Q) (x) Hx)))))))))) (HL A HAne)).
Qed.
