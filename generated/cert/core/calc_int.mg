...
exact (fun HL => (imp_forall_in (R) (fun m => forall n p :e R, hl_real_add m n = hl_real_add n m /\ (hl_real_add (hl_real_add m n) p = hl_real_add m (hl_real_add n p) /\ hl_real_add m (hl_real_add n p) = hl_real_add n (hl_real_add m p))) (fun m => forall n p :e R, m + n = n + m /\ ((m + n) + p = m + n + p /\ m + n + p = n + m + p)) (fun m Hm => (imp_forall_in (R) (fun n => forall p :e R, hl_real_add m n = hl_real_add n m /\ (hl_real_add (hl_real_add m n) p = hl_real_add m (hl_real_add n p) /\ hl_real_add m (hl_real_add n p) = hl_real_add n (hl_real_add m p))) (fun n => forall p :e R, m + n = n + m /\ ((m + n) + p = m + n + p /\ m + n + p = n + m + p)) (fun n Hn => (imp_forall_in (R) (fun p => hl_real_add m n = hl_real_add n m /\ (hl_real_add (hl_real_add m n) p = hl_real_add m (hl_real_add n p) /\ hl_real_add m (hl_real_add n p) = hl_real_add n (hl_real_add m p))) (fun p => m + n = n + m /\ ((m + n) + p = m + n + p /\ m + n + p = n + m + p)) (fun p Hp => (imp_and (hl_real_add m n = hl_real_add n m) (m + n = n + m) (hl_real_add (hl_real_add m n) p = hl_real_add m (hl_real_add n p) /\ hl_real_add m (hl_real_add n p) = hl_real_add n (hl_real_add m p)) ((m + n) + p = m + n + p /\ m + n + p = n + m + p) (imp_eq (hl_real_add m n) (m + n) (hl_real_add n m) (n + m) ((hl_real_add_compat) (m) Hm (n) Hn) ((hl_real_add_compat) (n) Hn (m) Hm)) (imp_and (hl_real_add (hl_real_add m n) p = hl_real_add m (hl_real_add n p)) ((m + n) + p = m + n + p) (hl_real_add m (hl_real_add n p) = hl_real_add n (hl_real_add m p)) (m + n + p = n + m + p) (imp_eq (hl_real_add (hl_real_add m n) p) ((m + n) + p) (hl_real_add m (hl_real_add n p)) (m + n + p) (((hl_real_add_compat) (m) Hm (n) Hn) (fun hl__u hl__v => hl_real_add (hl_real_add m n) p = hl__u + p) ((hl_real_add_compat) (hl_real_add m n) (setexp_ap (R) (R) (hl_real_add m) (setexp_ap (R) (R :^: R) (hl_real_add) ((hl_real_add_in)) (m) Hm) (n) Hn) (p) Hp)) (((hl_real_add_compat) (n) Hn (p) Hp) (fun hl__u hl__v => hl_real_add m (hl_real_add n p) = m + hl__u) ((hl_real_add_compat) (m) Hm (hl_real_add n p) (setexp_ap (R) (R) (hl_real_add n) (setexp_ap (R) (R :^: R) (hl_real_add) ((hl_real_add_in)) (n) Hn) (p) Hp)))) (imp_eq (hl_real_add m (hl_real_add n p)) (m + n + p) (hl_real_add n (hl_real_add m p)) (n + m + p) (((hl_real_add_compat) (n) Hn (p) Hp) (fun hl__u hl__v => hl_real_add m (hl_real_add n p) = m + hl__u) ((hl_real_add_compat) (m) Hm (hl_real_add n p) (setexp_ap (R) (R) (hl_real_add n) (setexp_ap (R) (R :^: R) (hl_real_add) ((hl_real_add_in)) (n) Hn) (p) Hp))) (((hl_real_add_compat) (m) Hm (p) Hp) (fun hl__u hl__v => hl_real_add n (hl_real_add m p) = n + hl__u) ((hl_real_add_compat) (n) Hn (hl_real_add m p) (setexp_ap (R) (R) (hl_real_add m) (setexp_ap (R) (R :^: R) (hl_real_add) ((hl_real_add_in)) (m) Hm) (p) Hp)))))))))))) HL).
Qed.
...
exact (fun HL => (imp_forall_in (R) (fun x => hl_real_neg (hl_real_neg x) = x) (fun x => - - x = x) (fun x Hx => (imp_eq (hl_real_neg (hl_real_neg x)) (- - x) (x) (x) (((hl_real_neg_compat) (x) Hx) (fun hl__u hl__v => hl_real_neg (hl_real_neg x) = - hl__u) ((hl_real_neg_compat) (hl_real_neg x) (setexp_ap (R) (R) (hl_real_neg) ((hl_real_neg_in)) (x) Hx))) (fun q H => H)))) HL).
Qed.
...
exact (fun HL => (imp_forall_in (R) (fun x => forall y :e R, hl_real_mul x (hl_real_neg y) = hl_real_neg (hl_real_mul x y)) (fun x => forall y :e R, x * (- y) = - x * y) (fun x Hx => (imp_forall_in (R) (fun y => hl_real_mul x (hl_real_neg y) = hl_real_neg (hl_real_mul x y)) (fun y => x * (- y) = - x * y) (fun y Hy => (imp_eq (hl_real_mul x (hl_real_neg y)) (x * (- y)) (hl_real_neg (hl_real_mul x y)) (- x * y) (((hl_real_neg_compat) (y) Hy) (fun hl__u hl__v => hl_real_mul x (hl_real_neg y) = x * hl__u) ((hl_real_mul_compat) (x) Hx (hl_real_neg y) (setexp_ap (R) (R) (hl_real_neg) ((hl_real_neg_in)) (y) Hy))) (((hl_real_mul_compat) (x) Hx (y) Hy) (fun hl__u hl__v => hl_real_neg (hl_real_mul x y) = - hl__u) ((hl_real_neg_compat) (hl_real_mul x y) (setexp_ap (R) (R) (hl_real_mul x) (setexp_ap (R) (R :^: R) (hl_real_mul) ((hl_real_mul_in)) (x) Hx) (y) Hy)))))))) HL).
Qed.
...
exact (fun HL => (imp_forall_in (R) (fun x => forall y :e R, hl_real_mul (hl_real_neg x) y = hl_real_neg (hl_real_mul x y)) (fun x => forall y :e R, (- x) * y = - x * y) (fun x Hx => (imp_forall_in (R) (fun y => hl_real_mul (hl_real_neg x) y = hl_real_neg (hl_real_mul x y)) (fun y => (- x) * y = - x * y) (fun y Hy => (imp_eq (hl_real_mul (hl_real_neg x) y) ((- x) * y) (hl_real_neg (hl_real_mul x y)) (- x * y) (((hl_real_neg_compat) (x) Hx) (fun hl__u hl__v => hl_real_mul (hl_real_neg x) y = hl__u * y) ((hl_real_mul_compat) (hl_real_neg x) (setexp_ap (R) (R) (hl_real_neg) ((hl_real_neg_in)) (x) Hx) (y) Hy)) (((hl_real_mul_compat) (x) Hx (y) Hy) (fun hl__u hl__v => hl_real_neg (hl_real_mul x y) = - hl__u) ((hl_real_neg_compat) (hl_real_mul x y) (setexp_ap (R) (R) (hl_real_mul x) (setexp_ap (R) (R :^: R) (hl_real_mul) ((hl_real_mul_in)) (x) Hx) (y) Hy)))))))) HL).
Qed.
...
exact (fun HL => (imp_forall_in (R) (fun x => forall y :e R, hl_real_neg (hl_real_add x y) = hl_real_add (hl_real_neg x) (hl_real_neg y)) (fun x => forall y :e R, - (x + y) = - x + - y) (fun x Hx => (imp_forall_in (R) (fun y => hl_real_neg (hl_real_add x y) = hl_real_add (hl_real_neg x) (hl_real_neg y)) (fun y => - (x + y) = - x + - y) (fun y Hy => (imp_eq (hl_real_neg (hl_real_add x y)) (- (x + y)) (hl_real_add (hl_real_neg x) (hl_real_neg y)) (- x + - y) (((hl_real_add_compat) (x) Hx (y) Hy) (fun hl__u hl__v => hl_real_neg (hl_real_add x y) = - hl__u) ((hl_real_neg_compat) (hl_real_add x y) (setexp_ap (R) (R) (hl_real_add x) (setexp_ap (R) (R :^: R) (hl_real_add) ((hl_real_add_in)) (x) Hx) (y) Hy))) (((hl_real_neg_compat) (y) Hy) (fun hl__u hl__v => hl_real_add (hl_real_neg x) (hl_real_neg y) = - x + hl__u) (((hl_real_neg_compat) (x) Hx) (fun hl__u hl__v => hl_real_add (hl_real_neg x) (hl_real_neg y) = hl__u + hl_real_neg y) ((hl_real_add_compat) (hl_real_neg x) (setexp_ap (R) (R) (hl_real_neg) ((hl_real_neg_in)) (x) Hx) (hl_real_neg y) (setexp_ap (R) (R) (hl_real_neg) ((hl_real_neg_in)) (y) Hy))))))))) HL).
Qed.
...
exact (fun HL => (imp_forall_in (R) (fun x => forall y :e R, hl_real_le x (hl_real_neg y) = 1 <-> hl_real_le (hl_real_add x y) (hl_real_of_num (hl_NUMERAL hl_zero)) = 1) (fun x => forall y :e R, x <= - y <-> x + y <= 0) (fun x Hx => (imp_forall_in (R) (fun y => hl_real_le x (hl_real_neg y) = 1 <-> hl_real_le (hl_real_add x y) (hl_real_of_num (hl_NUMERAL hl_zero)) = 1) (fun y => x <= - y <-> x + y <= 0) (fun y Hy => (imp_iff (hl_real_le x (hl_real_neg y) = 1) (x <= - y) (hl_real_le (hl_real_add x y) (hl_real_of_num (hl_NUMERAL hl_zero)) = 1) (x + y <= 0) (iffEL (hl_real_le x (hl_real_neg y) = 1) (x <= - y) (((hl_real_neg_compat) (y) Hy) (fun hl__u hl__v => hl_real_le x (hl_real_neg y) = 1 <-> x <= hl__u) ((hl_real_le_compat) (x) Hx (hl_real_neg y) (setexp_ap (R) (R) (hl_real_neg) ((hl_real_neg_in)) (y) Hy)))) (iffER (hl_real_le x (hl_real_neg y) = 1) (x <= - y) (((hl_real_neg_compat) (y) Hy) (fun hl__u hl__v => hl_real_le x (hl_real_neg y) = 1 <-> x <= hl__u) ((hl_real_le_compat) (x) Hx (hl_real_neg y) (setexp_ap (R) (R) (hl_real_neg) ((hl_real_neg_in)) (y) Hy)))) (iffEL (hl_real_le (hl_real_add x y) (hl_real_of_num (hl_NUMERAL hl_zero)) = 1) (x + y <= 0) (((eq_trans_i (hl_NUMERAL hl_zero) (hl_zero) 0 (hl_NUMERAL_compat (hl_zero) ((eq_sym_i (hl_zero) 0 hl_zero_compat) (fun hl__u hl__v => hl__u :e omega) (nat_p_omega 0 nat_0))) hl_zero_compat) (fun hl__u hl__v => hl_real_of_num (hl_NUMERAL hl_zero) = hl__u) ((hl_real_of_num_compat) (hl_NUMERAL hl_zero) (setexp_ap (omega) (omega) (hl_NUMERAL) ((hl_NUMERAL_in)) (hl_zero) ((hl_zero_in))))) (fun hl__u hl__v => hl_real_le (hl_real_add x y) (hl_real_of_num (hl_NUMERAL hl_zero)) = 1 <-> x + y <= hl__u) (((hl_real_add_compat) (x) Hx (y) Hy) (fun hl__u hl__v => hl_real_le (hl_real_add x y) (hl_real_of_num (hl_NUMERAL hl_zero)) = 1 <-> hl__u <= hl_real_of_num (hl_NUMERAL hl_zero)) ((hl_real_le_compat) (hl_real_add x y) (setexp_ap (R) (R) (hl_real_add x) (setexp_ap (R) (R :^: R) (hl_real_add) ((hl_real_add_in)) (x) Hx) (y) Hy) (hl_real_of_num (hl_NUMERAL hl_zero)) (setexp_ap (omega) (R) (hl_real_of_num) ((hl_real_of_num_in)) (hl_NUMERAL hl_zero) (setexp_ap (omega) (omega) (hl_NUMERAL) ((hl_NUMERAL_in)) (hl_zero) ((hl_zero_in)))))))) (iffER (hl_real_le (hl_real_add x y) (hl_real_of_num (hl_NUMERAL hl_zero)) = 1) (x + y <= 0) (((eq_trans_i (hl_NUMERAL hl_zero) (hl_zero) 0 (hl_NUMERAL_compat (hl_zero) ((eq_sym_i (hl_zero) 0 hl_zero_compat) (fun hl__u hl__v => hl__u :e omega) (nat_p_omega 0 nat_0))) hl_zero_compat) (fun hl__u hl__v => hl_real_of_num (hl_NUMERAL hl_zero) = hl__u) ((hl_real_of_num_compat) (hl_NUMERAL hl_zero) (setexp_ap (omega) (omega) (hl_NUMERAL) ((hl_NUMERAL_in)) (hl_zero) ((hl_zero_in))))) (fun hl__u hl__v => hl_real_le (hl_real_add x y) (hl_real_of_num (hl_NUMERAL hl_zero)) = 1 <-> x + y <= hl__u) (((hl_real_add_compat) (x) Hx (y) Hy) (fun hl__u hl__v => hl_real_le (hl_real_add x y) (hl_real_of_num (hl_NUMERAL hl_zero)) = 1 <-> hl__u <= hl_real_of_num (hl_NUMERAL hl_zero)) ((hl_real_le_compat) (hl_real_add x y) (setexp_ap (R) (R) (hl_real_add x) (setexp_ap (R) (R :^: R) (hl_real_add) ((hl_real_add_in)) (x) Hx) (y) Hy) (hl_real_of_num (hl_NUMERAL hl_zero)) (setexp_ap (omega) (R) (hl_real_of_num) ((hl_real_of_num_in)) (hl_NUMERAL hl_zero) (setexp_ap (omega) (omega) (hl_NUMERAL) ((hl_NUMERAL_in)) (hl_zero) ((hl_zero_in))))))))))))) HL).
Qed.
...
exact (fun HL => (imp_forall_in (omega) (fun x => forall n :e omega, hl_real_pow (hl_real_of_num x) n = hl_real_of_num (hl_EXP x n)) (fun x => forall n :e omega, x ^ n = x ^ n) (fun x Hx => (imp_forall_in (omega) (fun n => hl_real_pow (hl_real_of_num x) n = hl_real_of_num (hl_EXP x n)) (fun n => x ^ n = x ^ n) (fun n Hn => (imp_eq (hl_real_pow (hl_real_of_num x) n) (x ^ n) (hl_real_of_num (hl_EXP x n)) (x ^ n) (((hl_real_of_num_compat) (x) Hx) (fun hl__u hl__v => hl_real_pow (hl_real_of_num x) n = hl__u ^ n) ((hl_real_pow_compat) (hl_real_of_num x) (setexp_ap (omega) (R) (hl_real_of_num) ((hl_real_of_num_in)) (x) Hx) (n) Hn)) (((hl_EXP_compat) (x) Hx (n) Hn) (fun hl__u hl__v => hl_real_of_num (hl_EXP x n) = hl__u) ((hl_real_of_num_compat) (hl_EXP x n) (setexp_ap (omega) (omega) (hl_EXP x) (setexp_ap (omega) (omega :^: omega) (hl_EXP) ((hl_EXP_in)) (x) Hx) (n) Hn)))))))) HL).
Qed.
...
exact (fun HL => (imp_forall_in (R) (fun x => forall n :e omega, hl_real_pow (hl_real_neg x) n = hl_COND R (hl_EVEN n) (hl_real_pow x n) (hl_real_neg (hl_real_pow x n))) (fun x => forall n :e omega, (- x) ^ n = if even_nat n then x ^ n else - x ^ n) (fun x Hx => (imp_forall_in (omega) (fun n => hl_real_pow (hl_real_neg x) n = hl_COND R (hl_EVEN n) (hl_real_pow x n) (hl_real_neg (hl_real_pow x n))) (fun n => (- x) ^ n = if even_nat n then x ^ n else - x ^ n) (fun n Hn => (imp_eq (hl_real_pow (hl_real_neg x) n) ((- x) ^ n) (hl_COND R (hl_EVEN n) (hl_real_pow x n) (hl_real_neg (hl_real_pow x n))) (if even_nat n then x ^ n else - x ^ n) (((hl_real_neg_compat) (x) Hx) (fun hl__u hl__v => hl_real_pow (hl_real_neg x) n = hl__u ^ n) ((hl_real_pow_compat) (hl_real_neg x) (setexp_ap (R) (R) (hl_real_neg) ((hl_real_neg_in)) (x) Hx) (n) Hn)) ((((hl_real_pow_compat) (x) Hx (n) Hn) (fun hl__u hl__v => hl_real_neg (hl_real_pow x n) = - hl__u) ((hl_real_neg_compat) (hl_real_pow x n) (setexp_ap (omega) (R) (hl_real_pow x) (setexp_ap (R) (R :^: omega) (hl_real_pow) ((hl_real_pow_in)) (x) Hx) (n) Hn))) (fun hl__u hl__v => hl_COND R (hl_EVEN n) (hl_real_pow x n) (hl_real_neg (hl_real_pow x n)) = if even_nat n then x ^ n else hl__u) (((hl_real_pow_compat) (x) Hx (n) Hn) (fun hl__u hl__v => hl_COND R (hl_EVEN n) (hl_real_pow x n) (hl_real_neg (hl_real_pow x n)) = if even_nat n then hl__u else hl_real_neg (hl_real_pow x n)) (hl_COND_if (R) (hl_EVEN n) (setexp_ap (omega) (2) (hl_EVEN) ((hl_EVEN_in)) (n) Hn) (even_nat n) ((hl_EVEN_compat) (n) Hn) (hl_real_pow x n) (setexp_ap (omega) (R) (hl_real_pow x) (setexp_ap (R) (R :^: omega) (hl_real_pow) ((hl_real_pow_in)) (x) Hx) (n) Hn) (hl_real_neg (hl_real_pow x n)) (setexp_ap (R) (R) (hl_real_neg) ((hl_real_neg_in)) (hl_real_pow x n) (setexp_ap (omega) (R) (hl_real_pow x) (setexp_ap (R) (R :^: omega) (hl_real_pow) ((hl_real_pow_in)) (x) Hx) (n) Hn)))))))))) HL).
Qed.
...
exact (fun HL => (imp_forall_in (omega) (fun n => hl_real_abs (hl_real_of_num n) = hl_real_of_num n) (fun n => abs_SNo n = n) (fun n Hn => (imp_eq (hl_real_abs (hl_real_of_num n)) (abs_SNo n) (hl_real_of_num n) (n) (((hl_real_of_num_compat) (n) Hn) (fun hl__u hl__v => hl_real_abs (hl_real_of_num n) = abs_SNo hl__u) ((hl_real_abs_compat) (hl_real_of_num n) (setexp_ap (omega) (R) (hl_real_of_num) ((hl_real_of_num_in)) (n) Hn))) ((hl_real_of_num_compat) (n) Hn)))) HL).
Qed.
