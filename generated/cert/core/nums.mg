...
exact (fun HL A B HBne => (xm (A = Empty) (forall f:set -> set, (forall x :e A, f x :e B) -> ((forall x y :e A, f x = f y -> x = y) <-> forall x1 x2 :e A, f x1 = f x2 -> x1 = x2)) (fun HAe => ((eq_sym_i A Empty HAe) (fun hl__u hl__v => forall f:set -> set, (forall x :e hl__u, f x :e B) -> ((forall x y :e hl__u, f x = f y -> x = y) <-> forall x1 x2 :e hl__u, f x1 = f x2 -> x1 = x2)) (fun f => (fun H : forall x :e Empty, f x :e B => (iffI (forall x y :e Empty, f x = f y -> x = y) (forall x1 x2 :e Empty, f x1 = f x2 -> x1 = x2) (fun _ => (forall_in_Empty (fun x1 => forall x2 :e Empty, f x1 = f x2 -> x1 = x2))) (fun _ => (forall_in_Empty (fun x => forall y :e Empty, f x = f y -> x = y)))))))) (fun HAne => (imp_forall_fun (A) (B) (fun f => hl_ONE_ONE A B f = 1 <-> forall x1 x2 :e A, f x1 = f x2 -> x1 = x2) (fun f => (forall x y :e A, f x = f y -> x = y) <-> forall x1 x2 :e A, f x1 = f x2 -> x1 = x2) (fun f Hfc => (imp_iff (hl_ONE_ONE A B (hl_lam A f) = 1) (forall x y :e A, f x = f y -> x = y) (forall x1 x2 :e A, hl_lam A f x1 = hl_lam A f x2 -> x1 = x2) (forall x1 x2 :e A, f x1 = f x2 -> x1 = x2) (iffEL (hl_ONE_ONE A B (hl_lam A f) = 1) (forall x y :e A, f x = f y -> x = y) ((hl_ONE_ONE_compat) (A) (B) HAne HBne (hl_lam A f) (hl_lam_Pi (A) (B) f Hfc) (f) ((hl_lam_ap (A) f)))) (iffER (hl_ONE_ONE A B (hl_lam A f) = 1) (forall x y :e A, f x = f y -> x = y) ((hl_ONE_ONE_compat) (A) (B) HAne HBne (hl_lam A f) (hl_lam_Pi (A) (B) f Hfc) (f) ((hl_lam_ap (A) f)))) (imp_forall_in (A) (fun x1 => forall x2 :e A, hl_lam A f x1 = hl_lam A f x2 -> x1 = x2) (fun x1 => forall x2 :e A, f x1 = f x2 -> x1 = x2) (fun x1 Hx1 => (imp_forall_in (A) (fun x2 => hl_lam A f x1 = hl_lam A f x2 -> x1 = x2) (fun x2 => f x1 = f x2 -> x1 = x2) (fun x2 Hx2 => (imp_imp (hl_lam A f x1 = hl_lam A f x2) (f x1 = f x2) (x1 = x2) (x1 = x2) (imp_eq (f x1) (hl_lam A f x1) (f x2) (hl_lam A f x2) (eq_sym_i (hl_lam A f x1) (f x1) ((hl_lam_ap (A) f) (x1) Hx1)) (eq_sym_i (hl_lam A f x2) (f x2) ((hl_lam_ap (A) f) (x2) Hx2))) (imp_eq (x1) (x1) (x2) (x2) (fun q H => H) (fun q H => H))))))) (imp_forall_in (A) (fun x1 => forall x2 :e A, f x1 = f x2 -> x1 = x2) (fun x1 => forall x2 :e A, hl_lam A f x1 = hl_lam A f x2 -> x1 = x2) (fun x1 Hx1 => (imp_forall_in (A) (fun x2 => f x1 = f x2 -> x1 = x2) (fun x2 => hl_lam A f x1 = hl_lam A f x2 -> x1 = x2) (fun x2 Hx2 => (imp_imp (f x1 = f x2) (hl_lam A f x1 = hl_lam A f x2) (x1 = x2) (x1 = x2) (imp_eq (hl_lam A f x1) (f x1) (hl_lam A f x2) (f x2) ((hl_lam_ap (A) f) (x1) Hx1) ((hl_lam_ap (A) f) (x2) Hx2)) (imp_eq (x1) (x1) (x2) (x2) (eq_sym_i (x1) (x1) (fun q H => H)) (eq_sym_i (x2) (x2) (fun q H => H))))))))))) (HL A B HAne HBne)))).
Qed.
