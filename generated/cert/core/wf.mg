...
exact (fun HL A HAne => (imp_forall_fun2 (A :^: omega) (omega) (A) (fun H => (forall f g :e A :^: omega, forall n :e omega, (forall m :e omega, hl_lt m n = 1 -> f m = g m) -> H f n = H g n) -> exists f :e A :^: omega, forall n :e omega, f n = H f n) (fun H => (forall f g :e A :^: omega, forall n :e omega, (forall m :e omega, m < n -> f m = g m) -> H f n = H g n) -> exists f :e A :^: omega, forall n :e omega, f n = H f n) (fun H HHc => (imp_imp (forall f g :e A :^: omega, forall n :e omega, (forall m :e omega, hl_lt m n = 1 -> f m = g m) -> hl_lam2 (A :^: omega) omega H f n = hl_lam2 (A :^: omega) omega H g n) (forall f g :e A :^: omega, forall n :e omega, (forall m :e omega, m < n -> f m = g m) -> H f n = H g n) (exists f :e A :^: omega, forall n :e omega, f n = hl_lam2 (A :^: omega) omega H f n) (exists f :e A :^: omega, forall n :e omega, f n = H f n) (imp_forall_in (A :^: omega) (fun f => forall g :e A :^: omega, forall n :e omega, (forall m :e omega, m < n -> f m = g m) -> H f n = H g n) (fun f => forall g :e A :^: omega, forall n :e omega, (forall m :e omega, hl_lt m n = 1 -> f m = g m) -> hl_lam2 (A :^: omega) omega H f n = hl_lam2 (A :^: omega) omega H g n) (fun f Hf => (imp_forall_in (A :^: omega) (fun g => forall n :e omega, (forall m :e omega, m < n -> f m = g m) -> H f n = H g n) (fun g => forall n :e omega, (forall m :e omega, hl_lt m n = 1 -> f m = g m) -> hl_lam2 (A :^: omega) omega H f n = hl_lam2 (A :^: omega) omega H g n) (fun g Hg => (imp_forall_in (omega) (fun n => (forall m :e omega, m < n -> f m = g m) -> H f n = H g n) (fun n => (forall m :e omega, hl_lt m n = 1 -> f m = g m) -> hl_lam2 (A :^: omega) omega H f n = hl_lam2 (A :^: omega) omega H g n) (fun n Hn => (imp_imp (forall m :e omega, m < n -> f m = g m) (forall m :e omega, hl_lt m n = 1 -> f m = g m) (H f n = H g n) (hl_lam2 (A :^: omega) omega H f n = hl_lam2 (A :^: omega) omega H g n) (imp_forall_in (omega) (fun m => hl_lt m n = 1 -> f m = g m) (fun m => m < n -> f m = g m) (fun m Hm => (imp_imp (hl_lt m n = 1) (m < n) (f m = g m) (f m = g m) (iffER (hl_lt m n = 1) (m < n) ((hl_lt_compat) (m) Hm (n) Hn)) (imp_eq (f m) (f m) (g m) (g m) (fun q H => H) (fun q H => H))))) (imp_eq (H f n) (hl_lam2 (A :^: omega) omega H f n) (H g n) (hl_lam2 (A :^: omega) omega H g n) (eq_sym_i (hl_lam2 (A :^: omega) omega H f n) (H f n) ((hl_lam2_ap (A :^: omega) (omega) H) (f) Hf (n) Hn)) (eq_sym_i (hl_lam2 (A :^: omega) omega H g n) (H g n) ((hl_lam2_ap (A :^: omega) (omega) H) (g) Hg (n) Hn)))))))))) (imp_exists_in (A :^: omega) (fun f => forall n :e omega, f n = hl_lam2 (A :^: omega) omega H f n) (fun f => forall n :e omega, f n = H f n) (fun f Hf => (imp_forall_in (omega) (fun n => f n = hl_lam2 (A :^: omega) omega H f n) (fun n => f n = H f n) (fun n Hn => (imp_eq (f n) (f n) (hl_lam2 (A :^: omega) omega H f n) (H f n) (fun q H => H) ((hl_lam2_ap (A :^: omega) (omega) H) (f) Hf (n) Hn))))))))) (HL A HAne)).
Qed.
