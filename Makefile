...
LIBSRC = lib/hol.ml lib/mg.ml lib/rewrite.ml lib/emptycase.ml lib/registry.ml lib/elab.ml lib/literal.ml lib/manifest.ml lib/emptyproof.ml lib/bridge.ml lib/proofimport.ml
BINSRC = bin/main.ml
OUT = bin/hol2mg
