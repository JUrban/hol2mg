  ...
  [ ("EmptyE",
    ...
    ("real_le_lneg",
     Mg.AllIn ("hl__x", Mg.Cst "R", Mg.AllIn ("hl__y", Mg.Cst "R",
       Mg.App (Mg.App (Mg.Cst "iff",
         Mg.App (Mg.App (Mg.Cst "SNoLe",
           Mg.App (Mg.Cst "minus_SNo", Mg.Var "hl__x")), Mg.Var "hl__y")),
    ...
    ("div_nat_omega",
     Mg.AllIn ("hl__m", Mg.Cst "omega", Mg.AllIn ("hl__n", Mg.Cst "omega",
       mg_in (Mg.App (Mg.App (Mg.Cst "div_nat", Mg.Var "hl__m"), Mg.Var "hl__n"))
         (Mg.Cst "omega"))));
    ("mod_nat_omega",
     Mg.AllIn ("hl__m", Mg.Cst "omega", Mg.AllIn ("hl__n", Mg.Cst "omega",
       mg_in (Mg.App (Mg.App (Mg.Cst "mod_nat", Mg.Var "hl__m"), Mg.Var "hl__n"))
         (Mg.Cst "omega"))));
    ("mod_zero_thm",
     Mg.AllIn ("hl__n", Mg.Cst "omega",
       Mg.App (Mg.App (Mg.Cst "eq",
         Mg.App (Mg.App (Mg.Cst "mod_nat", Mg.Var "hl__n"), Mg.Num 0)),
         Mg.Var "hl__n")));
    ("div_zero_thm",
     Mg.AllIn ("hl__n", Mg.Cst "omega",
       Mg.App (Mg.App (Mg.Cst "eq",
         Mg.App (Mg.App (Mg.Cst "div_nat", Mg.Var "hl__n"), Mg.Num 0)),
         Mg.Num 0)));
    ("division_0_thm",
     Mg.AllIn ("hl__m", Mg.Cst "omega", Mg.AllIn ("hl__n", Mg.Cst "omega",
       Mg.App (Mg.App (Mg.Cst "and",
         Mg.Imp (Mg.App (Mg.App (Mg.Cst "eq", Mg.Var "hl__n"), Mg.Num 0),
           Mg.App (Mg.App (Mg.Cst "and",
             Mg.App (Mg.App (Mg.Cst "eq",
               Mg.App (Mg.App (Mg.Cst "div_nat", Mg.Var "hl__m"), Mg.Var "hl__n")),
               Mg.Num 0)),
    ...
    ("division_simp_thm",
     Mg.App (Mg.App (Mg.Cst "and",
       ...
       Mg.AllIn ("hl__m", Mg.Cst "omega", Mg.AllIn ("hl__n", Mg.Cst "omega",
         Mg.App (Mg.App (Mg.Cst "eq",
           Mg.App (Mg.App (Mg.Cst "add_SNo",
             Mg.App (Mg.App (Mg.Cst "mul_SNo", Mg.Var "hl__n"),
               Mg.App (Mg.App (Mg.Cst "div_nat", Mg.Var "hl__m"), Mg.Var "hl__n"))),
             Mg.App (Mg.App (Mg.Cst "mod_nat", Mg.Var "hl__m"), Mg.Var "hl__n"))),
           Mg.Var "hl__m")))));
    ...
    ("mul_SNo_nonzero_cancel",
     Mg.All ("hl__x", Mg.Set, Mg.All ("hl__y", Mg.Set, Mg.All ("hl__z", Mg.Set,
       Mg.Imp (Mg.App (Mg.Cst "SNo", Mg.Var "hl__x"),
         Mg.Imp (Mg.App (Mg.App (Mg.Cst "neq", Mg.Var "hl__x"), Mg.Num 0),
           Mg.Imp (Mg.App (Mg.Cst "SNo", Mg.Var "hl__y"),
             Mg.Imp (Mg.App (Mg.Cst "SNo", Mg.Var "hl__z"),
               Mg.Imp (Mg.App (Mg.App (Mg.Cst "eq",
                 Mg.App (Mg.App (Mg.Cst "mul_SNo", Mg.Var "hl__x"), Mg.Var "hl__y")),
    ...
    ("pos_mul_SNo_Lt",
     Mg.All ("hl__x", Mg.Set, Mg.All ("hl__y", Mg.Set, Mg.All ("hl__z", Mg.Set,
       Mg.Imp (Mg.App (Mg.Cst "SNo", Mg.Var "hl__x"),
         Mg.Imp (Mg.App (Mg.App (Mg.Cst "SNoLt", Mg.Num 0), Mg.Var "hl__x"),
           Mg.Imp (Mg.App (Mg.Cst "SNo", Mg.Var "hl__y"),
             Mg.Imp (Mg.App (Mg.Cst "SNo", Mg.Var "hl__z"),
               Mg.Imp (Mg.App (Mg.App (Mg.Cst "SNoLt", Mg.Var "hl__y"), Mg.Var "hl__z"),
                 Mg.App (Mg.App (Mg.Cst "SNoLt",
    ...
    ("mul_SNo_pos_pos",
     Mg.All ("hl__x", Mg.Set, Mg.All ("hl__y", Mg.Set,
       Mg.Imp (Mg.App (Mg.Cst "SNo", Mg.Var "hl__x"),
         Mg.Imp (Mg.App (Mg.Cst "SNo", Mg.Var "hl__y"),
           Mg.Imp (Mg.App (Mg.App (Mg.Cst "SNoLt", Mg.Num 0), Mg.Var "hl__x"),
             Mg.Imp (Mg.App (Mg.App (Mg.Cst "SNoLt", Mg.Num 0), Mg.Var "hl__y"),
               Mg.App (Mg.App (Mg.Cst "SNoLt", Mg.Num 0),
                 Mg.App (Mg.App (Mg.Cst "mul_SNo", Mg.Var "hl__x"), Mg.Var "hl__y")))))))));
    ("lt_nz_thm",
     Mg.AllIn ("hl__n", Mg.Cst "omega",
       Mg.App (Mg.App (Mg.Cst "iff",
         Mg.App (Mg.App (Mg.Cst "SNoLt", Mg.Num 0), Mg.Var "hl__n")),
         Mg.App (Mg.Cst "not",
           Mg.App (Mg.App (Mg.Cst "eq", Mg.Var "hl__n"), Mg.Num 0)))));
    ("eq_mult_lcancel_thm",
     Mg.AllIn ("hl__m", Mg.Cst "omega", Mg.AllIn ("hl__n", Mg.Cst "omega",
    ...
    ("sub_thm",
     Mg.App (Mg.App (Mg.Cst "and",
       ...
       Mg.AllIn ("hl__m", Mg.Cst "omega", Mg.AllIn ("hl__n", Mg.Cst "omega",
         Mg.App (Mg.App (Mg.Cst "eq",
           Mg.App (Mg.App (Mg.Cst "minus_nat", Mg.Var "hl__m"),
             Mg.App (Mg.Cst "ordsucc", Mg.Var "hl__n"))),
           Mg.App (Mg.Cst "nat_pred",
             Mg.App (Mg.App (Mg.Cst "minus_nat", Mg.Var "hl__m"), Mg.Var "hl__n")))))));
    ("el_thm",
     Mg.All ("hl__A", Mg.Set,
       Mg.Imp (Mg.App (Mg.Cst "not",
         Mg.App (Mg.App (Mg.Cst "eq", Mg.Var "hl__A"), Mg.Cst "Empty")),
         Mg.AllIn ("hl__l", Mg.App (Mg.Cst "finseq", Mg.Var "hl__A"),
           Mg.AllIn ("hl__n", Mg.Cst "omega",
             Mg.App (Mg.App (Mg.Cst "and",
               Mg.App (Mg.App (Mg.Cst "eq",
                 Mg.App (Mg.App (Mg.Cst "seq_nth", Mg.Var "hl__l"), Mg.Num 0)),
                 Mg.App (Mg.Cst "seq_hd", Mg.Var "hl__l"))),
               Mg.App (Mg.App (Mg.Cst "eq",
                 Mg.App (Mg.App (Mg.Cst "seq_nth", Mg.Var "hl__l"),
                   Mg.App (Mg.Cst "ordsucc", Mg.Var "hl__n"))),
                 Mg.App (Mg.App (Mg.Cst "seq_nth",
    ...
    ("reverse_thm",
     Mg.All ("hl__A", Mg.Set, Mg.AllIn ("hl__x", Mg.Var "hl__A",
       Mg.AllIn ("hl__l", Mg.App (Mg.Cst "finseq", Mg.Var "hl__A"),
         Mg.App (Mg.App (Mg.Cst "and",
           Mg.App (Mg.App (Mg.Cst "eq",
             Mg.App (Mg.Cst "seq_rev", Mg.Cst "seq_nil")),
             Mg.Cst "seq_nil")),
           Mg.App (Mg.App (Mg.Cst "eq",
             Mg.App (Mg.Cst "seq_rev",
               Mg.App (Mg.App (Mg.Cst "seq_cons", Mg.Var "hl__x"), Mg.Var "hl__l"))),
             Mg.App (Mg.App (Mg.Cst "seq_append",
               Mg.App (Mg.Cst "seq_rev", Mg.Var "hl__l")),
               Mg.App (Mg.App (Mg.Cst "seq_cons", Mg.Var "hl__x"),
                 Mg.Cst "seq_nil"))))))));
    ("real_not_lt_thm",
     Mg.AllIn ("hl__x", Mg.Cst "R", Mg.AllIn ("hl__y", Mg.Cst "R",
       Mg.App (Mg.App (Mg.Cst "iff",
    ...
    ("not_lt_thm",
     Mg.AllIn ("hl__m", Mg.Cst "omega", Mg.AllIn ("hl__n", Mg.Cst "omega",
       Mg.App (Mg.App (Mg.Cst "iff",
         Mg.App (Mg.Cst "not",
           Mg.App (Mg.App (Mg.Cst "SNoLt", Mg.Var "hl__m"), Mg.Var "hl__n"))),
         Mg.App (Mg.App (Mg.Cst "SNoLe", Mg.Var "hl__n"), Mg.Var "hl__m")))));
    ("sub_add_rcancel_thm",
     Mg.AllIn ("hl__m", Mg.Cst "omega", Mg.AllIn ("hl__n", Mg.Cst "omega",
       Mg.AllIn ("hl__p", Mg.Cst "omega",
         Mg.App (Mg.App (Mg.Cst "eq",
    ...
    ("union_of_empty_thm",
     Mg.All ("hl__A", Mg.Set,
       Mg.Imp (Mg.App (Mg.Cst "not",
         Mg.App (Mg.App (Mg.Cst "eq", Mg.Var "hl__A"), Mg.Cst "Empty")),
         Mg.All ("hl__P", Mg.Arr (Mg.Set, Mg.Prop),
           Mg.All ("hl__Q", Mg.Arr (Mg.Set, Mg.Prop),
             Mg.Imp (Mg.App (Mg.Var "hl__P", Mg.Cst "Empty"),
               Mg.ExSub ("hl__u", Mg.App (Mg.Cst "Power", Mg.Var "hl__A"),
                 Mg.App (Mg.App (Mg.Cst "and",
                   Mg.App (Mg.App (Mg.Cst "and",
                     Mg.App (Mg.Var "hl__P", Mg.Var "hl__u")),
                     Mg.AllIn ("hl__c", Mg.Var "hl__u",
                       Mg.App (Mg.Var "hl__Q", Mg.Var "hl__c")))),
                   Mg.App (Mg.App (Mg.Cst "eq",
                     Mg.App (Mg.Cst "Union", Mg.Var "hl__u")),
                     Mg.Cst "Empty")))))))));
    ("exp_add_thm",
     Mg.AllIn ("hl__m", Mg.Cst "omega", Mg.AllIn ("hl__n", Mg.Cst "omega",
       Mg.AllIn ("hl__p", Mg.Cst "omega",
         Mg.App (Mg.App (Mg.Cst "eq",
           Mg.App (Mg.App (Mg.Cst "exp_SNo_nat", Mg.Var "hl__m"),
             Mg.App (Mg.App (Mg.Cst "add_SNo", Mg.Var "hl__n"), Mg.Var "hl__p"))),
           Mg.App (Mg.App (Mg.Cst "mul_SNo",
             Mg.App (Mg.App (Mg.Cst "exp_SNo_nat", Mg.Var "hl__m"), Mg.Var "hl__n")),
             Mg.App (Mg.App (Mg.Cst "exp_SNo_nat", Mg.Var "hl__m"), Mg.Var "hl__p")))))));
    ("real_neg_sub_thm",
     Mg.AllIn ("hl__x", Mg.Cst "R", Mg.AllIn ("hl__y", Mg.Cst "R",
       Mg.App (Mg.App (Mg.Cst "eq",
         Mg.App (Mg.Cst "minus_SNo",
    ...
    ("last_cons_thm",
     Mg.All ("hl__A", Mg.Set, Mg.AllIn ("hl__h", Mg.Var "hl__A",
       Mg.AllIn ("hl__t", Mg.App (Mg.Cst "finseq", Mg.Var "hl__A"),
         Mg.App (Mg.App (Mg.Cst "eq",
           Mg.App (Mg.Cst "seq_last",
             Mg.App (Mg.App (Mg.Cst "seq_cons", Mg.Var "hl__h"), Mg.Var "hl__t"))),
           Mg.If (Mg.App (Mg.App (Mg.Cst "eq", Mg.Var "hl__t"), Mg.Cst "seq_nil"),
             Mg.Var "hl__h",
             Mg.App (Mg.Cst "seq_last", Mg.Var "hl__t")))))));
    ("intersection_of_empty_thm",
     Mg.All ("hl__A", Mg.Set,
       Mg.Imp (Mg.App (Mg.Cst "not",
         Mg.App (Mg.App (Mg.Cst "eq", Mg.Var "hl__A"), Mg.Cst "Empty")),
         Mg.All ("hl__P", Mg.Arr (Mg.Set, Mg.Prop),
                 ...
                 Mg.App (Mg.App (Mg.Cst "and",
                   Mg.App (Mg.App (Mg.Cst "and",
                     ...
                     Mg.AllIn ("hl__c", Mg.Var "hl__u",
                       Mg.App (Mg.Var "hl__Q", Mg.Var "hl__c")))),
                   Mg.App (Mg.App (Mg.Cst "eq",
                     Mg.Sep ("hl__x", Mg.Var "hl__A",
                       Mg.AllIn ("hl__Y", Mg.Var "hl__u",
                         Mg.App (Mg.App (Mg.Cst "In", Mg.Var "hl__x"), Mg.Var "hl__Y")))),
                     Mg.Var "hl__A")))))))));
    ("real_inv_inv_thm",
     Mg.AllIn ("hl__x", Mg.Cst "R",
       Mg.App (Mg.App (Mg.Cst "eq",
         Mg.App (Mg.Cst "recip_SNo",
           Mg.App (Mg.Cst "recip_SNo", Mg.Var "hl__x"))),
         Mg.Var "hl__x")));
    ("real_sub_le_thm",
     Mg.AllIn ("hl__x", Mg.Cst "R", Mg.AllIn ("hl__y", Mg.Cst "R",
       Mg.App (Mg.App (Mg.Cst "iff",
    ...
    ("mod_mult_rmod_thm",
     Mg.AllIn ("hl__m", Mg.Cst "omega", Mg.AllIn ("hl__n", Mg.Cst "omega",
       Mg.AllIn ("hl__p", Mg.Cst "omega",
         Mg.App (Mg.App (Mg.Cst "eq",
           Mg.App (Mg.App (Mg.Cst "mod_nat",
             Mg.App (Mg.App (Mg.Cst "mul_SNo", Mg.Var "hl__m"),
               Mg.App (Mg.App (Mg.Cst "mod_nat", Mg.Var "hl__p"), Mg.Var "hl__n"))),
             Mg.Var "hl__n")),
           Mg.App (Mg.App (Mg.Cst "mod_nat",
             Mg.App (Mg.App (Mg.Cst "mul_SNo", Mg.Var "hl__m"), Mg.Var "hl__p")),
             Mg.Var "hl__n"))))));
    ("real_mul_linv_uniq_thm",
     Mg.AllIn ("hl__x", Mg.Cst "R", Mg.AllIn ("hl__y", Mg.Cst "R",
       Mg.Imp (Mg.App (Mg.App (Mg.Cst "eq",
         Mg.App (Mg.App (Mg.Cst "mul_SNo", Mg.Var "hl__x"), Mg.Var "hl__y")),
         Mg.Num 1),
         Mg.App (Mg.App (Mg.Cst "eq",
           Mg.App (Mg.Cst "recip_SNo", Mg.Var "hl__y")), Mg.Var "hl__x")))));
    ("le_addr_thm",
     Mg.AllIn ("hl__m", Mg.Cst "omega", Mg.AllIn ("hl__n", Mg.Cst "omega",
       Mg.App (Mg.App (Mg.Cst "SNoLe", Mg.Var "hl__n"),
         Mg.App (Mg.App (Mg.Cst "add_SNo", Mg.Var "hl__m"), Mg.Var "hl__n")))));
    ("real_le_square_thm",
     Mg.AllIn ("hl__x", Mg.Cst "R",
       Mg.App (Mg.App (Mg.Cst "SNoLe", Mg.Num 0),
         Mg.App (Mg.App (Mg.Cst "mul_SNo", Mg.Var "hl__x"), Mg.Var "hl__x"))));
    ("mult_eq_0_thm",
     Mg.AllIn ("hl__m", Mg.Cst "omega", Mg.AllIn ("hl__n", Mg.Cst "omega",
       Mg.App (Mg.App (Mg.Cst "iff",
         Mg.App (Mg.App (Mg.Cst "eq",
     ...
     Mg.All ("hl__A", Mg.Set,
       Mg.Imp (Mg.App (Mg.Cst "not",
         ...
         Mg.AllIn ("hl__l", Mg.App (Mg.Cst "finseq", Mg.Var "hl__A"),
           Mg.App (Mg.App (Mg.Cst "iff",
             Mg.App (Mg.App (Mg.Cst "eq",
               Mg.App (Mg.Cst "seq_len", Mg.Var "hl__l")), Mg.Num 0)),
             Mg.App (Mg.App (Mg.Cst "eq", Mg.Var "hl__l"), Mg.Cst "seq_nil"))))));
    ("real_lt_nz_thm",
     Mg.AllIn ("hl__n", Mg.Cst "omega",
       Mg.App (Mg.App (Mg.Cst "iff",
         Mg.App (Mg.Cst "not",
    ...
    ("mod_eq_thm",
     Mg.AllIn ("hl__m", Mg.Cst "omega", Mg.AllIn ("hl__n", Mg.Cst "omega",
       Mg.AllIn ("hl__p", Mg.Cst "omega", Mg.AllIn ("hl__q", Mg.Cst "omega",
         Mg.Imp (Mg.App (Mg.App (Mg.Cst "eq", Mg.Var "hl__m"),
           Mg.App (Mg.App (Mg.Cst "add_SNo", Mg.Var "hl__n"),
             Mg.App (Mg.App (Mg.Cst "mul_SNo", Mg.Var "hl__q"), Mg.Var "hl__p"))),
           Mg.App (Mg.App (Mg.Cst "eq",
             Mg.App (Mg.App (Mg.Cst "mod_nat", Mg.Var "hl__m"), Mg.Var "hl__p")),
             Mg.App (Mg.App (Mg.Cst "mod_nat", Mg.Var "hl__n"), Mg.Var "hl__p"))))))));
    ("real_pow_add_thm",
     Mg.AllIn ("hl__x", Mg.Cst "R",
       Mg.AllIn ("hl__m", Mg.Cst "omega", Mg.AllIn ("hl__n", Mg.Cst "omega",
         Mg.App (Mg.App (Mg.Cst "eq",
           Mg.App (Mg.App (Mg.Cst "exp_SNo_nat", Mg.Var "hl__x"),
             Mg.App (Mg.App (Mg.Cst "add_SNo", Mg.Var "hl__m"), Mg.Var "hl__n"))),
           Mg.App (Mg.App (Mg.Cst "mul_SNo",
             Mg.App (Mg.App (Mg.Cst "exp_SNo_nat", Mg.Var "hl__x"), Mg.Var "hl__m")),
             Mg.App (Mg.App (Mg.Cst "exp_SNo_nat", Mg.Var "hl__x"), Mg.Var "hl__n")))))));
    ("lt_exists_thm",
     Mg.AllIn ("hl__m", Mg.Cst "omega", Mg.AllIn ("hl__n", Mg.Cst "omega",
       Mg.App (Mg.App (Mg.Cst "iff",
         Mg.App (Mg.App (Mg.Cst "SNoLt", Mg.Var "hl__m"), Mg.Var "hl__n")),
         Mg.ExIn ("hl__d", Mg.Cst "omega",
           Mg.App (Mg.App (Mg.Cst "eq", Mg.Var "hl__n"),
             Mg.App (Mg.App (Mg.Cst "add_SNo", Mg.Var "hl__m"),
               Mg.App (Mg.Cst "ordsucc", Mg.Var "hl__d"))))))));
    ("real_le_negtotal_thm",
     Mg.AllIn ("hl__x", Mg.Cst "R",
       Mg.App (Mg.App (Mg.Cst "or",
     ...
     Mg.AllIn ("hl__x", Mg.Cst "R", Mg.AllIn ("hl__y", Mg.Cst "R",
       Mg.AllIn ("hl__z", Mg.Cst "R",
         Mg.App (Mg.App (Mg.Cst "iff",
           ...
           Mg.App (Mg.App (Mg.Cst "or",
             Mg.App (Mg.App (Mg.Cst "eq", Mg.Var "hl__x"), Mg.Var "hl__y")),
             Mg.App (Mg.App (Mg.Cst "eq", Mg.Var "hl__z"), Mg.Num 0)))))));
    ("real_entire_thm",
     Mg.AllIn ("hl__x", Mg.Cst "R", Mg.AllIn ("hl__y", Mg.Cst "R",
       Mg.App (Mg.App (Mg.Cst "iff",
         Mg.App (Mg.App (Mg.Cst "eq",
         ...
         Mg.App (Mg.App (Mg.Cst "or",
           ...
           Mg.App (Mg.App (Mg.Cst "eq", Mg.Var "hl__y"), Mg.Num 0))))));
    ("length_append_thm",
     Mg.All ("hl__A", Mg.Set,
       Mg.Imp (Mg.App (Mg.Cst "not",
         Mg.App (Mg.App (Mg.Cst "eq", Mg.Var "hl__A"), Mg.Cst "Empty")),
           ...
           Mg.AllIn ("hl__m", Mg.App (Mg.Cst "finseq", Mg.Var "hl__A"),
             Mg.App (Mg.App (Mg.Cst "eq",
               Mg.App (Mg.Cst "seq_len",
                 Mg.App (Mg.App (Mg.Cst "seq_append", Mg.Var "hl__l"), Mg.Var "hl__m"))),
               Mg.App (Mg.App (Mg.Cst "add_SNo",
                 Mg.App (Mg.Cst "seq_len", Mg.Var "hl__l")),
                 Mg.App (Mg.Cst "seq_len", Mg.Var "hl__m"))))))));
    ("real_zpow_0_thm",
     Mg.AllIn ("hl__x", Mg.Cst "R",
       Mg.App (Mg.App (Mg.Cst "eq",
    ...
    ("tl_cons_thm",
     Mg.All ("hl__A", Mg.Set, Mg.AllIn ("hl__h", Mg.Var "hl__A",
       Mg.AllIn ("hl__t", Mg.App (Mg.Cst "finseq", Mg.Var "hl__A"),
         Mg.App (Mg.App (Mg.Cst "eq",
           Mg.App (Mg.Cst "seq_tl",
             Mg.App (Mg.App (Mg.Cst "seq_cons", Mg.Var "hl__h"), Mg.Var "hl__t"))),
           Mg.Var "hl__t")))));
    ("cons_11_thm",
     Mg.All ("hl__A", Mg.Set, Mg.AllIn ("hl__h1", Mg.Var "hl__A",
       Mg.AllIn ("hl__h2", Mg.Var "hl__A",
         Mg.AllIn ("hl__t1", Mg.App (Mg.Cst "finseq", Mg.Var "hl__A"),
           Mg.AllIn ("hl__t2", Mg.App (Mg.Cst "finseq", Mg.Var "hl__A"),
             Mg.App (Mg.App (Mg.Cst "iff",
               Mg.App (Mg.App (Mg.Cst "eq",
                 Mg.App (Mg.App (Mg.Cst "seq_cons", Mg.Var "hl__h1"), Mg.Var "hl__t1")),
                 Mg.App (Mg.App (Mg.Cst "seq_cons", Mg.Var "hl__h2"), Mg.Var "hl__t2"))),
               Mg.App (Mg.App (Mg.Cst "and",
                 Mg.App (Mg.App (Mg.Cst "eq", Mg.Var "hl__h1"), Mg.Var "hl__h2")),
                 Mg.App (Mg.App (Mg.Cst "eq", Mg.Var "hl__t1"), Mg.Var "hl__t2")))))))));
    ("even_mult_thm",
     Mg.AllIn ("hl__m", Mg.Cst "omega", Mg.AllIn ("hl__n", Mg.Cst "omega",
       Mg.App (Mg.App (Mg.Cst "iff",
         Mg.App (Mg.Cst "even_nat",
           Mg.App (Mg.App (Mg.Cst "mul_SNo", Mg.Var "hl__m"), Mg.Var "hl__n"))),
         Mg.App (Mg.App (Mg.Cst "or",
           Mg.App (Mg.Cst "even_nat", Mg.Var "hl__m")),
           Mg.App (Mg.Cst "even_nat", Mg.Var "hl__n"))))));
    ("hd_cons_thm",
     Mg.All ("hl__A", Mg.Set, Mg.AllIn ("hl__h", Mg.Var "hl__A",
       Mg.AllIn ("hl__t", Mg.App (Mg.Cst "finseq", Mg.Var "hl__A"),
         Mg.App (Mg.App (Mg.Cst "eq",
           Mg.App (Mg.Cst "seq_hd",
             Mg.App (Mg.App (Mg.Cst "seq_cons", Mg.Var "hl__h"), Mg.Var "hl__t"))),
           Mg.Var "hl__h")))));
    ("le_add_lcancel_thm",
     Mg.AllIn ("hl__m", Mg.Cst "omega", Mg.AllIn ("hl__n", Mg.Cst "omega",
       Mg.AllIn ("hl__p", Mg.Cst "omega",
         Mg.App (Mg.App (Mg.Cst "iff",
           Mg.App (Mg.App (Mg.Cst "SNoLe",
             Mg.App (Mg.App (Mg.Cst "add_SNo", Mg.Var "hl__m"), Mg.Var "hl__n")),
             Mg.App (Mg.App (Mg.Cst "add_SNo", Mg.Var "hl__m"), Mg.Var "hl__p"))),
           Mg.App (Mg.App (Mg.Cst "SNoLe", Mg.Var "hl__n"), Mg.Var "hl__p"))))));
    ("sub_add_self_thm",
     Mg.AllIn ("hl__a", Mg.Cst "omega", Mg.AllIn ("hl__b", Mg.Cst "omega",
       Mg.App (Mg.App (Mg.Cst "eq",
         Mg.App (Mg.App (Mg.Cst "minus_nat",
           Mg.App (Mg.App (Mg.Cst "add_SNo", Mg.Var "hl__a"), Mg.Var "hl__b")),
           Mg.Var "hl__a")),
         Mg.Var "hl__b"))));
    ("left_sub_distrib_thm",
     Mg.AllIn ("hl__m", Mg.Cst "omega", Mg.AllIn ("hl__n", Mg.Cst "omega",
       Mg.AllIn ("hl__p", Mg.Cst "omega",
         Mg.App (Mg.App (Mg.Cst "eq",
           Mg.App (Mg.App (Mg.Cst "mul_SNo", Mg.Var "hl__m"),
             Mg.App (Mg.App (Mg.Cst "minus_nat", Mg.Var "hl__n"), Mg.Var "hl__p"))),
           Mg.App (Mg.App (Mg.Cst "minus_nat",
             Mg.App (Mg.App (Mg.Cst "mul_SNo", Mg.Var "hl__m"), Mg.Var "hl__n")),
             Mg.App (Mg.App (Mg.Cst "mul_SNo", Mg.Var "hl__m"), Mg.Var "hl__p")))))));
    ("finite_rules_thm",
     Mg.All ("hl__A", Mg.Set,
       Mg.App (Mg.App (Mg.Cst "and",
         Mg.App (Mg.Cst "finite", Mg.Cst "Empty")),
         Mg.AllIn ("hl__x", Mg.Var "hl__A",
           Mg.AllSub ("hl__s", Mg.Var "hl__A",
             Mg.Imp (Mg.App (Mg.Cst "finite", Mg.Var "hl__s"),
               Mg.App (Mg.Cst "finite",
                 Mg.App (Mg.App (Mg.Cst "SetAdjoin", Mg.Var "hl__s"),
                   Mg.Var "hl__x"))))))));
    ("int_forall_pos_thm",
     Mg.All ("hl__P", Mg.Arr (Mg.Set, Mg.Prop),
       Mg.App (Mg.App (Mg.Cst "iff",
         Mg.AllIn ("hl__n", Mg.Cst "omega",
           Mg.App (Mg.Var "hl__P", Mg.Var "hl__n"))),
         Mg.AllIn ("hl__i", Mg.Cst "int",
           Mg.Imp (Mg.App (Mg.App (Mg.Cst "SNoLe", Mg.Num 0), Mg.Var "hl__i"),
             Mg.App (Mg.Var "hl__P", Mg.Var "hl__i"))))));
    ("odd_thm",
     Mg.App (Mg.App (Mg.Cst "and",
       Mg.App (Mg.App (Mg.Cst "iff",
         Mg.App (Mg.Cst "odd_nat", Mg.Num 0)), Mg.Cst "False")),
       Mg.AllIn ("hl__n", Mg.Cst "omega",
         Mg.App (Mg.App (Mg.Cst "iff",
           Mg.App (Mg.Cst "odd_nat", Mg.App (Mg.Cst "ordsucc", Mg.Var "hl__n"))),
           Mg.App (Mg.Cst "not", Mg.App (Mg.Cst "odd_nat", Mg.Var "hl__n"))))));
    ("sub_eq_0_thm",
     Mg.AllIn ("hl__m", Mg.Cst "omega", Mg.AllIn ("hl__n", Mg.Cst "omega",
       Mg.App (Mg.App (Mg.Cst "iff",
         Mg.App (Mg.App (Mg.Cst "eq",
