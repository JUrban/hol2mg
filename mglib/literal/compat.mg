...
// ---- isomorphisms, choice, primes, cardinal comparison, pairwise on sets of subsets ----
...
let A B. assume HA HB. let l1. assume Hl1. let f1. assume Hf1. let l2. assume Hl2. let f2. assume Hf2.
claim H1: forall x :e B, l1 (l2 x) = f1 (f2 x). { let x. assume Hx. exact (eq_trans_i (l1 (l2 x)) (f1 (l2 x)) (f1 (f2 x)) (Hf1 (l2 x) (setexp_ap B A l2 Hl2 x Hx)) (f_equal (fun u => f1 u) (l2 x) (f2 x) (Hf2 x Hx))). }
claim H2: forall y :e A, l2 (l1 y) = f2 (f1 y). { let y. assume Hy. exact (eq_trans_i (l2 (l1 y)) (f2 (l1 y)) (f2 (f1 y)) (Hf2 (l1 y) (setexp_ap A B l1 Hl1 y Hy)) (f_equal (fun u => f2 u) (l1 y) (f1 y) (Hf1 y Hy))). }
apply (iff_eq1_l (hl_ISO A B l1 l2) (if ((forall x :e B, l1 (l2 x) = x) /\ forall y :e A, l2 (l1 y) = y) then 1 else 0) (hl_ISO_unfold A B l1 Hl1 l2 Hl2) ((forall x :e B, f1 (f2 x) = x) /\ forall y :e A, f2 (f1 y) = y)).
apply (iff_trans ((if ((forall x :e B, l1 (l2 x) = x) /\ forall y :e A, l2 (l1 y) = y) then 1 else 0) = 1) ((forall x :e B, l1 (l2 x) = x) /\ forall y :e A, l2 (l1 y) = y) ((forall x :e B, f1 (f2 x) = x) /\ forall y :e A, f2 (f1 y) = y) (If_1_iff ((forall x :e B, l1 (l2 x) = x) /\ forall y :e A, l2 (l1 y) = y))).
apply (iff_and2 (forall x :e B, l1 (l2 x) = x) (forall x :e B, f1 (f2 x) = x) (forall y :e A, l2 (l1 y) = y) (forall y :e A, f2 (f1 y) = y)).
- apply iffI.
  + assume H. let x. assume Hx. exact (eq_trans_i (f1 (f2 x)) (l1 (l2 x)) x (eq_sym_i (l1 (l2 x)) (f1 (f2 x)) (H1 x Hx)) (H x Hx)).
  + assume H. let x. assume Hx. exact (eq_trans_i (l1 (l2 x)) (f1 (f2 x)) x (H1 x Hx) (H x Hx)).
- apply iffI.
  + assume H. let y. assume Hy. exact (eq_trans_i (f2 (f1 y)) (l2 (l1 y)) y (eq_sym_i (l2 (l1 y)) (f2 (f1 y)) (H2 y Hy)) (H y Hy)).
  + assume H. let y. assume Hy. exact (eq_trans_i (l2 (l1 y)) (f2 (f1 y)) y (H2 y Hy) (H y Hy)).
Qed.
Theorem hl_CHOICE_compat : forall A:set, A <> Empty -> forall l1 :e 2 :^: A, hl_CHOICE A l1 = choose_in A (fun x:set => x :e hl_rep A l1).
let A. assume HA. let s. assume Hs.
claim HF: (fun x :e A => hl_IN A x s) :e 2 :^: A. { prove (fun x :e A => hl_IN A x s) :e Pi_ x :e A, 2. apply (lam_Pi A (fun _ => 2) (fun x => hl_IN A x s)). let x. assume Hx. exact (setexp2_ap A (2 :^: A) 2 (hl_IN A) (hl_IN_in A HA) x Hx s Hs). }
rewrite (hl_CHOICE_unfold A s Hs). rewrite (hl_select_eq A (fun x :e A => hl_IN A x s) HF).
apply (choose_in_ext A (fun x => (fun x :e A => hl_IN A x s) x = 1) (fun x:set => x :e hl_rep A s)). let x. assume Hx.
apply (iff_eq1_l ((fun x :e A => hl_IN A x s) x) (hl_IN A x s) (beta A (fun x => hl_IN A x s) x Hx) (x :e hl_rep A s)). exact (hl_IN_compat A HA x Hx s Hs).
Qed.
Theorem hl_prime_compat : forall l1 :e omega, hl_prime l1 = 1 <-> prime_nat l1.
let n. assume Hn.
claim Hone: (hl_NUMERAL (hl_BIT1 hl_zero)) = 1. { exact hl_one_numeral. }
claim Hn21: 2 <> 1. { assume H. exact (In_irref 1 (H (fun hl__u hl__v => 1 :e hl__u) In_1_2)). }
apply (iff_eq1_l (hl_prime n) (if (~ n = hl_NUMERAL (hl_BIT1 hl_zero) /\ forall x :e omega, hl_num_divides x n = 1 -> x = hl_NUMERAL (hl_BIT1 hl_zero) \/ x = n) then 1 else 0) (hl_prime_unfold n Hn) (prime_nat n)).
apply (iff_trans ((if (~ n = hl_NUMERAL (hl_BIT1 hl_zero) /\ forall x :e omega, hl_num_divides x n = 1 -> x = hl_NUMERAL (hl_BIT1 hl_zero) \/ x = n) then 1 else 0) = 1) (~ n = hl_NUMERAL (hl_BIT1 hl_zero) /\ forall x :e omega, hl_num_divides x n = 1 -> x = hl_NUMERAL (hl_BIT1 hl_zero) \/ x = n) (prime_nat n) (If_1_iff (~ n = hl_NUMERAL (hl_BIT1 hl_zero) /\ forall x :e omega, hl_num_divides x n = 1 -> x = hl_NUMERAL (hl_BIT1 hl_zero) \/ x = n))).
prove (~ n = hl_NUMERAL (hl_BIT1 hl_zero) /\ forall x :e omega, hl_num_divides x n = 1 -> x = hl_NUMERAL (hl_BIT1 hl_zero) \/ x = n) <-> (n :e omega /\ 1 :e n /\ forall k :e omega, divides_nat k n -> k = 1 \/ k = n).
apply iffI.
- assume H. apply H. assume Hn1 Hdiv.
  claim Hn1': n <> 1. { assume H1. apply Hn1. exact (eq_trans_i n 1 (hl_NUMERAL (hl_BIT1 hl_zero)) H1 (eq_sym_i (hl_NUMERAL (hl_BIT1 hl_zero)) 1 Hone)). }
  claim Hdiv': forall k :e omega, divides_nat k n -> k = 1 \/ k = n.
  { let k. assume Hk Hd.
    claim Hkn: hl_num_divides k n = 1. { apply (hl_num_divides_compat k Hk n Hn). assume _ H2. exact (H2 Hd). }
    apply (Hdiv k Hk Hkn).
    - assume H1. apply orIL. exact (eq_trans_i k (hl_NUMERAL (hl_BIT1 hl_zero)) 1 H1 Hone).
    - assume H1. apply orIR. exact H1. }
  claim Hn0: n <> 0.
  { assume H0.
    claim Hd20: divides_nat 2 n. { prove 2 :e omega /\ n :e omega /\ exists k :e omega, mul_nat 2 k = n. apply andI.
      - apply andI.
        + exact (nat_p_omega 2 nat_2).
        + exact Hn.
      - witness 0. apply andI.
        + exact (nat_p_omega 0 nat_0).
        + exact (eq_trans_i (mul_nat 2 0) 0 n (mul_nat_0R 2) (eq_sym_i n 0 H0)). }
    apply (Hdiv' 2 (nat_p_omega 2 nat_2) Hd20).
    - assume H2. exact (Hn21 H2).
    - assume H2. exact (neq_2_0 (eq_trans_i 2 n 0 H2 H0)). }
  claim H1n: 1 :e n.
  { apply (nat_inv n (omega_nat_p n Hn)).
    - assume H0. exact (FalseE (Hn0 H0) (1 :e n)).
    - assume H1. apply H1. let m. assume Hm0. apply Hm0. assume Hm Hnm.
      apply (nat_inv m Hm).
      + assume Hm0'. exact (FalseE (Hn1' (eq_trans_i n (ordsucc m) 1 Hnm (f_equal (fun u => ordsucc u) m 0 Hm0'))) (1 :e n)).
      + assume H2. apply H2. let m'. assume Hm'0. apply Hm'0. assume Hm' Hmm'.
        claim H1m: 1 :e ordsucc (ordsucc m'). { exact (nat_ordsucc_in_ordsucc (ordsucc m') (nat_ordsucc m' Hm') 0 (nat_0_in_ordsucc m' Hm')). }
        exact ((eq_sym_i n (ordsucc m) Hnm) (fun hl__u hl__v => 1 :e hl__u) ((eq_sym_i m (ordsucc m') Hmm') (fun hl__u hl__v => 1 :e ordsucc hl__u) H1m)). }
  apply andI.
  + apply andI.
    * exact Hn.
    * exact H1n.
  + exact Hdiv'.
- assume H. apply H. assume H12 Hdiv. apply H12. assume _ H1n.
  apply andI.
  + assume H1. exact (In_irref 1 ((eq_trans_i n (hl_NUMERAL (hl_BIT1 hl_zero)) 1 H1 Hone) (fun hl__u hl__v => 1 :e hl__u) H1n)).
  + let x. assume Hx Hxd.
    claim Hd: divides_nat x n. { apply (hl_num_divides_compat x Hx n Hn). assume H2 _. exact (H2 Hxd). }
    apply (Hdiv x Hx Hd).
    * assume H1. apply orIL. exact (eq_trans_i x 1 (hl_NUMERAL (hl_BIT1 hl_zero)) H1 (eq_sym_i (hl_NUMERAL (hl_BIT1 hl_zero)) 1 Hone)).
    * assume H1. apply orIR. exact H1.
Qed.
...
apply (iff_eq1_l (hl_sym_3c3d5f63 A B s t) (if (exists f :e B :^: A, (forall x :e A, hl_IN A x s = 1 -> hl_IN B (f x) t = 1) /\ forall x y :e A, hl_IN A x s = 1 /\ (hl_IN A y s = 1 /\ f x = f y) -> x = y) then 1 else 0) (hl_sym_3c3d5f63_unfold A B s Hs t Ht) (atleastp (hl_rep A s) (hl_rep B t))).
apply (iff_trans ((if (exists f :e B :^: A, (forall x :e A, hl_IN A x s = 1 -> hl_IN B (f x) t = 1) /\ forall x y :e A, hl_IN A x s = 1 /\ (hl_IN A y s = 1 /\ f x = f y) -> x = y) then 1 else 0) = 1) (exists f :e B :^: A, (forall x :e A, hl_IN A x s = 1 -> hl_IN B (f x) t = 1) /\ forall x y :e A, hl_IN A x s = 1 /\ (hl_IN A y s = 1 /\ f x = f y) -> x = y) (atleastp (hl_rep A s) (hl_rep B t)) (If_1_iff (exists f :e B :^: A, (forall x :e A, hl_IN A x s = 1 -> hl_IN B (f x) t = 1) /\ forall x y :e A, hl_IN A x s = 1 /\ (hl_IN A y s = 1 /\ f x = f y) -> x = y))).
prove (exists f :e B :^: A, (forall x :e A, hl_IN A x s = 1 -> hl_IN B (f x) t = 1) /\ forall x y :e A, hl_IN A x s = 1 /\ (hl_IN A y s = 1 /\ f x = f y) -> x = y) <-> exists f:set -> set, inj (hl_rep A s) (hl_rep B t) f.
apply iffI.
- assume H. apply H. let f. assume Hf0. apply Hf0. assume Hf H2. apply H2. assume Hmap Hinj.
  witness (fun x:set => f x). prove (forall u :e hl_rep A s, f u :e hl_rep B t) /\ (forall u v :e hl_rep A s, f u = f v -> u = v). apply andI.
  + let u. assume Hu.
    claim HuA: u :e A. { exact (hl_rep_Subq A s u Hu). }
    claim Hin: hl_IN A u s = 1. { apply (hl_IN_compat A HA u HuA s Hs). assume _ H3. exact (H3 Hu). }
    claim Hfu: f u :e B. { exact (setexp_ap A B f Hf u HuA). }
    apply (hl_IN_compat B HB (f u) Hfu t Ht). assume H3 _. exact (H3 (Hmap u HuA Hin)).
  + let u. assume Hu. let v. assume Hv. assume Heq.
    claim HuA: u :e A. { exact (hl_rep_Subq A s u Hu). }
    claim HvA: v :e A. { exact (hl_rep_Subq A s v Hv). }
    claim Hinu: hl_IN A u s = 1. { apply (hl_IN_compat A HA u HuA s Hs). assume _ H3. exact (H3 Hu). }
    claim Hinv: hl_IN A v s = 1. { apply (hl_IN_compat A HA v HvA s Hs). assume _ H3. exact (H3 Hv). }
    exact (Hinj u HuA v HvA (andI (hl_IN A u s = 1) (hl_IN A v s = 1 /\ f u = f v) Hinu (andI (hl_IN A v s = 1) (f u = f v) Hinv Heq))).
- assume H. apply H. let f. assume Hinj. apply Hinj. assume Hmap Hinj2.
  claim HG: forall x :e A, (fun x :e A => if x :e hl_rep A s then f x else hl_ARB B) x = if x :e hl_rep A s then f x else hl_ARB B. { let x. assume Hx. exact (beta A (fun x => if x :e hl_rep A s then f x else hl_ARB B) x Hx). }
  claim HGs: forall x :e A, x :e hl_rep A s -> (fun x :e A => if x :e hl_rep A s then f x else hl_ARB B) x = f x. { let x. assume Hx Hxs. exact (eq_trans_i ((fun x :e A => if x :e hl_rep A s then f x else hl_ARB B) x) (if x :e hl_rep A s then f x else hl_ARB B) (f x) (HG x Hx) (If_i_1 (x :e hl_rep A s) (f x) (hl_ARB B) Hxs)). }
  witness (fun x :e A => if x :e hl_rep A s then f x else hl_ARB B). apply andI.
  + prove (fun x :e A => if x :e hl_rep A s then f x else hl_ARB B) :e Pi_ x :e A, B. apply (lam_Pi A (fun _ => B) (fun x => if x :e hl_rep A s then f x else hl_ARB B)). let x. assume Hx. apply (xm (x :e hl_rep A s)).
    * assume Hxs. exact ((eq_sym_i (if x :e hl_rep A s then f x else hl_ARB B) (f x) (If_i_1 (x :e hl_rep A s) (f x) (hl_ARB B) Hxs)) (fun hl__u hl__v => hl__u :e B) (hl_rep_Subq B t (f x) (Hmap x Hxs))).
    * assume Hxs. exact ((eq_sym_i (if x :e hl_rep A s then f x else hl_ARB B) (hl_ARB B) (If_i_0 (x :e hl_rep A s) (f x) (hl_ARB B) Hxs)) (fun hl__u hl__v => hl__u :e B) (hl_ARB_in B HB)).
  + apply andI.
    * let x. assume Hx Hin.
      claim Hxs: x :e hl_rep A s. { apply (hl_IN_compat A HA x Hx s Hs). assume H3 _. exact (H3 Hin). }
      claim Hfx: f x :e hl_rep B t. { exact (Hmap x Hxs). }
      claim HfxB: f x :e B. { exact (hl_rep_Subq B t (f x) Hfx). }
      claim H4: hl_IN B (f x) t = 1. { apply (hl_IN_compat B HB (f x) HfxB t Ht). assume _ H5. exact (H5 Hfx). }
      exact ((eq_sym_i ((fun x :e A => if x :e hl_rep A s then f x else hl_ARB B) x) (f x) (HGs x Hx Hxs)) (fun hl__u hl__v => hl_IN B hl__u t = 1) H4).
    * let x. assume Hx. let y. assume Hy. assume H3. apply H3. assume Hinx H4. apply H4. assume Hiny Heq.
      claim Hxs: x :e hl_rep A s. { apply (hl_IN_compat A HA x Hx s Hs). assume H5 _. exact (H5 Hinx). }
      claim Hys: y :e hl_rep A s. { apply (hl_IN_compat A HA y Hy s Hs). assume H5 _. exact (H5 Hiny). }
      exact (Hinj2 x Hxs y Hys (eq_trans_i (f x) ((fun x :e A => if x :e hl_rep A s then f x else hl_ARB B) x) (f y) (eq_sym_i ((fun x :e A => if x :e hl_rep A s then f x else hl_ARB B) x) (f x) (HGs x Hx Hxs)) (eq_trans_i ((fun x :e A => if x :e hl_rep A s then f x else hl_ARB B) x) ((fun x :e A => if x :e hl_rep A s then f x else hl_ARB B) y) (f y) Heq (HGs y Hy Hys)))).
Qed.
...
let A. assume HA. let r. assume Hr. let P1. assume HP. let s. assume Hs.
apply (iff_eq1_l (hl_pairwise (2 :^: A) r s) (if (forall x y :e 2 :^: A, hl_IN (2 :^: A) x s = 1 /\ (hl_IN (2 :^: A) y s = 1 /\ ~ x = y) -> r x y = 1) then 1 else 0) (hl_pairwise_unfold (2 :^: A) r Hr s Hs) (forall x y :e hl_rep2 A s, x <> y -> P1 x y)).
apply (iff_trans ((if (forall x y :e 2 :^: A, hl_IN (2 :^: A) x s = 1 /\ (hl_IN (2 :^: A) y s = 1 /\ ~ x = y) -> r x y = 1) then 1 else 0) = 1) (forall x y :e 2 :^: A, hl_IN (2 :^: A) x s = 1 /\ (hl_IN (2 :^: A) y s = 1 /\ ~ x = y) -> r x y = 1) (forall x y :e hl_rep2 A s, x <> y -> P1 x y) (If_1_iff (forall x y :e 2 :^: A, hl_IN (2 :^: A) x s = 1 /\ (hl_IN (2 :^: A) y s = 1 /\ ~ x = y) -> r x y = 1))).
apply iffI.
- assume H. let X. assume HX. let Y. assume HY. assume Hne.
  apply (ReplE_impred (hl_rep (2 :^: A) s) (fun u => hl_rep A u) X HX). let u. assume Hu HXu.
  apply (ReplE_impred (hl_rep (2 :^: A) s) (fun u => hl_rep A u) Y HY). let v. assume Hv HYv.
  claim HuA: u :e 2 :^: A. { exact (hl_rep_Subq (2 :^: A) s u Hu). }
  claim HvA: v :e 2 :^: A. { exact (hl_rep_Subq (2 :^: A) s v Hv). }
  claim Hinu: hl_IN (2 :^: A) u s = 1. { apply (hl_IN_compat (2 :^: A) (setexp_nonempty A 2 two_nonempty) u HuA s Hs). assume _ H3. exact (H3 Hu). }
  claim Hinv: hl_IN (2 :^: A) v s = 1. { apply (hl_IN_compat (2 :^: A) (setexp_nonempty A 2 two_nonempty) v HvA s Hs). assume _ H3. exact (H3 Hv). }
  claim Huv: ~ u = v. { assume Heq. apply Hne. exact (eq_trans_i X (hl_rep A u) Y HXu (eq_trans_i (hl_rep A u) (hl_rep A v) Y (f_equal (fun w => hl_rep A w) u v Heq) (eq_sym_i Y (hl_rep A v) HYv))). }
  claim Hruv: r u v = 1. { exact (H u HuA v HvA (andI (hl_IN (2 :^: A) u s = 1) (hl_IN (2 :^: A) v s = 1 /\ ~ u = v) Hinu (andI (hl_IN (2 :^: A) v s = 1) (~ u = v) Hinv Huv))). }
  claim HP1: P1 (hl_rep A u) (hl_rep A v). { apply (HP u HuA v HvA). assume H3 _. exact (H3 Hruv). }
  exact ((eq_sym_i Y (hl_rep A v) HYv) (fun hl__u hl__v => P1 X hl__u) ((eq_sym_i X (hl_rep A u) HXu) (fun hl__u hl__v => P1 hl__u (hl_rep A v)) HP1)).
- assume H. let u. assume Hu. let v. assume Hv. assume H3. apply H3. assume Hinu H4. apply H4. assume Hinv Hne.
  claim Hus: u :e hl_rep (2 :^: A) s. { apply (hl_IN_compat (2 :^: A) (setexp_nonempty A 2 two_nonempty) u Hu s Hs). assume H5 _. exact (H5 Hinu). }
  claim Hvs: v :e hl_rep (2 :^: A) s. { apply (hl_IN_compat (2 :^: A) (setexp_nonempty A 2 two_nonempty) v Hv s Hs). assume H5 _. exact (H5 Hinv). }
  claim HX: hl_rep A u :e hl_rep2 A s. { exact (ReplI (hl_rep (2 :^: A) s) (fun u => hl_rep A u) u Hus). }
  claim HY: hl_rep A v :e hl_rep2 A s. { exact (ReplI (hl_rep (2 :^: A) s) (fun u => hl_rep A u) v Hvs). }
...
// ---- greatest common divisors: HOL Light's Bezout specification versus the native gcd_int ----
Theorem gcd_int_00 : gcd_int 0 0 = 0.
prove (if 0 = 0 /\ 0 = 0 then 0 else choose_in int (fun d => 0 <= d /\ gcd_reln 0 0 d)) = 0.
exact (If_i_1 (0 = 0 /\ 0 = 0) 0 (choose_in int (fun d => 0 <= d /\ gcd_reln 0 0 d)) (andI (0 = 0) (0 = 0) (fun q H => H) (fun q H => H))).
Qed.
Theorem gcd_int_spec : forall a b :e int, ~ (a = 0 /\ b = 0) -> gcd_int a b :e int /\ 0 <= gcd_int a b /\ gcd_reln a b (gcd_int a b).
let a. assume Ha. let b. assume Hb. assume Hne.
claim Hunf: gcd_int a b = (choose_in int (fun d => 0 <= d /\ gcd_reln a b d)). { prove (if a = 0 /\ b = 0 then 0 else (choose_in int (fun d => 0 <= d /\ gcd_reln a b d))) = (choose_in int (fun d => 0 <= d /\ gcd_reln a b d)). exact (If_i_0 (a = 0 /\ b = 0) 0 (choose_in int (fun d => 0 <= d /\ gcd_reln a b d)) Hne). }
claim Hex: exists d :e int, 0 <= d /\ gcd_reln a b d.
{ apply (least_pos_int_lin_comb_ex a Ha b Hb Hne). let c. assume Hc0. apply Hc0. assume Hc12 Hmin. apply Hc12. assume Hlc Hpos.
  witness c. apply andI.
  - exact (int_lin_comb_E3 a b c Hlc).
  - exact (andI (0 <= c) (gcd_reln a b c) (SNoLtLe 0 c Hpos) (least_pos_int_lin_comb_gcd a b c Hlc Hpos Hmin)). }
apply (choose_in_spec int (fun d => 0 <= d /\ gcd_reln a b d) Hex). assume Hin Hp. apply Hp. assume Hnn Hg.
apply andI.
- apply andI.
  + exact ((eq_sym_i (gcd_int a b) (choose_in int (fun d => 0 <= d /\ gcd_reln a b d)) Hunf) (fun hl__u hl__v => hl__u :e int) Hin).
  + exact ((eq_sym_i (gcd_int a b) (choose_in int (fun d => 0 <= d /\ gcd_reln a b d)) Hunf) (fun hl__u hl__v => 0 <= hl__u) Hnn).
- exact ((eq_sym_i (gcd_int a b) (choose_in int (fun d => 0 <= d /\ gcd_reln a b d)) Hunf) (fun hl__u hl__v => gcd_reln a b hl__u) Hg).
Qed.
Theorem gcd_reln_of_bezout : forall a b d :e int, divides_int d a -> divides_int d b -> 0 <= d -> ~ (a = 0 /\ b = 0) -> (exists x y :e int, d = a * x + b * y) -> gcd_reln a b d.
let a. assume Ha. let b. assume Hb. let d. assume Hd. assume Hda Hdb Hnn Hne Hbez.
apply Hbez. let x. assume Hx0. apply Hx0. assume Hx Hy0. apply Hy0. let y. assume Hy1. apply Hy1. assume Hy Heq.
claim Hdpos: 0 < d.
{ apply (SNoLeE 0 d SNo_0 (int_SNo d Hd) Hnn).
  - assume H. exact H.
  - assume H0. apply Hne.
    claim Hd0: d = 0. { exact (eq_sym_i 0 d H0). }
    claim Hda0: divides_int 0 a. { exact (Hd0 (fun hl__u hl__v => divides_int hl__u a) Hda). }
    claim Hdb0: divides_int 0 b. { exact (Hd0 (fun hl__u hl__v => divides_int hl__u b) Hdb). }
    exact (andI (a = 0) (b = 0) (god1_zero_divides_integer_only_zero a Ha Hda0) (god1_zero_divides_integer_only_zero b Hb Hdb0)). }
prove divides_int d a /\ divides_int d b /\ forall d', divides_int d' a -> divides_int d' b -> d' <= d.
apply andI.
- exact (andI (divides_int d a) (divides_int d b) Hda Hdb).
- let d'. assume H1 H2.
  claim Hdiv: divides_int d' d. { exact ((eq_sym_i d (a * x + b * y) Heq) (fun hl__u hl__v => divides_int d' hl__u) (divides_int_add_SNo d' (a * x) (b * y) (divides_int_mul_SNo_L d' a x Hx H1) (divides_int_mul_SNo_L d' b y Hy H2))). }
  exact (divides_int_pos_Le d' d Hdiv Hdpos).
Qed.
Theorem hl_int_gcd_compat : forall l1 :e int :*: int, hl_int_gcd l1 = gcd_int (l1 0) (l1 1).
claim Hspec: (exists g :e int :^: (int :*: int), (forall a b :e int, hl_int_le (hl_int_of_num (hl_NUMERAL hl_zero)) (g (hl_pair int int a b)) = 1 /\ (hl_int_divides (g (hl_pair int int a b)) a = 1 /\ (hl_int_divides (g (hl_pair int int a b)) b = 1 /\ exists x y :e int, g (hl_pair int int a b) = hl_int_add (hl_int_mul a x) (hl_int_mul b y))))) -> (forall a b :e int, hl_int_le (hl_int_of_num (hl_NUMERAL hl_zero)) (hl_int_gcd (hl_pair int int a b)) = 1 /\ (hl_int_divides (hl_int_gcd (hl_pair int int a b)) a = 1 /\ (hl_int_divides (hl_int_gcd (hl_pair int int a b)) b = 1 /\ exists x y :e int, hl_int_gcd (hl_pair int int a b) = hl_int_add (hl_int_mul a x) (hl_int_mul b y)))) /\ hl_int_gcd :e int :^: (int :*: int). { exact (hl_ty_int_native (fun hl__u hl__v => (exists g :e hl__u :^: (hl__u :*: hl__u), (forall a b :e hl__u, hl_int_le (hl_int_of_num (hl_NUMERAL hl_zero)) (g (hl_pair hl__u hl__u a b)) = 1 /\ (hl_int_divides (g (hl_pair hl__u hl__u a b)) a = 1 /\ (hl_int_divides (g (hl_pair hl__u hl__u a b)) b = 1 /\ exists x y :e hl__u, g (hl_pair hl__u hl__u a b) = hl_int_add (hl_int_mul a x) (hl_int_mul b y))))) -> (forall a b :e hl__u, hl_int_le (hl_int_of_num (hl_NUMERAL hl_zero)) (hl_int_gcd (hl_pair hl__u hl__u a b)) = 1 /\ (hl_int_divides (hl_int_gcd (hl_pair hl__u hl__u a b)) a = 1 /\ (hl_int_divides (hl_int_gcd (hl_pair hl__u hl__u a b)) b = 1 /\ exists x y :e hl__u, hl_int_gcd (hl_pair hl__u hl__u a b) = hl_int_add (hl_int_mul a x) (hl_int_mul b y)))) /\ hl_int_gcd :e hl__u :^: (hl__u :*: hl__u)) hl_int_gcd_spec). }
...
claim HgcdI: forall a b :e int, gcd_int a b :e int.
...
claim Hg: exists g :e int :^: (int :*: int), (forall a b :e int, hl_int_le (hl_int_of_num (hl_NUMERAL hl_zero)) (g (hl_pair int int a b)) = 1 /\ (hl_int_divides (g (hl_pair int int a b)) a = 1 /\ (hl_int_divides (g (hl_pair int int a b)) b = 1 /\ exists x y :e int, g (hl_pair int int a b) = hl_int_add (hl_int_mul a x) (hl_int_mul b y)))).
{ witness (fun p :e int :*: int => gcd_int (p 0) (p 1)). apply andI.
  - prove (fun p :e int :*: int => gcd_int (p 0) (p 1)) :e Pi_ p :e int :*: int, int. apply (lam_Pi (int :*: int) (fun _ => int) (fun p => gcd_int (p 0) (p 1))). let p. assume Hp. exact (HgcdI (p 0) (ap0_Sigma int (fun _ => int) p Hp) (p 1) (ap1_Sigma int (fun _ => int) p Hp)).
  - let a. assume Ha. let b. assume Hb.
    claim Hpab: (a,b) :e int :*: int. { exact (tuple_2_setprod int int a Ha b Hb). }
    claim Hpair: hl_pair int int a b = (a,b). { exact (hl_pair_compat int int hl_ty_int_native_nonempty hl_ty_int_native_nonempty a Ha b Hb). }
    claim HG: (fun p :e int :*: int => gcd_int (p 0) (p 1)) (hl_pair int int a b) = gcd_int a b.
    { exact (eq_trans_i ((fun p :e int :*: int => gcd_int (p 0) (p 1)) (hl_pair int int a b)) ((fun p :e int :*: int => gcd_int (p 0) (p 1)) (a,b)) (gcd_int a b) (f_equal (fun u => (fun p :e int :*: int => gcd_int (p 0) (p 1)) u) (hl_pair int int a b) (a,b) Hpair) (eq_trans_i ((fun p :e int :*: int => gcd_int (p 0) (p 1)) (a,b)) (gcd_int ((a,b) 0) ((a,b) 1)) (gcd_int a b) (beta (int :*: int) (fun p => gcd_int (p 0) (p 1)) (a,b) Hpab) (f_equal2 (fun u v => gcd_int u v) ((a,b) 0) a ((a,b) 1) b (tuple_2_0_eq a b) (tuple_2_1_eq a b)))). }
    claim HdI: gcd_int a b :e int. { exact (HgcdI a Ha b Hb). }
    claim Hfacts: 0 <= gcd_int a b /\ divides_int (gcd_int a b) a /\ divides_int (gcd_int a b) b /\ exists x y :e int, gcd_int a b = a * x + b * y.
    { apply (xm (a = 0 /\ b = 0)).
      - assume H. apply H. assume Ha0 Hb0.
        claim Hg0: gcd_int a b = 0. { exact (eq_trans_i (gcd_int a b) (gcd_int 0 0) 0 (f_equal2 (fun u v => gcd_int u v) a 0 b 0 Ha0 Hb0) gcd_int_00). }
        claim Hbez0: a * 0 + b * 0 = 0. { exact (eq_trans_i (a * 0 + b * 0) (0 + 0) 0 (f_equal2 (fun u v => u + v) (a * 0) 0 (b * 0) 0 (mul_SNo_zeroR a (int_SNo a Ha)) (mul_SNo_zeroR b (int_SNo b Hb))) (add_SNo_0L 0 SNo_0)). }
        apply andI.
        + apply andI.
          * apply andI.
            - exact ((eq_sym_i (gcd_int a b) 0 Hg0) (fun hl__u hl__v => 0 <= hl__u) (SNoLe_ref 0)).
            - exact ((eq_sym_i (gcd_int a b) 0 Hg0) (fun hl__u hl__v => divides_int hl__u a) ((eq_sym_i a 0 Ha0) (fun hl__u hl__v => divides_int 0 hl__u) (divides_int_0 0 (Subq_omega_int 0 (nat_p_omega 0 nat_0))))).
          * exact ((eq_sym_i (gcd_int a b) 0 Hg0) (fun hl__u hl__v => divides_int hl__u b) ((eq_sym_i b 0 Hb0) (fun hl__u hl__v => divides_int 0 hl__u) (divides_int_0 0 (Subq_omega_int 0 (nat_p_omega 0 nat_0))))).
        + witness 0. apply andI.
          * exact (Subq_omega_int 0 (nat_p_omega 0 nat_0)).
          * witness 0. apply andI.
            - exact (Subq_omega_int 0 (nat_p_omega 0 nat_0)).
            - exact (eq_trans_i (gcd_int a b) 0 (a * 0 + b * 0) Hg0 (eq_sym_i (a * 0 + b * 0) 0 Hbez0)).
      - assume Hne. apply (gcd_int_spec a Ha b Hb Hne). assume H12 Hgr. apply H12. assume HdI' Hnn.
        claim Hlc: exists c, int_lin_comb a b c /\ 0 < c /\ forall c', int_lin_comb a b c' -> 0 < c' -> c <= c'. { exact (least_pos_int_lin_comb_ex a Ha b Hb Hne). }
        apply Hlc. let c. assume Hc0. apply Hc0. assume Hc12 Hmin. apply Hc12. assume Hlin Hpos.
        claim Hgc: gcd_reln a b c. { exact (least_pos_int_lin_comb_gcd a b c Hlin Hpos Hmin). }
        claim Hdc: gcd_int a b = c. { exact (gcd_reln_uniq a b (gcd_int a b) c Hgr Hgc). }
        apply Hgr. assume Hg12 _. apply Hg12. assume Hda Hdb.
        apply andI.
        + apply andI.
          * exact (andI (0 <= gcd_int a b) (divides_int (gcd_int a b) a) Hnn Hda).
          * exact Hdb.
        + apply (int_lin_comb_E4 a b c Hlin). let m. assume Hm. let n. assume Hn. assume Hmn.
          witness m. apply andI.
          * exact Hm.
          * witness n. apply andI.
            - exact Hn.
            - exact (eq_trans_i (gcd_int a b) c (a * m + b * n) Hdc (eq_trans_i c (m * a + n * b) (a * m + b * n) (eq_sym_i (m * a + n * b) c Hmn) (f_equal2 (fun u v => u + v) (m * a) (a * m) (n * b) (b * n) (mul_SNo_com m a (int_SNo m Hm) (int_SNo a Ha)) (mul_SNo_com n b (int_SNo n Hn) (int_SNo b Hb))))). }
    apply Hfacts. assume H123 Hbez. apply H123. assume H12 Hdb. apply H12. assume Hnn Hda.
    apply andI.
    + exact ((eq_sym_i ((fun p :e int :*: int => gcd_int (p 0) (p 1)) (hl_pair int int a b)) (gcd_int a b) HG) (fun hl__u hl__v => hl_int_le (hl_int_of_num (hl_NUMERAL hl_zero)) hl__u = 1) ((eq_sym_i (hl_int_of_num (hl_NUMERAL hl_zero)) 0 H0) (fun hl__u hl__v => hl_int_le hl__u (gcd_int a b) = 1) (iffER (hl_int_le 0 (gcd_int a b) = 1) (0 <= gcd_int a b) (hl_int_le_compat 0 (Subq_omega_int 0 (nat_p_omega 0 nat_0)) (gcd_int a b) HdI) Hnn))).
    + apply andI.
      * exact ((eq_sym_i ((fun p :e int :*: int => gcd_int (p 0) (p 1)) (hl_pair int int a b)) (gcd_int a b) HG) (fun hl__u hl__v => hl_int_divides hl__u a = 1) (iffER (hl_int_divides (gcd_int a b) a = 1) (divides_int (gcd_int a b) a) (hl_int_divides_compat (gcd_int a b) HdI a Ha) Hda)).
      * apply andI.
        - exact ((eq_sym_i ((fun p :e int :*: int => gcd_int (p 0) (p 1)) (hl_pair int int a b)) (gcd_int a b) HG) (fun hl__u hl__v => hl_int_divides hl__u b = 1) (iffER (hl_int_divides (gcd_int a b) b = 1) (divides_int (gcd_int a b) b) (hl_int_divides_compat (gcd_int a b) HdI b Hb) Hdb)).
        - apply Hbez. let x. assume Hx0. apply Hx0. assume Hx Hy0. apply Hy0. let y. assume Hy1. apply Hy1. assume Hy Heq.
          witness x. apply andI.
          + exact Hx.
          + witness y. apply andI.
            * exact Hy.
            * exact (eq_trans_i ((fun p :e int :*: int => gcd_int (p 0) (p 1)) (hl_pair int int a b)) (gcd_int a b) (hl_int_add (hl_int_mul a x) (hl_int_mul b y)) HG (eq_trans_i (gcd_int a b) (a * x + b * y) (hl_int_add (hl_int_mul a x) (hl_int_mul b y)) Heq (eq_sym_i (hl_int_add (hl_int_mul a x) (hl_int_mul b y)) (a * x + b * y) (eq_trans_i (hl_int_add (hl_int_mul a x) (hl_int_mul b y)) (hl_int_mul a x + hl_int_mul b y) (a * x + b * y) (hl_int_add_compat (hl_int_mul a x) ((eq_sym_i (hl_int_mul a x) (a * x) (hl_int_mul_compat a Ha x Hx)) (fun hl__u hl__v => hl__u :e int) (int_mul_SNo a Ha x Hx)) (hl_int_mul b y) ((eq_sym_i (hl_int_mul b y) (b * y) (hl_int_mul_compat b Hb y Hy)) (fun hl__u hl__v => hl__u :e int) (int_mul_SNo b Hb y Hy))) (f_equal2 (fun u v => u + v) (hl_int_mul a x) (a * x) (hl_int_mul b y) (b * y) (hl_int_mul_compat a Ha x Hx) (hl_int_mul_compat b Hb y Hy)))))). }
apply (Hspec Hg). assume Hc Hin.
let p. assume Hp.
claim Ha: p 0 :e int. { exact (ap0_Sigma int (fun _ => int) p Hp). }
claim Hb: p 1 :e int. { exact (ap1_Sigma int (fun _ => int) p Hp). }
claim Hpe: p = hl_pair int int (p 0) (p 1). { exact (eq_sym_i (hl_pair int int (p 0) (p 1)) p (eq_trans_i (hl_pair int int (p 0) (p 1)) (p 0, p 1) p (hl_pair_compat int int hl_ty_int_native_nonempty hl_ty_int_native_nonempty (p 0) Ha (p 1) Hb) (tuple_Sigma_eta int (fun _ => int) p Hp))). }
claim HD: hl_int_gcd (hl_pair int int (p 0) (p 1)) :e int. { exact (setexp_ap (int :*: int) int hl_int_gcd Hin (hl_pair int int (p 0) (p 1)) (Hpe (fun hl__u hl__v => hl__u :e int :*: int) Hp)). }
apply (Hc (p 0) Ha (p 1) Hb). assume Hle H2. apply H2. assume Hda H3. apply H3. assume Hdb Hbez.
claim Hnn: 0 <= hl_int_gcd (hl_pair int int (p 0) (p 1)). { apply (hl_int_le_compat 0 (Subq_omega_int 0 (nat_p_omega 0 nat_0)) (hl_int_gcd (hl_pair int int (p 0) (p 1))) HD). assume H4 _. apply H4. exact (H0 (fun hl__u hl__v => hl_int_le hl__u (hl_int_gcd (hl_pair int int (p 0) (p 1))) = 1) Hle). }
claim Hda': divides_int (hl_int_gcd (hl_pair int int (p 0) (p 1))) (p 0). { apply (hl_int_divides_compat (hl_int_gcd (hl_pair int int (p 0) (p 1))) HD (p 0) Ha). assume H4 _. exact (H4 Hda). }
claim Hdb': divides_int (hl_int_gcd (hl_pair int int (p 0) (p 1))) (p 1). { apply (hl_int_divides_compat (hl_int_gcd (hl_pair int int (p 0) (p 1))) HD (p 1) Hb). assume H4 _. exact (H4 Hdb). }
claim Hbez': exists x y :e int, hl_int_gcd (hl_pair int int (p 0) (p 1)) = p 0 * x + p 1 * y.
{ apply Hbez. let x. assume Hx0. apply Hx0. assume Hx Hy0. apply Hy0. let y. assume Hy1. apply Hy1. assume Hy Heq.
  witness x. apply andI.
  - exact Hx.
  - witness y. apply andI.
    + exact Hy.
    + exact (eq_trans_i (hl_int_gcd (hl_pair int int (p 0) (p 1))) (hl_int_add (hl_int_mul (p 0) x) (hl_int_mul (p 1) y)) (p 0 * x + p 1 * y) Heq (eq_trans_i (hl_int_add (hl_int_mul (p 0) x) (hl_int_mul (p 1) y)) (hl_int_mul (p 0) x + hl_int_mul (p 1) y) (p 0 * x + p 1 * y) (hl_int_add_compat (hl_int_mul (p 0) x) ((eq_sym_i (hl_int_mul (p 0) x) (p 0 * x) (hl_int_mul_compat (p 0) Ha x Hx)) (fun hl__u hl__v => hl__u :e int) (int_mul_SNo (p 0) Ha x Hx)) (hl_int_mul (p 1) y) ((eq_sym_i (hl_int_mul (p 1) y) (p 1 * y) (hl_int_mul_compat (p 1) Hb y Hy)) (fun hl__u hl__v => hl__u :e int) (int_mul_SNo (p 1) Hb y Hy))) (f_equal2 (fun u v => u + v) (hl_int_mul (p 0) x) (p 0 * x) (hl_int_mul (p 1) y) (p 1 * y) (hl_int_mul_compat (p 0) Ha x Hx) (hl_int_mul_compat (p 1) Hb y Hy)))). }
claim Hmain: hl_int_gcd (hl_pair int int (p 0) (p 1)) = gcd_int (p 0) (p 1).
{ apply (xm (p 0 = 0 /\ p 1 = 0)).
  - assume H. apply H. assume Ha0 Hb0.
    claim Hg0: gcd_int (p 0) (p 1) = 0. { exact (eq_trans_i (gcd_int (p 0) (p 1)) (gcd_int 0 0) 0 (f_equal2 (fun u v => gcd_int u v) (p 0) 0 (p 1) 0 Ha0 Hb0) gcd_int_00). }
    apply Hbez'. let x. assume Hx0. apply Hx0. assume Hx Hy0. apply Hy0. let y. assume Hy1. apply Hy1. assume Hy Heq.
    claim Hz: p 0 * x + p 1 * y = 0. { exact (eq_trans_i (p 0 * x + p 1 * y) (0 * x + 0 * y) 0 (f_equal2 (fun u v => u * x + v * y) (p 0) 0 (p 1) 0 Ha0 Hb0) (eq_trans_i (0 * x + 0 * y) (0 + 0) 0 (f_equal2 (fun u v => u + v) (0 * x) 0 (0 * y) 0 (mul_SNo_zeroL x (int_SNo x Hx)) (mul_SNo_zeroL y (int_SNo y Hy))) (add_SNo_0L 0 SNo_0))). }
    exact (eq_trans_i (hl_int_gcd (hl_pair int int (p 0) (p 1))) 0 (gcd_int (p 0) (p 1)) (eq_trans_i (hl_int_gcd (hl_pair int int (p 0) (p 1))) (p 0 * x + p 1 * y) 0 Heq Hz) (eq_sym_i (gcd_int (p 0) (p 1)) 0 Hg0)).
  - assume Hne.
    claim HgrD: gcd_reln (p 0) (p 1) (hl_int_gcd (hl_pair int int (p 0) (p 1))). { exact (gcd_reln_of_bezout (p 0) Ha (p 1) Hb (hl_int_gcd (hl_pair int int (p 0) (p 1))) HD Hda' Hdb' Hnn Hne Hbez'). }
    apply (gcd_int_spec (p 0) Ha (p 1) Hb Hne). assume _ Hgr.
    exact (gcd_reln_uniq (p 0) (p 1) (hl_int_gcd (hl_pair int int (p 0) (p 1))) (gcd_int (p 0) (p 1)) HgrD Hgr). }
exact (eq_trans_i (hl_int_gcd p) (hl_int_gcd (hl_pair int int (p 0) (p 1))) (gcd_int (p 0) (p 1)) (f_equal (fun u => hl_int_gcd u) p (hl_pair int int (p 0) (p 1)) Hpe) Hmain).
Qed.

// ---- coprimality and the gcd of naturals ----
Theorem gcd_int_eq_1_iff : forall a b :e int, gcd_int a b = 1 <-> exists x y :e int, a * x + b * y = 1.
let a. assume Ha. let b. assume Hb.
claim H0i: 0 :e int. { exact (Subq_omega_int 0 (nat_p_omega 0 nat_0)). }
claim H1i: 1 :e int. { exact (Subq_omega_int 1 (nat_p_omega 1 nat_1)). }
claim H01: 0 < 1. { exact (omega_In_SNoLt 1 (nat_p_omega 1 nat_1) 0 (nat_0_in_ordsucc 0 nat_0)). }
apply iffI.
- assume Hg1.
  claim Hne: ~ (a = 0 /\ b = 0).
  { assume H. apply H. assume Ha0 Hb0. exact (neq_0_1 (eq_trans_i 0 (gcd_int a b) 1 (eq_sym_i (gcd_int a b) 0 (eq_trans_i (gcd_int a b) (gcd_int 0 0) 0 (f_equal2 (fun u v => gcd_int u v) a 0 b 0 Ha0 Hb0) gcd_int_00)) Hg1)). }
  apply (gcd_int_spec a Ha b Hb Hne). assume _ Hgr.
  apply (least_pos_int_lin_comb_ex a Ha b Hb Hne). let c. assume Hc0. apply Hc0. assume Hc12 Hmin. apply Hc12. assume Hlin Hpos.
  claim Hgc: gcd_reln a b c. { exact (least_pos_int_lin_comb_gcd a b c Hlin Hpos Hmin). }
  claim Hc1: c = 1. { exact (eq_trans_i c (gcd_int a b) 1 (gcd_reln_uniq a b c (gcd_int a b) Hgc Hgr) Hg1). }
  apply (int_lin_comb_E4 a b c Hlin). let m. assume Hm. let n. assume Hn. assume Hmn.
  witness m. apply andI.
  + exact Hm.
  + witness n. apply andI.
    * exact Hn.
    * exact (eq_trans_i (a * m + b * n) (m * a + n * b) 1 (f_equal2 (fun u v => u + v) (a * m) (m * a) (b * n) (n * b) (mul_SNo_com a m (int_SNo a Ha) (int_SNo m Hm)) (mul_SNo_com b n (int_SNo b Hb) (int_SNo n Hn))) (eq_trans_i (m * a + n * b) c 1 Hmn Hc1)).
- assume H. apply H. let x. assume Hx0. apply Hx0. assume Hx Hy0. apply Hy0. let y. assume Hy1. apply Hy1. assume Hy Heq.
  claim Hne: ~ (a = 0 /\ b = 0).
  { assume H2. apply H2. assume Ha0 Hb0. apply neq_0_1. exact (eq_trans_i 0 (a * x + b * y) 1 (eq_sym_i (a * x + b * y) 0 (eq_trans_i (a * x + b * y) (0 * x + 0 * y) 0 (f_equal2 (fun u v => u * x + v * y) a 0 b 0 Ha0 Hb0) (eq_trans_i (0 * x + 0 * y) (0 + 0) 0 (f_equal2 (fun u v => u + v) (0 * x) 0 (0 * y) 0 (mul_SNo_zeroL x (int_SNo x Hx)) (mul_SNo_zeroL y (int_SNo y Hy))) (add_SNo_0L 0 SNo_0)))) Heq). }
  apply (gcd_int_spec a Ha b Hb Hne). assume H12 Hgr. apply H12. assume HdI Hnn. apply Hgr. assume Hg12 Hmax. apply Hg12. assume Hda Hdb.
  claim Hd1: divides_int (gcd_int a b) 1. { exact ((Heq) (fun hl__u hl__v => divides_int (gcd_int a b) hl__u) (divides_int_add_SNo (gcd_int a b) (a * x) (b * y) (divides_int_mul_SNo_L (gcd_int a b) a x Hx Hda) (divides_int_mul_SNo_L (gcd_int a b) b y Hy Hdb))). }
  claim Hle1: gcd_int a b <= 1. { exact (divides_int_pos_Le (gcd_int a b) 1 Hd1 H01). }
  claim Hge1: 1 <= gcd_int a b. { exact (Hmax 1 (divides_int_1 a Ha) (divides_int_1 b Hb)). }
  exact (SNoLe_antisym (gcd_int a b) 1 (int_SNo (gcd_int a b) HdI) SNo_1 Hle1 Hge1).
Qed.
...
claim H1: (hl_int_of_num (hl_NUMERAL (hl_BIT1 hl_zero))) = 1. { exact (eq_trans_i (hl_int_of_num (hl_NUMERAL (hl_BIT1 hl_zero))) (hl_int_of_num 1) 1 (f_equal (fun u => hl_int_of_num u) (hl_NUMERAL (hl_BIT1 hl_zero)) 1 hl_one_numeral) (hl_int_of_num_compat 1 (nat_p_omega 1 nat_1))). }
apply (iff_eq1_l (hl_int_coprime p) (if (exists x y :e hl_ty_int, hl_int_add (hl_int_mul (hl_FST hl_ty_int hl_ty_int p) x) (hl_int_mul (hl_SND hl_ty_int hl_ty_int p) y) = (hl_int_of_num (hl_NUMERAL (hl_BIT1 hl_zero)))) then 1 else 0) (hl_int_coprime_unfold p Hph) (gcd_int (p 0) (p 1) = 1)).
apply (iff_trans ((if (exists x y :e hl_ty_int, hl_int_add (hl_int_mul (hl_FST hl_ty_int hl_ty_int p) x) (hl_int_mul (hl_SND hl_ty_int hl_ty_int p) y) = (hl_int_of_num (hl_NUMERAL (hl_BIT1 hl_zero)))) then 1 else 0) = 1) (exists x y :e hl_ty_int, hl_int_add (hl_int_mul (hl_FST hl_ty_int hl_ty_int p) x) (hl_int_mul (hl_SND hl_ty_int hl_ty_int p) y) = (hl_int_of_num (hl_NUMERAL (hl_BIT1 hl_zero)))) (gcd_int (p 0) (p 1) = 1) (If_1_iff (exists x y :e hl_ty_int, hl_int_add (hl_int_mul (hl_FST hl_ty_int hl_ty_int p) x) (hl_int_mul (hl_SND hl_ty_int hl_ty_int p) y) = (hl_int_of_num (hl_NUMERAL (hl_BIT1 hl_zero)))))).
apply (iff_trans (exists x y :e hl_ty_int, hl_int_add (hl_int_mul (hl_FST hl_ty_int hl_ty_int p) x) (hl_int_mul (hl_SND hl_ty_int hl_ty_int p) y) = (hl_int_of_num (hl_NUMERAL (hl_BIT1 hl_zero)))) (exists x y :e int, p 0 * x + p 1 * y = 1) (gcd_int (p 0) (p 1) = 1)).
- claim Hpw: forall x y :e int, hl_int_add (hl_int_mul (hl_FST hl_ty_int hl_ty_int p) x) (hl_int_mul (hl_SND hl_ty_int hl_ty_int p) y) = (hl_int_of_num (hl_NUMERAL (hl_BIT1 hl_zero))) <-> p 0 * x + p 1 * y = 1.
  { let x. assume Hx. let y. assume Hy.
    claim Hlhs: hl_int_add (hl_int_mul (hl_FST hl_ty_int hl_ty_int p) x) (hl_int_mul (hl_SND hl_ty_int hl_ty_int p) y) = p 0 * x + p 1 * y.
    { exact (eq_trans_i (hl_int_add (hl_int_mul (hl_FST hl_ty_int hl_ty_int p) x) (hl_int_mul (hl_SND hl_ty_int hl_ty_int p) y)) (hl_int_add (hl_int_mul (p 0) x) (hl_int_mul (p 1) y)) (p 0 * x + p 1 * y) (f_equal2 (fun u v => hl_int_add (hl_int_mul u x) (hl_int_mul v y)) (hl_FST hl_ty_int hl_ty_int p) (p 0) (hl_SND hl_ty_int hl_ty_int p) (p 1) HF HS) (eq_trans_i (hl_int_add (hl_int_mul (p 0) x) (hl_int_mul (p 1) y)) (hl_int_mul (p 0) x + hl_int_mul (p 1) y) (p 0 * x + p 1 * y) (hl_int_add_compat (hl_int_mul (p 0) x) ((eq_sym_i (hl_int_mul (p 0) x) (p 0 * x) (hl_int_mul_compat (p 0) Ha x Hx)) (fun hl__u hl__v => hl__u :e int) (int_mul_SNo (p 0) Ha x Hx)) (hl_int_mul (p 1) y) ((eq_sym_i (hl_int_mul (p 1) y) (p 1 * y) (hl_int_mul_compat (p 1) Hb y Hy)) (fun hl__u hl__v => hl__u :e int) (int_mul_SNo (p 1) Hb y Hy))) (f_equal2 (fun u v => u + v) (hl_int_mul (p 0) x) (p 0 * x) (hl_int_mul (p 1) y) (p 1 * y) (hl_int_mul_compat (p 0) Ha x Hx) (hl_int_mul_compat (p 1) Hb y Hy)))). }
    exact (Hlhs (fun hl__u hl__v => hl__v = (hl_int_of_num (hl_NUMERAL (hl_BIT1 hl_zero))) <-> p 0 * x + p 1 * y = 1) ((eq_sym_i (hl_int_of_num (hl_NUMERAL (hl_BIT1 hl_zero))) 1 H1) (fun hl__u hl__v => p 0 * x + p 1 * y = hl__u <-> p 0 * x + p 1 * y = 1) (iff_refl (p 0 * x + p 1 * y = 1)))). }
  claim Hint: forall x:set, x :e hl_ty_int <-> x :e int. { let x. exact (hl_ty_int_native (fun hl__u hl__v => x :e hl__v <-> x :e int) (iff_refl (x :e int))). }
  apply iffI.
  + assume H. apply H. let x. assume Hx0. apply Hx0. assume Hx Hy0. apply Hy0. let y. assume Hy1. apply Hy1. assume Hy Heq.
    claim Hx': x :e int. { apply (Hint x). assume H3 _. exact (H3 Hx). }
    claim Hy': y :e int. { apply (Hint y). assume H3 _. exact (H3 Hy). }
    witness x. apply andI.
    * exact Hx'.
    * witness y. apply andI.
      - exact Hy'.
      - apply (Hpw x Hx' y Hy'). assume H3 _. exact (H3 Heq).
  + assume H. apply H. let x. assume Hx0. apply Hx0. assume Hx Hy0. apply Hy0. let y. assume Hy1. apply Hy1. assume Hy Heq.
    claim Hx': x :e hl_ty_int. { apply (Hint x). assume _ H3. exact (H3 Hx). }
    claim Hy': y :e hl_ty_int. { apply (Hint y). assume _ H3. exact (H3 Hy). }
    witness x. apply andI.
    * exact Hx'.
    * witness y. apply andI.
      - exact Hy'.
      - apply (Hpw x Hx y Hy). assume _ H3. exact (H3 Heq).
- exact (iff_sym (gcd_int (p 0) (p 1) = 1) (exists x y :e int, p 0 * x + p 1 * y = 1) (gcd_int_eq_1_iff (p 0) Ha (p 1) Hb)).
Qed.
Theorem gcd_int_omega : forall a b :e omega, gcd_int a b :e omega.
let a. assume Ha. let b. assume Hb.
claim Hai: a :e int. { exact (Subq_omega_int a Ha). }
claim Hbi: b :e int. { exact (Subq_omega_int b Hb). }
apply (xm (a = 0 /\ b = 0)).
- assume H. apply H. assume Ha0 Hb0. exact ((eq_sym_i (gcd_int a b) 0 (eq_trans_i (gcd_int a b) (gcd_int 0 0) 0 (f_equal2 (fun u v => gcd_int u v) a 0 b 0 Ha0 Hb0) gcd_int_00)) (fun hl__u hl__v => hl__u :e omega) (nat_p_omega 0 nat_0)).
- assume Hne. apply (gcd_int_spec a Hai b Hbi Hne). assume H12 _. apply H12. assume HdI Hnn. exact (int_nonneg_omega (gcd_int a b) HdI Hnn).
Qed.
...
claim Hgcd: hl_int_gcd (p 0, p 1) = gcd_int (p 0) (p 1). { exact (eq_trans_i (hl_int_gcd (p 0, p 1)) (gcd_int ((p 0, p 1) 0) ((p 0, p 1) 1)) (gcd_int (p 0) (p 1)) (hl_int_gcd_compat (p 0, p 1) Hpab) (f_equal2 (fun u v => gcd_int u v) ((p 0, p 1) 0) (p 0) ((p 0, p 1) 1) (p 1) (tuple_2_0_eq (p 0) (p 1)) (tuple_2_1_eq (p 0) (p 1)))). }
claim Hgo: gcd_int (p 0) (p 1) :e omega. { exact (gcd_int_omega (p 0) Ha (p 1) Hb). }
claim Hgi: gcd_int (p 0) (p 1) :e int. { exact (Subq_omega_int (gcd_int (p 0) (p 1)) Hgo). }
rewrite (hl_num_gcd_unfold p Hp).
exact (eq_trans_i (hl_num_of_int (hl_int_gcd (hl_pair hl_ty_int hl_ty_int (hl_int_of_num (hl_FST omega omega p)) (hl_int_of_num (hl_SND omega omega p))))) (hl_num_of_int (gcd_int (p 0) (p 1))) (gcd_int (p 0) (p 1)) (f_equal (fun u => hl_num_of_int u) (hl_int_gcd (hl_pair hl_ty_int hl_ty_int (hl_int_of_num (hl_FST omega omega p)) (hl_int_of_num (hl_SND omega omega p)))) (gcd_int (p 0) (p 1)) (eq_trans_i (hl_int_gcd (hl_pair hl_ty_int hl_ty_int (hl_int_of_num (hl_FST omega omega p)) (hl_int_of_num (hl_SND omega omega p)))) (hl_int_gcd (p 0, p 1)) (gcd_int (p 0) (p 1)) (f_equal (fun u => hl_int_gcd u) (hl_pair hl_ty_int hl_ty_int (hl_int_of_num (hl_FST omega omega p)) (hl_int_of_num (hl_SND omega omega p))) (p 0, p 1) Hpair) Hgcd)) (eq_trans_i (hl_num_of_int (gcd_int (p 0) (p 1))) (if gcd_int (p 0) (p 1) :e omega then gcd_int (p 0) (p 1) else 0) (gcd_int (p 0) (p 1)) (hl_num_of_int_compat (gcd_int (p 0) (p 1)) Hgi Hgo) (If_i_1 (gcd_int (p 0) (p 1) :e omega) (gcd_int (p 0) (p 1)) 0 Hgo))).
Qed.
...
{ exact (eq_trans_i (hl_pair hl_ty_int hl_ty_int (hl_int_of_num (hl_FST omega omega p)) (hl_int_of_num (hl_SND omega omega p))) (hl_pair hl_ty_int hl_ty_int (p 0) (p 1)) (p 0, p 1) (f_equal2 (fun u v => hl_pair hl_ty_int hl_ty_int u v) (hl_int_of_num (hl_FST omega omega p)) (p 0) (hl_int_of_num (hl_SND omega omega p)) (p 1) (eq_trans_i (hl_int_of_num (hl_FST omega omega p)) (hl_int_of_num (p 0)) (p 0) (f_equal (fun u => hl_int_of_num u) (hl_FST omega omega p) (p 0) HF) (hl_int_of_num_compat (p 0) Ha)) (eq_trans_i (hl_int_of_num (hl_SND omega omega p)) (hl_int_of_num (p 1)) (p 1) (f_equal (fun u => hl_int_of_num u) (hl_SND omega omega p) (p 1) HS) (hl_int_of_num_compat (p 1) Hb))) ((eq_sym_i hl_ty_int int hl_ty_int_native) (fun hl__u hl__v => hl_pair hl__u hl__u (p 0) (p 1) = (p 0, p 1)) (hl_pair_compat int int hl_ty_int_native_nonempty hl_ty_int_native_nonempty (p 0) Hai (p 1) Hbi))). }
claim Hpab: (p 0, p 1) :e int :*: int. { exact (tuple_2_setprod int int (p 0) Hai (p 1) Hbi). }
rewrite (hl_num_coprime_unfold p Hp).
apply (iff_eq1_l (hl_int_coprime (hl_pair hl_ty_int hl_ty_int (hl_int_of_num (hl_FST omega omega p)) (hl_int_of_num (hl_SND omega omega p)))) (hl_int_coprime (p 0, p 1)) (f_equal (fun u => hl_int_coprime u) (hl_pair hl_ty_int hl_ty_int (hl_int_of_num (hl_FST omega omega p)) (hl_int_of_num (hl_SND omega omega p))) (p 0, p 1) Hpair) (gcd_int (p 0) (p 1) = 1)).
...
// ---- an index below the length is in the length ----
Theorem index_of_lt : forall A:set, forall l :e finseq A, forall n :e omega, n < seq_len l -> n :e seq_len l.
let A l. assume Hl. let n. assume Hn Hlt. exact (omega_SNoLt_In (seq_len l) (seq_len_omega A l Hl) n Hn Hlt).
Qed.

// ---- EL: the n-th element, conditional on the index being in range ----
Theorem hl_EL_compat : forall A:set, A <> Empty -> forall l1 :e omega, forall l2 :e finseq A, l1 :e seq_len l2 -> hl_EL A l1 l2 = seq_nth l2 l1.
let A. assume HA.
claim H0o: hl_NUMERAL hl_zero :e omega. { exact ((eq_sym_i (hl_NUMERAL hl_zero) 0 hl_NUMERAL_zero) (fun hl__u hl__v => hl__u :e omega) (nat_p_omega 0 nat_0)). }
claim HG: forall n :e omega, forall l :e finseq A, (fun n :e omega => fun l :e finseq A => hl_HD A (nat_primrec l (fun _ r => hl_TL A r) n)) n l = hl_HD A (nat_primrec l (fun _ r => hl_TL A r) n). { let n. assume Hn. let l. assume Hl. exact (lam2_beta omega (finseq A) (fun n l => hl_HD A (nat_primrec l (fun _ r => hl_TL A r) n)) n Hn l Hl). }
claim HGA: forall n :e omega, forall l :e finseq A, hl_HD A (nat_primrec l (fun _ r => hl_TL A r) n) :e A. { let n. assume Hn. let l. assume Hl. exact (setexp_ap (finseq A) A (hl_HD A) (hl_HD_in A HA) (nat_primrec l (fun _ r => hl_TL A r) n) (tlk_finseq A HA l Hl n (omega_nat_p n Hn))). }
claim Hex: exists g :e A :^: finseq A :^: omega, (forall l :e finseq A, g (hl_NUMERAL hl_zero) l = hl_HD A l) /\ forall n :e omega, forall l :e finseq A, g (hl_SUC n) l = g n (hl_TL A l).
{ witness (fun n :e omega => fun l :e finseq A => hl_HD A (nat_primrec l (fun _ r => hl_TL A r) n)). apply andI.
  - exact (lam2_Pi omega (finseq A) A (fun n l => hl_HD A (nat_primrec l (fun _ r => hl_TL A r) n)) (fun n Hn l Hl => HGA n Hn l Hl)).
  - apply andI.
    + let l. assume Hl.
      exact (eq_trans_i ((fun n :e omega => fun l :e finseq A => hl_HD A (nat_primrec l (fun _ r => hl_TL A r) n)) (hl_NUMERAL hl_zero) l) ((fun n :e omega => fun l :e finseq A => hl_HD A (nat_primrec l (fun _ r => hl_TL A r) n)) 0 l) (hl_HD A l) (f_equal (fun u => (fun n :e omega => fun l :e finseq A => hl_HD A (nat_primrec l (fun _ r => hl_TL A r) n)) u l) (hl_NUMERAL hl_zero) 0 hl_NUMERAL_zero) (eq_trans_i ((fun n :e omega => fun l :e finseq A => hl_HD A (nat_primrec l (fun _ r => hl_TL A r) n)) 0 l) (hl_HD A (nat_primrec l (fun _ r => hl_TL A r) 0)) (hl_HD A l) (HG 0 (nat_p_omega 0 nat_0) l Hl) (f_equal (fun u => hl_HD A u) (nat_primrec l (fun _ r => hl_TL A r) 0) l (nat_primrec_0 l (fun _ r => hl_TL A r))))).
    + let n. assume Hn. let l. assume Hl.
      claim HSn: ordsucc n :e omega. { exact (omega_ordsucc n Hn). }
      claim Htl: hl_TL A l :e finseq A. { exact (setexp_ap (finseq A) (finseq A) (hl_TL A) (hl_TL_in A HA) l Hl). }
      exact (eq_trans_i ((fun n :e omega => fun l :e finseq A => hl_HD A (nat_primrec l (fun _ r => hl_TL A r) n)) (hl_SUC n) l) ((fun n :e omega => fun l :e finseq A => hl_HD A (nat_primrec l (fun _ r => hl_TL A r) n)) (ordsucc n) l) ((fun n :e omega => fun l :e finseq A => hl_HD A (nat_primrec l (fun _ r => hl_TL A r) n)) n (hl_TL A l)) (f_equal (fun u => (fun n :e omega => fun l :e finseq A => hl_HD A (nat_primrec l (fun _ r => hl_TL A r) n)) u l) (hl_SUC n) (ordsucc n) (hl_SUC_compat n Hn)) (eq_trans_i ((fun n :e omega => fun l :e finseq A => hl_HD A (nat_primrec l (fun _ r => hl_TL A r) n)) (ordsucc n) l) (hl_HD A (nat_primrec l (fun _ r => hl_TL A r) (ordsucc n))) ((fun n :e omega => fun l :e finseq A => hl_HD A (nat_primrec l (fun _ r => hl_TL A r) n)) n (hl_TL A l)) (HG (ordsucc n) HSn l Hl) (eq_trans_i (hl_HD A (nat_primrec l (fun _ r => hl_TL A r) (ordsucc n))) (hl_HD A (nat_primrec (hl_TL A l) (fun _ r => hl_TL A r) n)) ((fun n :e omega => fun l :e finseq A => hl_HD A (nat_primrec l (fun _ r => hl_TL A r) n)) n (hl_TL A l)) (f_equal (fun u => hl_HD A u) (nat_primrec l (fun _ r => hl_TL A r) (ordsucc n)) (nat_primrec (hl_TL A l) (fun _ r => hl_TL A r) n) (eq_sym_i (nat_primrec (hl_TL A l) (fun _ r => hl_TL A r) n) (nat_primrec l (fun _ r => hl_TL A r) (ordsucc n)) (tlk_shift A l n (omega_nat_p n Hn)))) (eq_sym_i ((fun n :e omega => fun l :e finseq A => hl_HD A (nat_primrec l (fun _ r => hl_TL A r) n)) n (hl_TL A l)) (hl_HD A (nat_primrec (hl_TL A l) (fun _ r => hl_TL A r) n)) (HG n Hn (hl_TL A l) Htl))))). }
apply (hl_EL_spec A HA Hex). assume H12 Hin. apply H12. assume H0 HS.
claim Hbase: forall l :e finseq A, 0 :e seq_len l -> hl_EL A 0 l = seq_nth l 0.
{ let l. assume Hl H0l.
  claim Hne: ~ l = seq_nil. { assume H. exact (EmptyE 0 (seq_len_nil (fun hl__u hl__v => 0 :e hl__u) ((f_equal (fun u => seq_len u) l seq_nil H) (fun hl__u hl__v => 0 :e hl__u) H0l))). }
  exact (eq_trans_i (hl_EL A 0 l) (hl_EL A (hl_NUMERAL hl_zero) l) (seq_nth l 0) (f_equal (fun u => hl_EL A u l) 0 (hl_NUMERAL hl_zero) (eq_sym_i (hl_NUMERAL hl_zero) 0 hl_NUMERAL_zero)) (eq_trans_i (hl_EL A (hl_NUMERAL hl_zero) l) (hl_HD A l) (seq_nth l 0) (H0 l Hl) (hl_HD_compat A HA l Hl Hne))). }
claim Hstep: forall n, nat_p n -> (forall l :e finseq A, n :e seq_len l -> hl_EL A n l = seq_nth l n) -> (forall l :e finseq A, ordsucc n :e seq_len l -> hl_EL A (ordsucc n) l = seq_nth l (ordsucc n)).
{ let n. assume Hn IH. let l. assume Hl HSl.
  claim Hno: n :e omega. { exact (nat_p_omega n Hn). }
  claim Hne: ~ l = seq_nil. { assume H. exact (EmptyE (ordsucc n) (seq_len_nil (fun hl__u hl__v => ordsucc n :e hl__u) ((f_equal (fun u => seq_len u) l seq_nil H) (fun hl__u hl__v => ordsucc n :e hl__u) HSl))). }
  claim Htl: hl_TL A l = seq_tl l. { exact (hl_TL_compat A HA l Hl Hne). }
  claim Htlf: seq_tl l :e finseq A. { exact (seq_tl_finseq A l Hl). }
  claim Hln: nat_p (seq_len l). { exact (omega_nat_p (seq_len l) (seq_len_omega A l Hl)). }
  claim Hsuccn: nat_pred (ordsucc n) = n. { exact (nat_pred_ordsucc_nat n Hn). }
  claim Hnp: n :e nat_pred (seq_len l). { exact (Hsuccn (fun hl__u hl__v => hl__u :e nat_pred (seq_len l)) (nat_pred_in (nat_pred (seq_len l)) (nat_p_trans (seq_len l) Hln (nat_pred (seq_len l)) ((eq_sym_i (seq_len l) (ordsucc (nat_pred (seq_len l))) (seq_len_ordsucc_pred A l Hl Hne)) (fun hl__u hl__v => nat_pred (seq_len l) :e hl__u) (ordsuccI2 (nat_pred (seq_len l))))) (ordsucc n) ((seq_len_ordsucc_pred A l Hl Hne) (fun hl__u hl__v => ordsucc n :e hl__u) HSl) (neq_ordsucc_0 n))). }
  claim Hntl: n :e seq_len (seq_tl l). { exact ((eq_sym_i (seq_len (seq_tl l)) (nat_pred (seq_len l)) (seq_len_tl l)) (fun hl__u hl__v => n :e hl__u) Hnp). }
...
let A. assume HA. let l1. assume Hl1. let f1. assume Hf1. let l2. assume Hl2. let l3. assume Hl3.
claim H2: l1 l2 :e omega. { exact (setexp_ap A omega l1 Hl1 l2 Hl2). }
claim H3: l1 l3 :e omega. { exact (setexp_ap A omega l1 Hl1 l3 Hl3). }
rewrite (hl_MEASURE_unfold A l1 Hl1 l2 Hl2 l3 Hl3).
rewrite <- (Hf1 l2 Hl2). rewrite <- (Hf1 l3 Hl3).
exact (hl_lt_compat (l1 l2) H2 (l1 l3) H3).
Qed.
...
let A. assume HA. let l1. assume Hl1.
claim Hc: hl_CHOICE A l1 :e A. { exact (setexp_ap (2 :^: A) A (hl_CHOICE A) (hl_CHOICE_in A HA) l1 Hl1). }
exact (eq_trans_i (hl_rep A (hl_REST A l1)) (hl_rep A l1 :\: {hl_CHOICE A l1}) (hl_rep A l1 :\: {choose_in A (fun x:set => x :e hl_rep A l1)})
  (eq_trans_i (hl_rep A (hl_REST A l1)) (hl_rep A (hl_DELETE A l1 (hl_CHOICE A l1))) (hl_rep A l1 :\: {hl_CHOICE A l1}) (f_equal (fun u => hl_rep A u) (hl_REST A l1) (hl_DELETE A l1 (hl_CHOICE A l1)) (hl_REST_unfold A l1 Hl1)) (hl_DELETE_compat A HA l1 Hl1 (hl_CHOICE A l1) Hc))
  (f_equal (fun u => hl_rep A l1 :\: {u}) (hl_CHOICE A l1) (choose_in A (fun x:set => x :e hl_rep A l1)) (hl_CHOICE_compat A HA l1 Hl1))).
Qed.
...
rewrite (hl_INJ_unfold A B l1 Hl1 l2 Hl2 l3 Hl3).
claim HP: (if (forall x :e A, hl_IN A x l2 = 1 -> hl_IN B (l1 x) l3 = 1) /\ forall x y :e A, hl_IN A x l2 = 1 /\ (hl_IN A y l2 = 1 /\ l1 x = l1 y) -> x = y then 1 else 0) = 1 <-> (forall x :e A, hl_IN A x l2 = 1 -> hl_IN B (l1 x) l3 = 1) /\ forall x y :e A, hl_IN A x l2 = 1 /\ (hl_IN A y l2 = 1 /\ l1 x = l1 y) -> x = y. { exact (If_1_iff ((forall x :e A, hl_IN A x l2 = 1 -> hl_IN B (l1 x) l3 = 1) /\ forall x y :e A, hl_IN A x l2 = 1 /\ (hl_IN A y l2 = 1 /\ l1 x = l1 y) -> x = y)). }
claim HinA: forall x :e A, hl_IN A x l2 = 1 <-> x :e hl_rep A l2. { let x. assume Hx. exact (hl_IN_compat A HA x Hx l2 Hl2). }
claim HinB: forall x :e A, hl_IN B (l1 x) l3 = 1 <-> l1 x :e hl_rep B l3. { let x. assume Hx. exact (hl_IN_compat B HB (l1 x) (setexp_ap A B l1 Hl1 x Hx) l3 Hl3). }
claim HsA: forall x :e hl_rep A l2, x :e A. { let x. assume Hx. exact (hl_rep_Subq A l2 x Hx). }
apply HP. assume HPf HPb.
apply iffI.
- assume H. apply (HPf H). assume H1 H2.
  prove (forall u :e hl_rep A l2, f1 u :e hl_rep B l3) /\ (forall u v :e hl_rep A l2, f1 u = f1 v -> u = v).
  apply andI.
  + let u. assume Hu. claim HuA: u :e A. { exact (HsA u Hu). }
    claim Hm: hl_IN A u l2 = 1. { apply (HinA u HuA). assume _ Hb. exact (Hb Hu). }
    claim Hn: l1 u :e hl_rep B l3. { apply (HinB u HuA). assume Hf _. exact (Hf (H1 u HuA Hm)). }
    exact ((Hf1 u HuA) (fun hl__u hl__v => hl__u :e hl_rep B l3) Hn).
  + let u. assume Hu. let v. assume Hv. assume Heq. claim HuA: u :e A. { exact (HsA u Hu). } claim HvA: v :e A. { exact (HsA v Hv). }
    claim Hmu: hl_IN A u l2 = 1. { apply (HinA u HuA). assume _ Hb. exact (Hb Hu). }
    claim Hmv: hl_IN A v l2 = 1. { apply (HinA v HvA). assume _ Hb. exact (Hb Hv). }
    claim Hl: l1 u = l1 v. { exact (eq_trans_i (l1 u) (f1 u) (l1 v) (Hf1 u HuA) (eq_trans_i (f1 u) (f1 v) (l1 v) Heq (eq_sym_i (l1 v) (f1 v) (Hf1 v HvA)))). }
    apply (H2 u HuA v HvA). apply andI. exact Hmu. apply andI. exact Hmv. exact Hl.
- assume Hinj. apply Hinj. assume Hi1 Hi2. apply HPb. apply andI.
  + let x. assume HxA Hx.
    claim Hxs: x :e hl_rep A l2. { apply (HinA x HxA). assume Hf _. exact (Hf Hx). }
    claim Hfx: f1 x :e hl_rep B l3. { exact (Hi1 x Hxs). }
    claim Hlx: l1 x :e hl_rep B l3. { exact ((eq_sym_i (l1 x) (f1 x) (Hf1 x HxA)) (fun hl__u hl__v => hl__u :e hl_rep B l3) Hfx). }
    apply (HinB x HxA). assume _ Hb. exact (Hb Hlx).
  + let x. assume HxA. let y. assume HyA. assume H. apply H. assume Hx H'. apply H'. assume Hy Hxy.
    claim Hxs: x :e hl_rep A l2. { apply (HinA x HxA). assume Hf _. exact (Hf Hx). }
    claim Hys: y :e hl_rep A l2. { apply (HinA y HyA). assume Hf _. exact (Hf Hy). }
    claim Hfxy: f1 x = f1 y. { exact (eq_trans_i (f1 x) (l1 x) (f1 y) (eq_sym_i (l1 x) (f1 x) (Hf1 x HxA)) (eq_trans_i (l1 x) (l1 y) (f1 y) Hxy (Hf1 y HyA))). }
    exact (Hi2 x Hxs y Hys Hfxy).
Qed.

// ---- three-argument bounded lambdas; foldr typing; replicate recursion ----
Theorem lam3_Pi : forall A B C D:set, forall F:set -> set -> set -> set, (forall x :e A, forall y :e B, forall z :e C, F x y z :e D) -> (fun x :e A => fun y :e B => fun z :e C => F x y z) :e D :^: C :^: B :^: A.
let A B C D F. assume H.
prove (fun x :e A => fun y :e B => fun z :e C => F x y z) :e Pi_ x :e A, D :^: C :^: B.
apply (lam_Pi A (fun _ => D :^: C :^: B) (fun x => fun y :e B => fun z :e C => F x y z)).
let x. assume Hx. exact (lam2_Pi B C D (fun y z => F x y z) (fun y Hy z Hz => H x Hx y Hy z Hz)).
Qed.
Theorem lam3_beta : forall A B C:set, forall F:set -> set -> set -> set, forall x :e A, forall y :e B, forall z :e C, (fun x :e A => fun y :e B => fun z :e C => F x y z) x y z = F x y z.
let A B C F x. assume Hx. let y. assume Hy. let z. assume Hz.
rewrite (beta A (fun x => fun y :e B => fun z :e C => F x y z) x Hx). exact (lam2_beta B C (fun y z => F x y z) y Hy z Hz).
Qed.
Theorem seq_foldr_in : forall A B:set, forall f:set -> set -> set, (forall x :e A, forall y :e B, f x y :e B) -> forall l :e finseq A, forall b :e B, seq_foldr f l b :e B.
let A B f. assume Hf.
claim Hbase: forall b :e B, seq_foldr f seq_nil b :e B. { let b. assume Hb. exact ((eq_sym_i (seq_foldr f seq_nil b) b (seq_foldr_nil f b)) (fun hl__u hl__v => hl__u :e B) Hb). }
claim Hstep: forall a :e A, forall l :e finseq A, (forall b :e B, seq_foldr f l b :e B) -> forall b :e B, seq_foldr f (seq_cons a l) b :e B.
{ let a. assume Ha. let l. assume Hl IH. let b. assume Hb. exact ((eq_sym_i (seq_foldr f (seq_cons a l) b) (f a (seq_foldr f l b)) (seq_foldr_cons A f a Ha l Hl b)) (fun hl__u hl__v => hl__u :e B) (Hf a Ha (seq_foldr f l b) (IH b Hb))). }
exact (seq_induct A (fun l => forall b :e B, seq_foldr f l b :e B) Hbase Hstep).
Qed.
Theorem seq_replicate_0 : forall a:set, seq_replicate 0 a = seq_nil.
let a. exact (seq_mk_0 (fun _ => a)).
Qed.
Theorem seq_replicate_S : forall A:set, forall n :e omega, forall a :e A, seq_replicate (ordsucc n) a = seq_cons a (seq_replicate n a).
let A n. assume Hn. let a. assume Ha.
claim Hnn: nat_p n. { exact (omega_nat_p n Hn). }
claim Hr: seq_replicate n a :e finseq A. { exact (seq_replicate_finseq A n Hn a Ha). }
claim HrS: seq_replicate (ordsucc n) a :e finseq A. { exact (seq_replicate_finseq A (ordsucc n) (omega_ordsucc n Hn) a Ha). }
claim Hc: seq_cons a (seq_replicate n a) :e finseq A. { exact (seq_cons_finseq A a Ha (seq_replicate n a) Hr). }
claim Hlen: seq_len (seq_replicate n a) = n. { exact (seq_len_mk n (fun _ => a)). }
claim HlenS: seq_len (seq_replicate (ordsucc n) a) = ordsucc n. { exact (seq_len_mk (ordsucc n) (fun _ => a)). }
claim Hlc: seq_len (seq_cons a (seq_replicate n a)) = ordsucc n. { exact (eq_trans_i (seq_len (seq_cons a (seq_replicate n a))) (ordsucc (seq_len (seq_replicate n a))) (ordsucc n) (seq_len_cons A a Ha (seq_replicate n a) Hr) (f_equal (fun u => ordsucc u) (seq_len (seq_replicate n a)) n Hlen)). }
apply (seq_ext A (seq_replicate (ordsucc n) a) HrS (seq_cons a (seq_replicate n a)) Hc).
- exact (eq_trans_i (seq_len (seq_replicate (ordsucc n) a)) (ordsucc n) (seq_len (seq_cons a (seq_replicate n a))) HlenS (eq_sym_i (seq_len (seq_cons a (seq_replicate n a))) (ordsucc n) Hlc)).
- let i. assume Hi.
  claim Hi': i :e ordsucc n. { exact (HlenS (fun hl__u hl__v => i :e hl__u) Hi). }
  claim Hl: seq_nth (seq_replicate (ordsucc n) a) i = a. { exact (seq_nth_mk (ordsucc n) (fun _ => a) i Hi'). }
  claim Hni: nat_p i. { exact (nat_p_trans (ordsucc n) (nat_ordsucc n Hnn) i Hi'). }
  apply (nat_inv i Hni).
  + assume H0. 
    claim Hr0: seq_nth (seq_cons a (seq_replicate n a)) i = a. { exact ((eq_sym_i i 0 H0) (fun hl__u hl__v => seq_nth (seq_cons a (seq_replicate n a)) hl__u = a) (seq_nth_cons_0 A a Ha (seq_replicate n a) Hr)). }
    exact (eq_trans_i (seq_nth (seq_replicate (ordsucc n) a) i) a (seq_nth (seq_cons a (seq_replicate n a)) i) Hl (eq_sym_i (seq_nth (seq_cons a (seq_replicate n a)) i) a Hr0)).
  + assume H. apply H. let m. assume Hm0. apply Hm0. assume Hm Him.
    claim Hmn: m :e n.
    { claim HSm: ordsucc m :e ordsucc n. { exact (Him (fun hl__u hl__v => hl__u :e ordsucc n) Hi'). }
      apply (ordsuccE n (ordsucc m) HSm).
      - assume H1. exact (nat_trans n Hnn (ordsucc m) H1 m (ordsuccI2 m)).
      - assume H1. exact (H1 (fun hl__u hl__v => m :e hl__u) (ordsuccI2 m)). }
    claim Hml: m :e seq_len (seq_replicate n a). { exact ((eq_sym_i (seq_len (seq_replicate n a)) n Hlen) (fun hl__u hl__v => m :e hl__u) Hmn). }
    claim HrS': seq_nth (seq_cons a (seq_replicate n a)) i = a.
    { exact (eq_trans_i (seq_nth (seq_cons a (seq_replicate n a)) i) (seq_nth (seq_replicate n a) m) a
        ((eq_sym_i i (ordsucc m) Him) (fun hl__u hl__v => seq_nth (seq_cons a (seq_replicate n a)) hl__u = seq_nth (seq_replicate n a) m) (seq_nth_cons_S A a Ha (seq_replicate n a) Hr m Hml))
        (seq_nth_mk n (fun _ => a) m Hmn)). }
    exact (eq_trans_i (seq_nth (seq_replicate (ordsucc n) a) i) a (seq_nth (seq_cons a (seq_replicate n a)) i) Hl (eq_sym_i (seq_nth (seq_cons a (seq_replicate n a)) i) a HrS')).
Qed.
...
let A B. assume HA HB.
claim HnilA: hl_NIL A = seq_nil. { exact (hl_NIL_compat A HA). }
claim Hfin: forall f :e B :^: B :^: A, forall l :e finseq A, forall b :e B, seq_foldr (fun x y => f x y) l b :e B. { let f. assume Hf. exact (seq_foldr_in A B (fun x y => f x y) (fun x Hx y Hy => setexp2_ap A B B f Hf x Hx y Hy)). }
claim Hex: exists g :e B :^: B :^: finseq A :^: (B :^: B :^: A), (forall f :e B :^: B :^: A, forall b :e B, g f (hl_NIL A) b = b) /\ forall h :e A, forall f :e B :^: B :^: A, forall t :e finseq A, forall b :e B, g f (hl_CONS A h t) b = f h (g f t b).
{ witness (fun f :e B :^: B :^: A => fun l :e finseq A => fun b :e B => seq_foldr (fun x y => f x y) l b). apply andI.
  - exact (lam3_Pi (B :^: B :^: A) (finseq A) B B (fun f l b => seq_foldr (fun x y => f x y) l b) (fun f Hf l Hl b Hb => Hfin f Hf l Hl b Hb)).
  - apply andI.
    + let f. assume Hf. let b. assume Hb.
      rewrite HnilA.
      rewrite (lam3_beta (B :^: B :^: A) (finseq A) B (fun f l b => seq_foldr (fun x y => f x y) l b) f Hf seq_nil (seq_nil_finseq A) b Hb).
      exact (seq_foldr_nil (fun x y => f x y) b).
    + let h. assume Hh. let f. assume Hf. let t. assume Ht. let b. assume Hb.
      claim Hct: hl_CONS A h t = seq_cons h t. { exact (hl_CONS_compat A HA h Hh t Ht). }
      claim Hcf: seq_cons h t :e finseq A. { exact (seq_cons_finseq A h Hh t Ht). }
      rewrite Hct.
      rewrite (lam3_beta (B :^: B :^: A) (finseq A) B (fun f l b => seq_foldr (fun x y => f x y) l b) f Hf (seq_cons h t) Hcf b Hb).
      rewrite (lam3_beta (B :^: B :^: A) (finseq A) B (fun f l b => seq_foldr (fun x y => f x y) l b) f Hf t Ht b Hb).
      exact (seq_foldr_cons A (fun x y => f x y) h Hh t Ht b). }
apply (hl_ITLIST_spec A HA B HB Hex). assume H12 Hin. apply H12. assume Hnil Hcons.
let f. assume Hf. let f1. assume Hf1.
claim Hfold: forall t :e finseq A, forall b :e B, seq_foldr f1 t b :e B. { exact (seq_foldr_in A B f1 (fun x Hx y Hy => (Hf1 x Hx y Hy) (fun hl__u hl__v => hl__u :e B) (setexp2_ap A B B f Hf x Hx y Hy))). }
claim Hbase: forall b :e B, hl_ITLIST A B f seq_nil b = seq_foldr f1 seq_nil b.
{ let b. assume Hb. exact (eq_trans_i (hl_ITLIST A B f seq_nil b) b (seq_foldr f1 seq_nil b) (HnilA (fun hl__u hl__v => hl_ITLIST A B f hl__u b = b) (Hnil f Hf b Hb)) (eq_sym_i (seq_foldr f1 seq_nil b) b (seq_foldr_nil f1 b))). }
claim Hstep: forall h :e A, forall t :e finseq A, (forall b :e B, hl_ITLIST A B f t b = seq_foldr f1 t b) -> forall b :e B, hl_ITLIST A B f (seq_cons h t) b = seq_foldr f1 (seq_cons h t) b.
{ let h. assume Hh. let t. assume Ht IH. let b. assume Hb.
  claim Hct: hl_CONS A h t = seq_cons h t. { exact (hl_CONS_compat A HA h Hh t Ht). }
  claim Hc: hl_ITLIST A B f (seq_cons h t) b = f h (hl_ITLIST A B f t b). { exact (Hct (fun hl__u hl__v => hl_ITLIST A B f hl__u b = f h (hl_ITLIST A B f t b)) (Hcons h Hh f Hf t Ht b Hb)). }
  exact (eq_trans_i (hl_ITLIST A B f (seq_cons h t) b) (f h (hl_ITLIST A B f t b)) (seq_foldr f1 (seq_cons h t) b) Hc
    (eq_trans_i (f h (hl_ITLIST A B f t b)) (f h (seq_foldr f1 t b)) (seq_foldr f1 (seq_cons h t) b) (f_equal (fun u => f h u) (hl_ITLIST A B f t b) (seq_foldr f1 t b) (IH b Hb))
      (eq_trans_i (f h (seq_foldr f1 t b)) (f1 h (seq_foldr f1 t b)) (seq_foldr f1 (seq_cons h t) b) (Hf1 h Hh (seq_foldr f1 t b) (Hfold t Ht b Hb)) (eq_sym_i (seq_foldr f1 (seq_cons h t) b) (f1 h (seq_foldr f1 t b)) (seq_foldr_cons A f1 h Hh t Ht b))))). }
exact (seq_induct A (fun l => forall b :e B, hl_ITLIST A B f l b = seq_foldr f1 l b) Hbase Hstep).
Qed.
...
let A. assume HA.
claim HnilA: hl_NIL A = seq_nil. { exact (hl_NIL_compat A HA). }
claim Hex: exists g :e finseq A :^: A :^: omega, (forall x :e A, g (hl_NUMERAL hl_zero) x = hl_NIL A) /\ forall n :e omega, forall x :e A, g (hl_SUC n) x = hl_CONS A x (g n x).
{ witness (fun n :e omega => fun x :e A => seq_replicate n x). apply andI.
  - exact (lam2_Pi omega A (finseq A) (fun n x => seq_replicate n x) (fun n Hn x Hx => seq_replicate_finseq A n Hn x Hx)).
  - apply andI.
    + let x. assume Hx.
      claim H0: (fun n :e omega => fun x :e A => seq_replicate n x) 0 x = seq_nil. { exact (eq_trans_i ((fun n :e omega => fun x :e A => seq_replicate n x) 0 x) (seq_replicate 0 x) seq_nil (lam2_beta omega A (fun n x => seq_replicate n x) 0 (nat_p_omega 0 nat_0) x Hx) (seq_replicate_0 x)). }
      exact (eq_trans_i ((fun n :e omega => fun x :e A => seq_replicate n x) (hl_NUMERAL hl_zero) x) seq_nil (hl_NIL A) ((eq_sym_i (hl_NUMERAL hl_zero) 0 hl_NUMERAL_zero) (fun hl__u hl__v => (fun n :e omega => fun x :e A => seq_replicate n x) hl__u x = seq_nil) H0) (eq_sym_i (hl_NIL A) seq_nil HnilA)).
    + let n. assume Hn. let x. assume Hx.
      claim HSn: ordsucc n :e omega. { exact (omega_ordsucc n Hn). }
      claim H1: (fun n :e omega => fun x :e A => seq_replicate n x) (ordsucc n) x = seq_replicate (ordsucc n) x. { exact (lam2_beta omega A (fun n x => seq_replicate n x) (ordsucc n) HSn x Hx). }
      claim H2: (fun n :e omega => fun x :e A => seq_replicate n x) n x = seq_replicate n x. { exact (lam2_beta omega A (fun n x => seq_replicate n x) n Hn x Hx). }
      claim H3: hl_CONS A x ((fun n :e omega => fun x :e A => seq_replicate n x) n x) = seq_cons x (seq_replicate n x). { exact (eq_trans_i (hl_CONS A x ((fun n :e omega => fun x :e A => seq_replicate n x) n x)) (hl_CONS A x (seq_replicate n x)) (seq_cons x (seq_replicate n x)) (f_equal (fun u => hl_CONS A x u) ((fun n :e omega => fun x :e A => seq_replicate n x) n x) (seq_replicate n x) H2) (hl_CONS_compat A HA x Hx (seq_replicate n x) (seq_replicate_finseq A n Hn x Hx))). }
      claim H4: (fun n :e omega => fun x :e A => seq_replicate n x) (ordsucc n) x = hl_CONS A x ((fun n :e omega => fun x :e A => seq_replicate n x) n x). { exact (eq_trans_i ((fun n :e omega => fun x :e A => seq_replicate n x) (ordsucc n) x) (seq_replicate (ordsucc n) x) (hl_CONS A x ((fun n :e omega => fun x :e A => seq_replicate n x) n x)) H1 (eq_trans_i (seq_replicate (ordsucc n) x) (seq_cons x (seq_replicate n x)) (hl_CONS A x ((fun n :e omega => fun x :e A => seq_replicate n x) n x)) (seq_replicate_S A n Hn x Hx) (eq_sym_i (hl_CONS A x ((fun n :e omega => fun x :e A => seq_replicate n x) n x)) (seq_cons x (seq_replicate n x)) H3))). }
      exact ((eq_sym_i (hl_SUC n) (ordsucc n) (hl_SUC_compat n Hn)) (fun hl__u hl__v => (fun n :e omega => fun x :e A => seq_replicate n x) hl__u x = hl_CONS A x ((fun n :e omega => fun x :e A => seq_replicate n x) n x)) H4). }
apply (hl_REPLICATE_spec A HA Hex). assume H12 Hin. apply H12. assume Hz Hs.
let n. assume Hn.
claim Hbase: forall x :e A, hl_REPLICATE A 0 x = seq_replicate 0 x.
{ let x. assume Hx. exact (eq_trans_i (hl_REPLICATE A 0 x) (hl_NIL A) (seq_replicate 0 x) (hl_NUMERAL_zero (fun hl__u hl__v => hl_REPLICATE A hl__u x = hl_NIL A) (Hz x Hx)) (eq_trans_i (hl_NIL A) seq_nil (seq_replicate 0 x) HnilA (eq_sym_i (seq_replicate 0 x) seq_nil (seq_replicate_0 x)))). }
claim Hstep: forall m, nat_p m -> (forall x :e A, hl_REPLICATE A m x = seq_replicate m x) -> forall x :e A, hl_REPLICATE A (ordsucc m) x = seq_replicate (ordsucc m) x.
{ let m. assume Hm IH. let x. assume Hx.
  claim Hmo: m :e omega. { exact (nat_p_omega m Hm). }
  claim H1: hl_REPLICATE A (ordsucc m) x = hl_CONS A x (hl_REPLICATE A m x). { exact ((hl_SUC_compat m Hmo) (fun hl__u hl__v => hl_REPLICATE A hl__u x = hl_CONS A x (hl_REPLICATE A m x)) (Hs m Hmo x Hx)). }
  exact (eq_trans_i (hl_REPLICATE A (ordsucc m) x) (hl_CONS A x (hl_REPLICATE A m x)) (seq_replicate (ordsucc m) x) H1
    (eq_trans_i (hl_CONS A x (hl_REPLICATE A m x)) (hl_CONS A x (seq_replicate m x)) (seq_replicate (ordsucc m) x) (f_equal (fun u => hl_CONS A x u) (hl_REPLICATE A m x) (seq_replicate m x) (IH x Hx))
      (eq_trans_i (hl_CONS A x (seq_replicate m x)) (seq_cons x (seq_replicate m x)) (seq_replicate (ordsucc m) x) (hl_CONS_compat A HA x Hx (seq_replicate m x) (seq_replicate_finseq A m Hmo x Hx)) (eq_sym_i (seq_replicate (ordsucc m) x) (seq_cons x (seq_replicate m x)) (seq_replicate_S A m Hmo x Hx))))). }
exact (nat_ind (fun n => forall x :e A, hl_REPLICATE A n x = seq_replicate n x) Hbase Hstep n (omega_nat_p n Hn)).
Qed.

// ---- compat: BIJ (via the literal SURJ characterization) ----
Theorem hl_SURJ_char : forall A B:set, A <> Empty -> B <> Empty -> forall l1 :e B :^: A, forall l2 :e 2 :^: A, forall l3 :e 2 :^: B, hl_SURJ A B l1 l2 l3 = 1 <-> (forall x :e A, hl_IN A x l2 = 1 -> hl_IN B (l1 x) l3 = 1) /\ forall x :e B, hl_IN B x l3 = 1 -> exists y :e A, hl_IN A y l2 = 1 /\ l1 y = x.
let A B. assume HA HB. let l1. assume Hl1. let l2. assume Hl2. let l3. assume Hl3.
rewrite (hl_SURJ_unfold A B l1 Hl1 l2 Hl2 l3 Hl3).
exact (If_1_iff ((forall x :e A, hl_IN A x l2 = 1 -> hl_IN B (l1 x) l3 = 1) /\ forall x :e B, hl_IN B x l3 = 1 -> exists y :e A, hl_IN A y l2 = 1 /\ l1 y = x)).
Qed.
...
let A B. assume HA HB. let l1. assume Hl1. let f1. assume Hf1. let l2. assume Hl2. let l3. assume Hl3.
rewrite (hl_BIJ_unfold A B l1 Hl1 l2 Hl2 l3 Hl3).
claim HP: (if hl_INJ A B l1 l2 l3 = 1 /\ hl_SURJ A B l1 l2 l3 = 1 then 1 else 0) = 1 <-> hl_INJ A B l1 l2 l3 = 1 /\ hl_SURJ A B l1 l2 l3 = 1. { exact (If_1_iff (hl_INJ A B l1 l2 l3 = 1 /\ hl_SURJ A B l1 l2 l3 = 1)). }
claim Hinj: hl_INJ A B l1 l2 l3 = 1 <-> inj (hl_rep A l2) (hl_rep B l3) f1. { exact (hl_INJ_compat A B HA HB l1 Hl1 f1 Hf1 l2 Hl2 l3 Hl3). }
...
apply HP. assume HPf HPb.
apply iffI.
- assume H. apply (HPf H). assume Hi Hs.
  claim Hi': inj (hl_rep A l2) (hl_rep B l3) f1. { apply Hinj. assume Hf _. exact (Hf Hi). }
  claim Hs': (forall x :e A, hl_IN A x l2 = 1 -> hl_IN B (l1 x) l3 = 1) /\ forall x :e B, hl_IN B x l3 = 1 -> exists y :e A, hl_IN A y l2 = 1 /\ l1 y = x. { apply Hsurj. assume Hf _. exact (Hf Hs). }
  prove ((forall u :e hl_rep A l2, f1 u :e hl_rep B l3) /\ (forall u v :e hl_rep A l2, f1 u = f1 v -> u = v)) /\ (forall w :e hl_rep B l3, exists u :e hl_rep A l2, f1 u = w).
  apply andI.
  + exact Hi'.
  + let w. assume Hw. claim HwB: w :e B. { exact (HsB w Hw). }
    claim Hw1: hl_IN B w l3 = 1. { apply (HinB w HwB). assume _ Hb. exact (Hb Hw). }
    apply Hs'. assume _ S2. apply (S2 w HwB Hw1). let y. assume Hy0. apply Hy0. assume HyA Hy1. apply Hy1. assume Hy2 Hy3.
    witness y. apply andI.
    * apply (HinA y HyA). assume Hf _. exact (Hf Hy2).
    * exact (eq_trans_i (f1 y) (l1 y) w (eq_sym_i (l1 y) (f1 y) (Hf1 y HyA)) Hy3).
- assume Hb. apply Hb. assume Hb12 Hb3. apply Hb12. assume Hb1 Hb2. apply HPb. apply andI.
  + apply Hinj. assume _ Hib. apply Hib. prove (forall u :e hl_rep A l2, f1 u :e hl_rep B l3) /\ (forall u v :e hl_rep A l2, f1 u = f1 v -> u = v). apply andI. exact Hb1. exact Hb2.
  + apply Hsurj. assume _ Hsb. apply Hsb. apply andI.
    * let x. assume HxA Hx.
      claim Hxs: x :e hl_rep A l2. { apply (HinA x HxA). assume Hf _. exact (Hf Hx). }
...
// ---- compat: >=_c and COUNTABLE (from <=_c) ----
...
let A B. assume HA HB. let l1. assume Hl1. let l2. assume Hl2.
rewrite (hl_sym_3e3d5f63_unfold A B l1 Hl1 l2 Hl2).
exact (hl_sym_3c3d5f63_compat B A HB HA l2 Hl2 l1 Hl1).
Qed.
Theorem hl_COUNTABLE_compat : forall A:set, A <> Empty -> forall l1 :e 2 :^: A, hl_COUNTABLE A l1 = 1 <-> countable (hl_rep A l1).
let A. assume HA. let l1. assume Hl1.
rewrite (hl_COUNTABLE_unfold A l1 Hl1).
claim HU: hl_UNIV omega :e 2 :^: omega. { exact (hl_UNIV_in omega omega_nonempty). }
claim H1: hl_sym_3e3d5f63 omega A (hl_UNIV omega) l1 = 1 <-> atleastp (hl_rep A l1) (hl_rep omega (hl_UNIV omega)). { exact (hl_sym_3e3d5f63_compat omega A omega_nonempty HA (hl_UNIV omega) HU l1 Hl1). }
prove hl_sym_3e3d5f63 omega A (hl_UNIV omega) l1 = 1 <-> atleastp (hl_rep A l1) omega.
exact ((hl_UNIV_compat omega omega_nonempty) (fun hl__u hl__v => hl_sym_3e3d5f63 omega A (hl_UNIV omega) l1 = 1 <-> atleastp (hl_rep A l1) hl__u) H1).
Qed.

// ---- compat: <_c (Schroeder-Bernstein) ----
...
let A B. assume HA HB. let l1. assume Hl1. let l2. assume Hl2.
rewrite (hl_sym_3c5f63_unfold A B l1 Hl1 l2 Hl2).
claim HP: (if hl_sym_3c3d5f63 A B l1 l2 = 1 /\ ~ hl_sym_3c3d5f63 B A l2 l1 = 1 then 1 else 0) = 1 <-> hl_sym_3c3d5f63 A B l1 l2 = 1 /\ ~ hl_sym_3c3d5f63 B A l2 l1 = 1. { exact (If_1_iff (hl_sym_3c3d5f63 A B l1 l2 = 1 /\ ~ hl_sym_3c3d5f63 B A l2 l1 = 1)). }
claim H1: hl_sym_3c3d5f63 A B l1 l2 = 1 <-> atleastp (hl_rep A l1) (hl_rep B l2). { exact (hl_sym_3c3d5f63_compat A B HA HB l1 Hl1 l2 Hl2). }
claim H2: hl_sym_3c3d5f63 B A l2 l1 = 1 <-> atleastp (hl_rep B l2) (hl_rep A l1). { exact (hl_sym_3c3d5f63_compat B A HB HA l2 Hl2 l1 Hl1). }
apply HP. assume HPf HPb.
apply iffI.
- assume H. apply (HPf H). assume Ha Hn. apply andI.
  + apply H1. assume Hf _. exact (Hf Ha).
  + assume He. apply Hn. apply H2. assume _ Hb. exact (Hb (equip_atleastp (hl_rep B l2) (hl_rep A l1) (equip_sym (hl_rep A l1) (hl_rep B l2) He))).
- assume H. apply H. assume Ha Hne. apply HPb. apply andI.
  + apply H1. assume _ Hb. exact (Hb Ha).
  + assume Hts. apply Hne.
    claim Hts': atleastp (hl_rep B l2) (hl_rep A l1). { apply H2. assume Hf _. exact (Hf Hts). }
    apply Ha. let f. assume Hf. apply Hts'. let g. assume Hg.
    exact (SchroederBernstein (hl_rep A l1) (hl_rep B l2) f g Hf Hg).
Qed.

// ---- compat: =_c (equipotence) ----
...
let A B. assume HA HB. let l1. assume Hl1. let l2. assume Hl2.
rewrite (hl_sym_3d5f63_unfold A B l1 Hl1 l2 Hl2).
claim HP: (if exists f :e B :^: A, (forall x :e A, hl_IN A x l1 = 1 -> hl_IN B (f x) l2 = 1) /\ forall y :e B, hl_IN B y l2 = 1 -> hl_exists_unique A (fun x :e A => if hl_IN A x l1 = 1 /\ f x = y then 1 else 0) = 1 then 1 else 0) = 1 <-> exists f :e B :^: A, (forall x :e A, hl_IN A x l1 = 1 -> hl_IN B (f x) l2 = 1) /\ forall y :e B, hl_IN B y l2 = 1 -> hl_exists_unique A (fun x :e A => if hl_IN A x l1 = 1 /\ f x = y then 1 else 0) = 1. { exact (If_1_iff (exists f :e B :^: A, (forall x :e A, hl_IN A x l1 = 1 -> hl_IN B (f x) l2 = 1) /\ forall y :e B, hl_IN B y l2 = 1 -> hl_exists_unique A (fun x :e A => if hl_IN A x l1 = 1 /\ f x = y then 1 else 0) = 1)). }
claim HinA: forall x :e A, hl_IN A x l1 = 1 <-> x :e hl_rep A l1. { let x. assume Hx. exact (hl_IN_compat A HA x Hx l1 Hl1). }
claim HinB: forall y :e B, hl_IN B y l2 = 1 <-> y :e hl_rep B l2. { let y. assume Hy. exact (hl_IN_compat B HB y Hy l2 Hl2). }
claim HsA: forall x :e hl_rep A l1, x :e A. { let x. assume Hx. exact (hl_rep_Subq A l1 x Hx). }
claim HsB: forall y :e hl_rep B l2, y :e B. { let y. assume Hy. exact (hl_rep_Subq B l2 y Hy). }
claim HU: forall f:set -> set, forall y:set, hl_exists_unique A (fun x :e A => if hl_IN A x l1 = 1 /\ f x = y then 1 else 0) = 1 <-> exists x :e A, (hl_IN A x l1 = 1 /\ f x = y) /\ forall x' :e A, (hl_IN A x' l1 = 1 /\ f x' = y) -> x' = x.
{ let f y. exact (hl_exists_unique_lit A (fun x => hl_IN A x l1 = 1 /\ f x = y)). }
apply HP. assume HPf HPb.
apply iffI.
- assume H. apply (HPf H). let f. assume Hf0. apply Hf0. assume Hf H12. apply H12. assume H1 H2.
  claim Hmap: forall u :e hl_rep A l1, f u :e hl_rep B l2.
  { let u. assume Hu. claim HuA: u :e A. { exact (HsA u Hu). }
    claim Hm: hl_IN A u l1 = 1. { apply (HinA u HuA). assume _ Hb. exact (Hb Hu). }
    apply (HinB (f u) (setexp_ap A B f Hf u HuA)). assume Hfw _. exact (Hfw (H1 u HuA Hm)). }
  claim Hinj: forall u v :e hl_rep A l1, f u = f v -> u = v.
  { let u. assume Hu. let v. assume Hv. assume Heq. claim HuA: u :e A. { exact (HsA u Hu). } claim HvA: v :e A. { exact (HsA v Hv). }
    claim Hmu: hl_IN A u l1 = 1. { apply (HinA u HuA). assume _ Hb. exact (Hb Hu). }
    claim Hmv: hl_IN A v l1 = 1. { apply (HinA v HvA). assume _ Hb. exact (Hb Hv). }
    claim HfuB: f u :e B. { exact (HsB (f u) (Hmap u Hu)). }
    claim Hm: hl_IN B (f u) l2 = 1. { apply (HinB (f u) HfuB). assume _ Hb. exact (Hb (Hmap u Hu)). }
    apply (HU (fun x => f x) (f u)). assume HUf _. apply (HUf (H2 (f u) HfuB Hm)). let x. assume Hx0. apply Hx0. assume HxA Hx1. apply Hx1. assume _ Huniq.
    claim Hux: u = x. { exact (Huniq u HuA (andI (hl_IN A u l1 = 1) (f u = f u) Hmu (fun q H => H))). }
    claim Hvx: v = x. { exact (Huniq v HvA (andI (hl_IN A v l1 = 1) (f v = f u) Hmv (eq_sym_i (f u) (f v) Heq))). }
    exact (eq_trans_i u x v Hux (eq_sym_i v x Hvx)). }
  claim Hsurj: forall w :e hl_rep B l2, exists u :e hl_rep A l1, f u = w.
  { let w. assume Hw. claim HwB: w :e B. { exact (HsB w Hw). }
    claim Hm: hl_IN B w l2 = 1. { apply (HinB w HwB). assume _ Hb. exact (Hb Hw). }
    apply (HU (fun x => f x) w). assume HUf _. apply (HUf (H2 w HwB Hm)). let x. assume Hx0. apply Hx0. assume HxA Hx1. apply Hx1. assume Hx2 _. apply Hx2. assume Hx3 Hx4.
    claim HxS: x :e hl_rep A l1. { apply (HinA x HxA). assume Hfw _. exact (Hfw Hx3). }
    witness x. exact (andI (x :e hl_rep A l1) (f x = w) HxS Hx4). }
  prove exists h:set -> set, bij (hl_rep A l1) (hl_rep B l2) h. witness (fun x => f x).
  exact (andI ((forall u :e hl_rep A l1, f u :e hl_rep B l2) /\ (forall u v :e hl_rep A l1, f u = f v -> u = v)) (forall w :e hl_rep B l2, exists u :e hl_rep A l1, f u = w) (andI (forall u :e hl_rep A l1, f u :e hl_rep B l2) (forall u v :e hl_rep A l1, f u = f v -> u = v) Hmap Hinj) Hsurj).
- assume He. apply He. let g. assume Hg. apply Hg. assume Hg12 Hg3. apply Hg12. assume Hg1 Hg2. apply HPb.
  claim Hc: choose_in B (fun y:set => True) :e B. { exact (choose_in_in B HB (fun y:set => True)). }
  claim Hty: forall x :e A, (if x :e hl_rep A l1 then g x else choose_in B (fun y:set => True)) :e B.
  { let x. assume Hx. exact ((xm (x :e hl_rep A l1)) ((if x :e hl_rep A l1 then g x else choose_in B (fun y:set => True)) :e B)
      (fun HxS => (eq_sym_i (if x :e hl_rep A l1 then g x else choose_in B (fun y:set => True)) (g x) (If_i_1 (x :e hl_rep A l1) (g x) (choose_in B (fun y:set => True)) HxS)) (fun hl__u hl__v => hl__u :e B) (HsB (g x) (Hg1 x HxS)))
      (fun HxS => (eq_sym_i (if x :e hl_rep A l1 then g x else choose_in B (fun y:set => True)) (choose_in B (fun y:set => True)) (If_i_0 (x :e hl_rep A l1) (g x) (choose_in B (fun y:set => True)) HxS)) (fun hl__u hl__v => hl__u :e B) Hc)). }
  claim HFin: (fun x :e A => if x :e hl_rep A l1 then g x else choose_in B (fun y:set => True)) :e B :^: A. { prove (fun x :e A => if x :e hl_rep A l1 then g x else choose_in B (fun y:set => True)) :e Pi_ x :e A, B. exact (lam_Pi A (fun _ => B) (fun x => (if x :e hl_rep A l1 then g x else choose_in B (fun y:set => True))) Hty). }
  claim HFS: forall x :e hl_rep A l1, (fun x :e A => if x :e hl_rep A l1 then g x else choose_in B (fun y:set => True)) x = g x.
  { let x. assume HxS. claim HxA: x :e A. { exact (HsA x HxS). }
    exact (eq_trans_i ((fun x :e A => if x :e hl_rep A l1 then g x else choose_in B (fun y:set => True)) x) (if x :e hl_rep A l1 then g x else choose_in B (fun y:set => True)) (g x) (beta A (fun x => (if x :e hl_rep A l1 then g x else choose_in B (fun y:set => True))) x HxA) (If_i_1 (x :e hl_rep A l1) (g x) (choose_in B (fun y:set => True)) HxS)). }
  witness (fun x :e A => if x :e hl_rep A l1 then g x else choose_in B (fun y:set => True)). apply andI.
  + exact HFin.
  + apply andI.
    * let x. assume HxA Hm. claim HxS: x :e hl_rep A l1. { apply (HinA x HxA). assume Hfw _. exact (Hfw Hm). }
      claim HgT: g x :e hl_rep B l2. { exact (Hg1 x HxS). }
      claim Hm2: hl_IN B (g x) l2 = 1. { apply (HinB (g x) (HsB (g x) HgT)). assume _ Hb. exact (Hb HgT). }
      exact ((eq_sym_i ((fun x :e A => if x :e hl_rep A l1 then g x else choose_in B (fun y:set => True)) x) (g x) (HFS x HxS)) (fun hl__u hl__v => hl_IN B hl__u l2 = 1) Hm2).
    * let y. assume HyB Hm. claim HyT: y :e hl_rep B l2. { apply (HinB y HyB). assume Hfw _. exact (Hfw Hm). }
      apply (HU (fun x => (fun x :e A => if x :e hl_rep A l1 then g x else choose_in B (fun y:set => True)) x) y). assume _ HUb. apply HUb. apply (Hg3 y HyT). let u. assume Hu0. apply Hu0. assume Hu Hgu.
      claim HuA: u :e A. { exact (HsA u Hu). }
      claim Hmu: hl_IN A u l1 = 1. { apply (HinA u HuA). assume _ Hb. exact (Hb Hu). }
      claim HFu: (fun x :e A => if x :e hl_rep A l1 then g x else choose_in B (fun y:set => True)) u = y. { exact (eq_trans_i ((fun x :e A => if x :e hl_rep A l1 then g x else choose_in B (fun y:set => True)) u) (g u) y (HFS u Hu) Hgu). }
      claim Huniq: forall x' :e A, (hl_IN A x' l1 = 1 /\ (fun x :e A => if x :e hl_rep A l1 then g x else choose_in B (fun y:set => True)) x' = y) -> x' = u.
      { let x'. assume Hx'A Hx'. apply Hx'. assume Hx'm Hx'F.
        claim Hx'S: x' :e hl_rep A l1. { apply (HinA x' Hx'A). assume Hfw _. exact (Hfw Hx'm). }
        claim Hgxu: g x' = g u. { exact (eq_trans_i (g x') ((fun x :e A => if x :e hl_rep A l1 then g x else choose_in B (fun y:set => True)) x') (g u) (eq_sym_i ((fun x :e A => if x :e hl_rep A l1 then g x else choose_in B (fun y:set => True)) x') (g x') (HFS x' Hx'S)) (eq_trans_i ((fun x :e A => if x :e hl_rep A l1 then g x else choose_in B (fun y:set => True)) x') y (g u) Hx'F (eq_sym_i (g u) y Hgu))). }
...
Qed.
Theorem pw_tr_fun2 : forall D1 D2 F G:set, forall N:set -> set -> set, F = G -> (forall x :e D1, forall y :e D2, G x y = N x y) -> forall x :e D1, forall y :e D2, F x y = N x y.
let D1 D2 F G N. assume Heq H. let x. assume Hx. let y. assume Hy. exact (eq_trans_i (F x y) (G x y) (N x y) (f_equal (fun u => u x y) F G Heq) (H x Hx y Hy)).
Qed.
Theorem pw_tr_pred2 : forall D1 D2 F G:set, forall N:set -> set -> prop, F = G -> (forall x :e D1, forall y :e D2, G x y = 1 <-> N x y) -> forall x :e D1, forall y :e D2, F x y = 1 <-> N x y.
let D1 D2 F G N. assume Heq H. let x. assume Hx. let y. assume Hy. exact (iff_eq1_l (F x y) (G x y) (f_equal (fun u => u x y) F G Heq) (N x y) (H x Hx y Hy)).
Qed.
Theorem f_equal3 : forall f:set -> set -> set -> set, forall a a' b b' c c':set, a = a' -> b = b' -> c = c' -> f a b c = f a' b' c'.
let f a a' b b' c c'. assume H1 H2 H3.
exact (eq_trans_i (f a b c) (f a' b c) (f a' b' c') (f_equal (fun u => f u b c) a a' H1) (f_equal2 (fun u v => f a' u v) b b' c c' H2 H3)).
Qed.
Theorem gabs_triple_eq : forall A B C D:set, A <> Empty -> B <> Empty -> C <> Empty -> forall T:set -> set -> set -> set, (forall x :e A, forall y :e B, forall z :e C, T x y z :e D) -> hl_GABS (D :^: (A :*: (B :*: C))) (fun f :e (D :^: (A :*: (B :*: C))) => if forall x :e A, forall y :e B, forall z :e C, hl_GEQ D (f (hl_pair A (B :*: C) x (hl_pair B C y z))) (T x y z) = 1 then 1 else 0) = (fun p :e A :*: (B :*: C) => T (hl_FST A (B :*: C) p) (hl_FST B C (hl_SND A (B :*: C) p)) (hl_SND B C (hl_SND A (B :*: C) p))).
let A B C D. assume HA HB HC. let T. assume HT.
claim HF1: forall p :e A :*: (B :*: C), hl_FST A (B :*: C) p :e A.
{ let p. assume Hp. exact ((eq_sym_i (hl_FST A (B :*: C) p) (p 0) (hl_FST_compat A (B :*: C) HA (nonempty_of_In (B :*: C) (p 1) (ap1_Sigma A (fun _ => (B :*: C)) p Hp)) p Hp)) (fun u v => u :e A) (ap0_Sigma A (fun _ => (B :*: C)) p Hp)). }
claim HS1: forall p :e A :*: (B :*: C), hl_SND A (B :*: C) p :e (B :*: C).
{ let p. assume Hp. exact ((eq_sym_i (hl_SND A (B :*: C) p) (p 1) (hl_SND_compat A (B :*: C) HA (nonempty_of_In (B :*: C) (p 1) (ap1_Sigma A (fun _ => (B :*: C)) p Hp)) p Hp)) (fun u v => u :e (B :*: C)) (ap1_Sigma A (fun _ => (B :*: C)) p Hp)). }
claim HF2: forall r :e (B :*: C), hl_FST B C r :e B.
{ let r. assume Hr. exact ((eq_sym_i (hl_FST B C r) (r 0) (hl_FST_compat B C HB HC r Hr)) (fun u v => u :e B) (ap0_Sigma B (fun _ => C) r Hr)). }
claim HS2: forall r :e (B :*: C), hl_SND B C r :e C.
{ let r. assume Hr. exact ((eq_sym_i (hl_SND B C r) (r 1) (hl_SND_compat B C HB HC r Hr)) (fun u v => u :e C) (ap1_Sigma B (fun _ => C) r Hr)). }
claim Hg: (fun p :e A :*: (B :*: C) => T (hl_FST A (B :*: C) p) (hl_FST B C (hl_SND A (B :*: C) p)) (hl_SND B C (hl_SND A (B :*: C) p))) :e (D :^: (A :*: (B :*: C))).
{ exact (lam_Pi (A :*: (B :*: C)) (fun _ => D) (fun p => T (hl_FST A (B :*: C) p) (hl_FST B C (hl_SND A (B :*: C) p)) (hl_SND B C (hl_SND A (B :*: C) p))) (fun p Hp => HT (hl_FST A (B :*: C) p) (HF1 p Hp) (hl_FST B C (hl_SND A (B :*: C) p)) (HF2 (hl_SND A (B :*: C) p) (HS1 p Hp)) (hl_SND B C (hl_SND A (B :*: C) p)) (HS2 (hl_SND A (B :*: C) p) (HS1 p Hp)))). }
claim HP: (fun f :e (D :^: (A :*: (B :*: C))) => if forall x :e A, forall y :e B, forall z :e C, hl_GEQ D (f (hl_pair A (B :*: C) x (hl_pair B C y z))) (T x y z) = 1 then 1 else 0) :e 2 :^: (D :^: (A :*: (B :*: C))).
{ exact (lam_Pi (D :^: (A :*: (B :*: C))) (fun _ => 2) (fun f => if forall x :e A, forall y :e B, forall z :e C, hl_GEQ D (f (hl_pair A (B :*: C) x (hl_pair B C y z))) (T x y z) = 1 then 1 else 0) (fun f Hf => (If_i_or (forall x :e A, forall y :e B, forall z :e C, hl_GEQ D (f (hl_pair A (B :*: C) x (hl_pair B C y z))) (T x y z) = 1) 1 0) ((if forall x :e A, forall y :e B, forall z :e C, hl_GEQ D (f (hl_pair A (B :*: C) x (hl_pair B C y z))) (T x y z) = 1 then 1 else 0) :e 2) (fun H1 => (eq_sym_i (if forall x :e A, forall y :e B, forall z :e C, hl_GEQ D (f (hl_pair A (B :*: C) x (hl_pair B C y z))) (T x y z) = 1 then 1 else 0) 1 H1) (fun u v => u :e 2) In_1_2) (fun H0 => (eq_sym_i (if forall x :e A, forall y :e B, forall z :e C, hl_GEQ D (f (hl_pair A (B :*: C) x (hl_pair B C y z))) (T x y z) = 1 then 1 else 0) 0 H0) (fun u v => u :e 2) In_0_2))). }
claim Hpair2: forall y :e B, forall z :e C, hl_pair B C y z :e (B :*: C).
{ let y. assume Hy. let z. assume Hz. rewrite (hl_pair_ap B C y Hy z Hz). exact (tuple_2_setprod B C y Hy z Hz). }
claim Hpair3: forall x :e A, forall y :e B, forall z :e C, (hl_pair A (B :*: C) x (hl_pair B C y z)) :e A :*: (B :*: C).
{ let x. assume Hx. let y. assume Hy. let z. assume Hz. rewrite (hl_pair_ap A (B :*: C) x Hx (hl_pair B C y z) (Hpair2 y Hy z Hz)). exact (tuple_2_setprod A (B :*: C) x Hx (hl_pair B C y z) (Hpair2 y Hy z Hz)). }
claim Hgeq: forall a b :e D, hl_GEQ D a b = 1 -> a = b.
{ let a. assume Ha. let b. assume Hb. assume H. exact ((xm (a = b)) (a = b) (fun H2 => H2) (fun Hn => (neq_1_0 (eq_trans_i 1 (if a = b then 1 else 0) 0 (eq_sym_i (if a = b then 1 else 0) 1 (eq_trans_i (if a = b then 1 else 0) (hl_GEQ D a b) 1 (eq_sym_i (hl_GEQ D a b) (if a = b then 1 else 0) (hl_GEQ_unfold D a Ha b Hb)) H)) (If_i_0 (a = b) 1 0 Hn))) (a = b))). }
claim Hsat: forall f :e (D :^: (A :*: (B :*: C))), (fun f :e (D :^: (A :*: (B :*: C))) => if forall x :e A, forall y :e B, forall z :e C, hl_GEQ D (f (hl_pair A (B :*: C) x (hl_pair B C y z))) (T x y z) = 1 then 1 else 0) f = 1 -> forall x :e A, forall y :e B, forall z :e C, f (hl_pair A (B :*: C) x (hl_pair B C y z)) = T x y z.
{ let f. assume Hf H1.
  claim Hif1: (if forall x :e A, forall y :e B, forall z :e C, hl_GEQ D (f (hl_pair A (B :*: C) x (hl_pair B C y z))) (T x y z) = 1 then 1 else 0) = 1.
  { exact (eq_trans_i (if forall x :e A, forall y :e B, forall z :e C, hl_GEQ D (f (hl_pair A (B :*: C) x (hl_pair B C y z))) (T x y z) = 1 then 1 else 0) ((fun f :e (D :^: (A :*: (B :*: C))) => if forall x :e A, forall y :e B, forall z :e C, hl_GEQ D (f (hl_pair A (B :*: C) x (hl_pair B C y z))) (T x y z) = 1 then 1 else 0) f) 1 (eq_sym_i ((fun f :e (D :^: (A :*: (B :*: C))) => if forall x :e A, forall y :e B, forall z :e C, hl_GEQ D (f (hl_pair A (B :*: C) x (hl_pair B C y z))) (T x y z) = 1 then 1 else 0) f) (if forall x :e A, forall y :e B, forall z :e C, hl_GEQ D (f (hl_pair A (B :*: C) x (hl_pair B C y z))) (T x y z) = 1 then 1 else 0) (beta (D :^: (A :*: (B :*: C))) (fun f => if forall x :e A, forall y :e B, forall z :e C, hl_GEQ D (f (hl_pair A (B :*: C) x (hl_pair B C y z))) (T x y z) = 1 then 1 else 0) f Hf)) H1). }
  claim Hc: forall x :e A, forall y :e B, forall z :e C, hl_GEQ D (f (hl_pair A (B :*: C) x (hl_pair B C y z))) (T x y z) = 1.
  { exact ((xm (forall x :e A, forall y :e B, forall z :e C, hl_GEQ D (f (hl_pair A (B :*: C) x (hl_pair B C y z))) (T x y z) = 1)) (forall x :e A, forall y :e B, forall z :e C, hl_GEQ D (f (hl_pair A (B :*: C) x (hl_pair B C y z))) (T x y z) = 1) (fun H2 => H2) (fun Hn => (neq_1_0 (eq_trans_i 1 (if forall x :e A, forall y :e B, forall z :e C, hl_GEQ D (f (hl_pair A (B :*: C) x (hl_pair B C y z))) (T x y z) = 1 then 1 else 0) 0 (eq_sym_i (if forall x :e A, forall y :e B, forall z :e C, hl_GEQ D (f (hl_pair A (B :*: C) x (hl_pair B C y z))) (T x y z) = 1 then 1 else 0) 1 Hif1) (If_i_0 (forall x :e A, forall y :e B, forall z :e C, hl_GEQ D (f (hl_pair A (B :*: C) x (hl_pair B C y z))) (T x y z) = 1) 1 0 Hn))) (forall x :e A, forall y :e B, forall z :e C, hl_GEQ D (f (hl_pair A (B :*: C) x (hl_pair B C y z))) (T x y z) = 1))). }
  let x. assume Hx. let y. assume Hy. let z. assume Hz.
  exact (Hgeq (f (hl_pair A (B :*: C) x (hl_pair B C y z))) (setexp_ap (A :*: (B :*: C)) D f Hf (hl_pair A (B :*: C) x (hl_pair B C y z)) (Hpair3 x Hx y Hy z Hz)) (T x y z) (HT x Hx y Hy z Hz) (Hc x Hx y Hy z Hz)). }
claim Hgood: (fun f :e (D :^: (A :*: (B :*: C))) => if forall x :e A, forall y :e B, forall z :e C, hl_GEQ D (f (hl_pair A (B :*: C) x (hl_pair B C y z))) (T x y z) = 1 then 1 else 0) (fun p :e A :*: (B :*: C) => T (hl_FST A (B :*: C) p) (hl_FST B C (hl_SND A (B :*: C) p)) (hl_SND B C (hl_SND A (B :*: C) p))) = 1.
{ rewrite (beta (D :^: (A :*: (B :*: C))) (fun f => if forall x :e A, forall y :e B, forall z :e C, hl_GEQ D (f (hl_pair A (B :*: C) x (hl_pair B C y z))) (T x y z) = 1 then 1 else 0) (fun p :e A :*: (B :*: C) => T (hl_FST A (B :*: C) p) (hl_FST B C (hl_SND A (B :*: C) p)) (hl_SND B C (hl_SND A (B :*: C) p))) Hg). apply (If_i_1 (forall x :e A, forall y :e B, forall z :e C, hl_GEQ D ((fun p :e A :*: (B :*: C) => T (hl_FST A (B :*: C) p) (hl_FST B C (hl_SND A (B :*: C) p)) (hl_SND B C (hl_SND A (B :*: C) p))) (hl_pair A (B :*: C) x (hl_pair B C y z))) (T x y z) = 1) 1 0).
  let x. assume Hx. let y. assume Hy. let z. assume Hz.
  claim Hq: (hl_pair B C y z) :e (B :*: C). { exact (Hpair2 y Hy z Hz). }
  claim HBC: (B :*: C) <> Empty. { exact (nonempty_of_In (B :*: C) (hl_pair B C y z) Hq). }
  claim Hfst1: hl_FST A (B :*: C) (hl_pair A (B :*: C) x (hl_pair B C y z)) = x.
  { exact (eq_trans_i (hl_FST A (B :*: C) (hl_pair A (B :*: C) x (hl_pair B C y z))) ((hl_pair A (B :*: C) x (hl_pair B C y z)) 0) x (hl_FST_compat A (B :*: C) HA HBC (hl_pair A (B :*: C) x (hl_pair B C y z)) (Hpair3 x Hx y Hy z Hz)) (eq_trans_i ((hl_pair A (B :*: C) x (hl_pair B C y z)) 0) ((x,(hl_pair B C y z)) 0) x (f_equal (fun u => u 0) (hl_pair A (B :*: C) x (hl_pair B C y z)) (x,(hl_pair B C y z)) (hl_pair_ap A (B :*: C) x Hx (hl_pair B C y z) Hq)) (tuple_2_0_eq x (hl_pair B C y z)))). }
  claim Hsnd1: hl_SND A (B :*: C) (hl_pair A (B :*: C) x (hl_pair B C y z)) = (hl_pair B C y z).
  { exact (eq_trans_i (hl_SND A (B :*: C) (hl_pair A (B :*: C) x (hl_pair B C y z))) ((hl_pair A (B :*: C) x (hl_pair B C y z)) 1) (hl_pair B C y z) (hl_SND_compat A (B :*: C) HA HBC (hl_pair A (B :*: C) x (hl_pair B C y z)) (Hpair3 x Hx y Hy z Hz)) (eq_trans_i ((hl_pair A (B :*: C) x (hl_pair B C y z)) 1) ((x,(hl_pair B C y z)) 1) (hl_pair B C y z) (f_equal (fun u => u 1) (hl_pair A (B :*: C) x (hl_pair B C y z)) (x,(hl_pair B C y z)) (hl_pair_ap A (B :*: C) x Hx (hl_pair B C y z) Hq)) (tuple_2_1_eq x (hl_pair B C y z)))). }
  claim Hfst2: hl_FST B C (hl_pair B C y z) = y.
  { exact (eq_trans_i (hl_FST B C (hl_pair B C y z)) ((hl_pair B C y z) 0) y (hl_FST_compat B C HB HC (hl_pair B C y z) Hq) (eq_trans_i ((hl_pair B C y z) 0) ((y,z) 0) y (f_equal (fun u => u 0) (hl_pair B C y z) (y,z) (hl_pair_ap B C y Hy z Hz)) (tuple_2_0_eq y z))). }
  claim Hsnd2: hl_SND B C (hl_pair B C y z) = z.
  { exact (eq_trans_i (hl_SND B C (hl_pair B C y z)) ((hl_pair B C y z) 1) z (hl_SND_compat B C HB HC (hl_pair B C y z) Hq) (eq_trans_i ((hl_pair B C y z) 1) ((y,z) 1) z (f_equal (fun u => u 1) (hl_pair B C y z) (y,z) (hl_pair_ap B C y Hy z Hz)) (tuple_2_1_eq y z))). }
  claim H2: hl_FST B C (hl_SND A (B :*: C) (hl_pair A (B :*: C) x (hl_pair B C y z))) = y.
  { exact (eq_trans_i (hl_FST B C (hl_SND A (B :*: C) (hl_pair A (B :*: C) x (hl_pair B C y z)))) (hl_FST B C (hl_pair B C y z)) y (f_equal (fun u => hl_FST B C u) (hl_SND A (B :*: C) (hl_pair A (B :*: C) x (hl_pair B C y z))) (hl_pair B C y z) Hsnd1) Hfst2). }
  claim H3: hl_SND B C (hl_SND A (B :*: C) (hl_pair A (B :*: C) x (hl_pair B C y z))) = z.
  { exact (eq_trans_i (hl_SND B C (hl_SND A (B :*: C) (hl_pair A (B :*: C) x (hl_pair B C y z)))) (hl_SND B C (hl_pair B C y z)) z (f_equal (fun u => hl_SND B C u) (hl_SND A (B :*: C) (hl_pair A (B :*: C) x (hl_pair B C y z))) (hl_pair B C y z) Hsnd1) Hsnd2). }
  claim Hgxyz: (fun p :e A :*: (B :*: C) => T (hl_FST A (B :*: C) p) (hl_FST B C (hl_SND A (B :*: C) p)) (hl_SND B C (hl_SND A (B :*: C) p))) (hl_pair A (B :*: C) x (hl_pair B C y z)) = T x y z.
  { exact (eq_trans_i ((fun p :e A :*: (B :*: C) => T (hl_FST A (B :*: C) p) (hl_FST B C (hl_SND A (B :*: C) p)) (hl_SND B C (hl_SND A (B :*: C) p))) (hl_pair A (B :*: C) x (hl_pair B C y z))) (T (hl_FST A (B :*: C) (hl_pair A (B :*: C) x (hl_pair B C y z))) (hl_FST B C (hl_SND A (B :*: C) (hl_pair A (B :*: C) x (hl_pair B C y z)))) (hl_SND B C (hl_SND A (B :*: C) (hl_pair A (B :*: C) x (hl_pair B C y z))))) (T x y z) (beta (A :*: (B :*: C)) (fun p => T (hl_FST A (B :*: C) p) (hl_FST B C (hl_SND A (B :*: C) p)) (hl_SND B C (hl_SND A (B :*: C) p))) (hl_pair A (B :*: C) x (hl_pair B C y z)) (Hpair3 x Hx y Hy z Hz)) (f_equal3 T (hl_FST A (B :*: C) (hl_pair A (B :*: C) x (hl_pair B C y z))) x (hl_FST B C (hl_SND A (B :*: C) (hl_pair A (B :*: C) x (hl_pair B C y z)))) y (hl_SND B C (hl_SND A (B :*: C) (hl_pair A (B :*: C) x (hl_pair B C y z)))) z Hfst1 H2 H3)). }
  rewrite Hgxyz. rewrite (hl_GEQ_unfold D (T x y z) (HT x Hx y Hy z Hz) (T x y z) (HT x Hx y Hy z Hz)). exact (If_i_1 (T x y z = T x y z) 1 0 (fun q H => H)). }
claim Huniq: forall f :e (D :^: (A :*: (B :*: C))), (fun f :e (D :^: (A :*: (B :*: C))) => if forall x :e A, forall y :e B, forall z :e C, hl_GEQ D (f (hl_pair A (B :*: C) x (hl_pair B C y z))) (T x y z) = 1 then 1 else 0) f = 1 -> f = (fun p :e A :*: (B :*: C) => T (hl_FST A (B :*: C) p) (hl_FST B C (hl_SND A (B :*: C) p)) (hl_SND B C (hl_SND A (B :*: C) p))).
{ let f. assume Hf Hf1. apply (Pi_ext (A :*: (B :*: C)) (fun _ => D) f Hf (fun p :e A :*: (B :*: C) => T (hl_FST A (B :*: C) p) (hl_FST B C (hl_SND A (B :*: C) p)) (hl_SND B C (hl_SND A (B :*: C) p))) Hg). let p. assume Hp.
  claim Hp0: p 0 :e A. { exact (ap0_Sigma A (fun _ => (B :*: C)) p Hp). }
  claim Hp1: p 1 :e (B :*: C). { exact (ap1_Sigma A (fun _ => (B :*: C)) p Hp). }
  claim HBC: (B :*: C) <> Empty. { exact (nonempty_of_In (B :*: C) (p 1) Hp1). }
  claim Hp10: p 1 0 :e B. { exact (ap0_Sigma B (fun _ => C) (p 1) Hp1). }
  claim Hp11: p 1 1 :e C. { exact (ap1_Sigma B (fun _ => C) (p 1) Hp1). }
  claim Hq: p 1 = hl_pair B C (p 1 0) (p 1 1).
  { exact (eq_trans_i (p 1) (p 1 0, p 1 1) (hl_pair B C (p 1 0) (p 1 1)) (eq_sym_i (p 1 0, p 1 1) (p 1) (tuple_Sigma_eta B (fun _ => C) (p 1) Hp1)) (eq_sym_i (hl_pair B C (p 1 0) (p 1 1)) (p 1 0, p 1 1) (hl_pair_ap B C (p 1 0) Hp10 (p 1 1) Hp11))). }
  claim Hpe: p = (hl_pair A (B :*: C) (p 0) (hl_pair B C (p 1 0) (p 1 1))).
  { exact (eq_trans_i p (hl_pair A (B :*: C) (p 0) (p 1)) (hl_pair A (B :*: C) (p 0) (hl_pair B C (p 1 0) (p 1 1))) (eq_trans_i p (p 0, p 1) (hl_pair A (B :*: C) (p 0) (p 1)) (eq_sym_i (p 0, p 1) p (tuple_Sigma_eta A (fun _ => (B :*: C)) p Hp)) (eq_sym_i (hl_pair A (B :*: C) (p 0) (p 1)) (p 0, p 1) (hl_pair_ap A (B :*: C) (p 0) Hp0 (p 1) Hp1))) (f_equal (fun u => hl_pair A (B :*: C) (p 0) u) (p 1) (hl_pair B C (p 1 0) (p 1 1)) Hq)). }
  claim Hfp: f p = T (p 0) (p 1 0) (p 1 1).
  { exact (eq_trans_i (f p) (f (hl_pair A (B :*: C) (p 0) (hl_pair B C (p 1 0) (p 1 1)))) (T (p 0) (p 1 0) (p 1 1)) (f_equal (fun u => f u) p (hl_pair A (B :*: C) (p 0) (hl_pair B C (p 1 0) (p 1 1))) Hpe) (Hsat f Hf Hf1 (p 0) Hp0 (p 1 0) Hp10 (p 1 1) Hp11)). }
  claim H2: hl_FST B C (hl_SND A (B :*: C) p) = p 1 0.
  { exact (eq_trans_i (hl_FST B C (hl_SND A (B :*: C) p)) (hl_FST B C (p 1)) (p 1 0) (f_equal (fun u => hl_FST B C u) (hl_SND A (B :*: C) p) (p 1) (hl_SND_compat A (B :*: C) HA HBC p Hp)) (hl_FST_compat B C HB HC (p 1) Hp1)). }
  claim H3: hl_SND B C (hl_SND A (B :*: C) p) = p 1 1.
  { exact (eq_trans_i (hl_SND B C (hl_SND A (B :*: C) p)) (hl_SND B C (p 1)) (p 1 1) (f_equal (fun u => hl_SND B C u) (hl_SND A (B :*: C) p) (p 1) (hl_SND_compat A (B :*: C) HA HBC p Hp)) (hl_SND_compat B C HB HC (p 1) Hp1)). }
  claim Hgp: (fun p :e A :*: (B :*: C) => T (hl_FST A (B :*: C) p) (hl_FST B C (hl_SND A (B :*: C) p)) (hl_SND B C (hl_SND A (B :*: C) p))) p = T (p 0) (p 1 0) (p 1 1).
  { exact (eq_trans_i ((fun p :e A :*: (B :*: C) => T (hl_FST A (B :*: C) p) (hl_FST B C (hl_SND A (B :*: C) p)) (hl_SND B C (hl_SND A (B :*: C) p))) p) (T (hl_FST A (B :*: C) p) (hl_FST B C (hl_SND A (B :*: C) p)) (hl_SND B C (hl_SND A (B :*: C) p))) (T (p 0) (p 1 0) (p 1 1)) (beta (A :*: (B :*: C)) (fun p => T (hl_FST A (B :*: C) p) (hl_FST B C (hl_SND A (B :*: C) p)) (hl_SND B C (hl_SND A (B :*: C) p))) p Hp) (f_equal3 T (hl_FST A (B :*: C) p) (p 0) (hl_FST B C (hl_SND A (B :*: C) p)) (p 1 0) (hl_SND B C (hl_SND A (B :*: C) p)) (p 1 1) (hl_FST_compat A (B :*: C) HA HBC p Hp) H2 H3)). }
  exact (eq_trans_i (f p) (T (p 0) (p 1 0) (p 1 1)) ((fun p :e A :*: (B :*: C) => T (hl_FST A (B :*: C) p) (hl_FST B C (hl_SND A (B :*: C) p)) (hl_SND B C (hl_SND A (B :*: C) p))) p) Hfp (eq_sym_i ((fun p :e A :*: (B :*: C) => T (hl_FST A (B :*: C) p) (hl_FST B C (hl_SND A (B :*: C) p)) (hl_SND B C (hl_SND A (B :*: C) p))) p) (T (p 0) (p 1 0) (p 1 1)) Hgp)). }
claim Hsel: hl_GABS (D :^: (A :*: (B :*: C))) (fun f :e (D :^: (A :*: (B :*: C))) => if forall x :e A, forall y :e B, forall z :e C, hl_GEQ D (f (hl_pair A (B :*: C) x (hl_pair B C y z))) (T x y z) = 1 then 1 else 0) = choose_in (D :^: (A :*: (B :*: C))) (fun f => (fun f :e (D :^: (A :*: (B :*: C))) => if forall x :e A, forall y :e B, forall z :e C, hl_GEQ D (f (hl_pair A (B :*: C) x (hl_pair B C y z))) (T x y z) = 1 then 1 else 0) f = 1).
{ exact (eq_trans_i (hl_GABS (D :^: (A :*: (B :*: C))) (fun f :e (D :^: (A :*: (B :*: C))) => if forall x :e A, forall y :e B, forall z :e C, hl_GEQ D (f (hl_pair A (B :*: C) x (hl_pair B C y z))) (T x y z) = 1 then 1 else 0)) (hl_select (D :^: (A :*: (B :*: C))) (fun f :e (D :^: (A :*: (B :*: C))) => if forall x :e A, forall y :e B, forall z :e C, hl_GEQ D (f (hl_pair A (B :*: C) x (hl_pair B C y z))) (T x y z) = 1 then 1 else 0)) (choose_in (D :^: (A :*: (B :*: C))) (fun f => (fun f :e (D :^: (A :*: (B :*: C))) => if forall x :e A, forall y :e B, forall z :e C, hl_GEQ D (f (hl_pair A (B :*: C) x (hl_pair B C y z))) (T x y z) = 1 then 1 else 0) f = 1)) (hl_GABS_unfold (D :^: (A :*: (B :*: C))) (fun f :e (D :^: (A :*: (B :*: C))) => if forall x :e A, forall y :e B, forall z :e C, hl_GEQ D (f (hl_pair A (B :*: C) x (hl_pair B C y z))) (T x y z) = 1 then 1 else 0) HP) (hl_select_eq (D :^: (A :*: (B :*: C))) (fun f :e (D :^: (A :*: (B :*: C))) => if forall x :e A, forall y :e B, forall z :e C, hl_GEQ D (f (hl_pair A (B :*: C) x (hl_pair B C y z))) (T x y z) = 1 then 1 else 0) HP)). }
exact (eq_trans_i (hl_GABS (D :^: (A :*: (B :*: C))) (fun f :e (D :^: (A :*: (B :*: C))) => if forall x :e A, forall y :e B, forall z :e C, hl_GEQ D (f (hl_pair A (B :*: C) x (hl_pair B C y z))) (T x y z) = 1 then 1 else 0)) (choose_in (D :^: (A :*: (B :*: C))) (fun f => (fun f :e (D :^: (A :*: (B :*: C))) => if forall x :e A, forall y :e B, forall z :e C, hl_GEQ D (f (hl_pair A (B :*: C) x (hl_pair B C y z))) (T x y z) = 1 then 1 else 0) f = 1)) (fun p :e A :*: (B :*: C) => T (hl_FST A (B :*: C) p) (hl_FST B C (hl_SND A (B :*: C) p)) (hl_SND B C (hl_SND A (B :*: C) p))) Hsel (choose_in_unique (D :^: (A :*: (B :*: C))) (fun f => (fun f :e (D :^: (A :*: (B :*: C))) => if forall x :e A, forall y :e B, forall z :e C, hl_GEQ D (f (hl_pair A (B :*: C) x (hl_pair B C y z))) (T x y z) = 1 then 1 else 0) f = 1) (fun p :e A :*: (B :*: C) => T (hl_FST A (B :*: C) p) (hl_FST B C (hl_SND A (B :*: C) p)) (hl_SND B C (hl_SND A (B :*: C) p))) Hg Hgood Huniq)).
Qed.
Theorem If_i_ap : forall p:prop, forall f g x:set, (if p then f else g) x = if p then f x else g x.
let p f g x. apply (xm p).
